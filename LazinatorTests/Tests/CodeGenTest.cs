...
";
        ...
        {
            AdhocWorkspace ws = GetAdhocWorkspace();
            await CompleteGenerateCode(typeof(ExampleContainerContainingClassesStructContainingClasses), "LazinatorTests", "/Examples/", "Structs/", ws); // DEBUG -- delete, repeated below
