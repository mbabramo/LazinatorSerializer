...
namespace MyCode
{
    public partial class MyExample : IMyExample
    {
            ...
            AddGeneratedFilesToCompilation(executionResult);
            var diagnosticsWithGeneratedSources = executionResult.compilation.GetDiagnostics().ToList();
            diagnosticsWithGeneratedSources.Count().Should().Be(0);
            
            return Task.CompletedTask;
        }

        private static void AddGeneratedFilesToCompilation(GeneratorExecutionResult executionResult)
        {
