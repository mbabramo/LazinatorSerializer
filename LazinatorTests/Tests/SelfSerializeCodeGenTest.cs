...
";
        ...
        public async Task CodeGenerationProducesActualCode_LazinatorBuiltIns()
        {
            ...
            //await CompleteGenerateCode(typeof(LazinatorFastReadList<>), project: "Lazinator", mainFolder: "/Collections/", subfolder: "", ws); // not autogenerated because it's generic with a non-generic base
