...
";
        ...
        public async Task CodeGenerationProducesActualCode_LazinatorBuiltIns()
        {
            ...
            //await CompleteGenerateCode(typeof(LazinatorFastReadList<>), project: "Lazinator", mainFolder: "/Collections/", subfolder: "", ws); // not autogenerated because it's generic with a non-generic base, but one can uncomment this to autogenerate and then add <T> and constraint at end of class declaration on generated code, as well as <T> on new statement.
        ...
        public async Task CodeGenerationProducesActualCode_TestExamples()
        {
            ...
            await CompleteGenerateCode(typeof(UnformedGeneric2c<>), "LazinatorTests", "/Examples/", "Abstract/", ws);
            await CompleteGenerateCode(typeof(UnformedGenericContainer<>), "LazinatorTests", "/Examples/", "Abstract/", ws);
