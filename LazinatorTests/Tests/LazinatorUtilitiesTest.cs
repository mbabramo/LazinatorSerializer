    ...
    public class LazinatorUtilitiesTest
    {
        ...
        public void LazinatorMemorySubranges()
        {
            ...
            for (int rep = 0; rep < numRepetitions; rep++)
            {
                ...
                int totalBytesReferredTo = memoryChunks.Sum(x => x.ReferenceOnceLoaded.LengthForLoading);
                ...
                memoryChunkReferences.Sum(x => x.LengthForLoading).Should().Equals(numBytesWithinLazinatorMemorySubrange);
        ...
        public void BinaryBufferWriterCanBeCreated()
        {
            ...
            { // same as above; higher iterations causes no memory leak
                ...
                ((ExpandableBytes)rented.InitialOwnedMemory).CurrentBuffer.Memory.Length.Should().BeGreaterOrEqualTo(bufferSize);
            }
        }
