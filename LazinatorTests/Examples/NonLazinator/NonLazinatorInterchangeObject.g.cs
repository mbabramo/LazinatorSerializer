//b323a2de-ad4c-79aa-524b-d1b54e24b09c
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    [Autogenerated]
    public partial struct NonLazinatorInterchangeObject : ILazinator
    {
        ...
        {
            var clone = new NonLazinatorInterchangeObject()
            {
        ...
        void AssignCloneProperties(ref NonLazinatorInterchangeObject clone, IncludeChildrenMode includeChildrenMode)
        {
            clone.IsNull = IsNull;
            clone.MyInt = MyInt;
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.NonLazinatorInterchangeObject ");
        ...
        {
            // header information
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.NonLazinatorInterchangeObject starting at {writer.Position}.");
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Byte {writer.Position} (end of NonLazinatorInterchangeObject) ");
        }
