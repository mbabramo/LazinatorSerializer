/*Location8326*//*Location8312*///55c505c1-a6d0-cdff-0943-7266afb2c8e8
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location8313*/
    using Lazinator.Attributes;/*Location8314*/
    using Lazinator.Buffers;/*Location8315*/
    using Lazinator.Core;/*Location8316*/
    using Lazinator.Exceptions;/*Location8317*/
    using Lazinator.Support;/*Location8318*/
    using System;/*Location8319*/
    using System.Buffers;/*Location8320*/
    using System.Collections.Generic;/*Location8321*/
    using System.Diagnostics;/*Location8322*/
    using System.IO;/*Location8323*/
    using System.Linq;/*Location8324*/
    using System.Runtime.InteropServices;/*Location8325*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ClassWithSubclass : ILazinator
    {
        /*Location8327*/public bool IsStruct => false;
        
        /*Location8328*//* Property definitions */
        
        /*Location8329*/        protected int _SubclassInstance1_ByteIndex;
        /*Location8330*/        protected int _SubclassInstance2_ByteIndex;
        /*Location8331*/protected virtual int _SubclassInstance1_ByteLength => _SubclassInstance2_ByteIndex - _SubclassInstance1_ByteIndex;
        /*Location8332*/private int _ClassWithSubclass_EndByteIndex;
        /*Location8333*/protected virtual int _SubclassInstance2_ByteLength => _ClassWithSubclass_EndByteIndex - _SubclassInstance2_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location8337*/typedClone.IntWithinSuperclass = IntWithinSuperclass;
            /*Location8338*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location8339*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location8342*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location8343*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _SubclassInstance1_Accessed) && SubclassInstance1 == null)
            {
            ...
            /*Location8344*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _SubclassInstance2_Accessed) && SubclassInstance2 == null)
            {
            ...
            /*Location8345*/yield break;
        }
        /*Location8346*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location8347*/yield return ("IntWithinSuperclass", (object)IntWithinSuperclass);
            /*Location8348*/yield break;
        }
        /*Location8349*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location8350*/if ((!exploreOnlyDeserializedChildren && SubclassInstance1 != null) || (_SubclassInstance1_Accessed && _SubclassInstance1 != null))
            {
            ...
            /*Location8351*/if ((!exploreOnlyDeserializedChildren && SubclassInstance2 != null) || (_SubclassInstance2_Accessed && _SubclassInstance2 != null))
            {
            ...
            /*Location8352*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location8355*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location8356*/_IntWithinSuperclass = span.ToDecompressedInt(ref bytesSoFar);
            /*Location8357*/_SubclassInstance1_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location8358*/_SubclassInstance2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location8359*/_ClassWithSubclass_EndByteIndex = bytesSoFar;
            /*Location8360*/        }
            
            /*Location8361*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location8362*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location8363*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location8364*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location8368*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location8369*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location8370*/}
                                /*Location8371*//*Location8372*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location8376*/if (_SubclassInstance1_Accessed && _SubclassInstance1 != null)
                                {
                                ...
                                /*Location8377*/if (_SubclassInstance2_Accessed && _SubclassInstance2 != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location8380*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location8381*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location8382*/// write properties
                                    /*Location8383*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _IntWithinSuperclass);
                                    /*Location8384*/startOfObjectPosition = writer.Position;
                                    ...
                                    /*Location8386*/if (updateStoredBuffer)
                                    {
                                        _SubclassInstance1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location8387*/startOfObjectPosition = writer.Position;
                                    /*Location8388*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location8389*/if (updateStoredBuffer)
                                    {
                                        _SubclassInstance2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location8390*/if (updateStoredBuffer)
                                    {
                                        /*Location8391*/_ClassWithSubclass_EndByteIndex = writer.Position - startPosition;
                                        /*Location8392*/}
                                        /*Location8393*/}
                                        /*Location8394*/
                                    }
