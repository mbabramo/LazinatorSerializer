//6ca49a04-5be5-f868-678d-051de64b41ad
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Subclasses
{
    ...
    public partial record LazinatorRecord : ILazinator
    {
        ...
        {
            _MyInt = span.ToDecompressedInt32(ref bytesSoFar);_MyString = span.ToString_BrotliCompressedWithLength(ref bytesSoFar);        }
            ...
            {
                TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Subclasses.LazinatorRecord ");
            ...
            {
                TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Subclasses.LazinatorRecord starting at {writer.Position}.");
                ...
                TabbedText.WriteLine($"Byte {writer.Position} (end of LazinatorRecord) ");
            }
