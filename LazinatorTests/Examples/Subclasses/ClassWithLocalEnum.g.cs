//5fb6695d-6e27-6c0e-68ce-0d0b3d866a12
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Subclasses
{
    ...
    public partial class ClassWithLocalEnum : ILazinator
    {
        ...
        private EnumWithinClass _MyEnum;
        public EnumWithinClass MyEnum
        {
            [DebuggerStepThrough]
            get
            {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _MyEnum = (EnumWithinClass)span.ToDecompressedInt(ref bytesSoFar);
        }
