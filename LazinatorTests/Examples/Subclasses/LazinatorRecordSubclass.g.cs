//f2029c5a-2b85-c741-fd53-7b604520c70c
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Subclasses
{
    ...
    public partial record LazinatorRecordSubclass : LazinatorRecord, ILazinator
    {
        ...
        protected override int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.Subclasses.LazinatorRecordSubclass from bytes at: " + LazinatorMemoryStorage.ToLocationString());
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Subclasses.LazinatorRecordSubclass at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Subclasses.LazinatorRecordSubclass.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of LazinatorRecordSubclass) ");
        ...
        protected override void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition}, MySubclassInt value {_MySubclassInt}");
            TabbedText.Tabs++;
