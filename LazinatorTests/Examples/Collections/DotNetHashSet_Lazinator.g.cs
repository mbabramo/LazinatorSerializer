...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetHashSet_Lazinator : ILazinator
    {
        ...
        private void LazinateMyHashSetSerialized()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyHashSetSerialized_ByteIndex, _MyHashSetSerialized_ByteLength, SizeOfLength.SkipLength, null);_MyHashSetSerialized = ConvertFromBytes_HashSet_GExampleChild_g(childData);
            }
            _MyHashSetSerialized_Accessed = true;
        }
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyHashSetSerialized_ByteIndex, _MyHashSetSerialized_ByteLength, SizeOfLength.SkipLength, null),
        ...
        private static void ConvertToBytes_HashSet_GExampleChild_g(ref BinaryBufferWriter writer, HashSet<ExampleChild> itemToConvert, LazinatorSerializationOptions options)
        {
