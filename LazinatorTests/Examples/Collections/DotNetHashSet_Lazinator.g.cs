/*Location5798*//*Location5783*///1a38df39-a7af-d478-5f19-eded9be85eac
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5784*/
    using Lazinator.Attributes;/*Location5785*/
    using Lazinator.Buffers;/*Location5786*/
    using Lazinator.Core;/*Location5787*/
    using Lazinator.Exceptions;/*Location5788*/
    using Lazinator.Support;/*Location5789*/
    using LazinatorTests.Examples;/*Location5790*/
    using System;/*Location5791*/
    using System.Buffers;/*Location5792*/
    using System.Collections.Generic;/*Location5793*/
    using System.Diagnostics;/*Location5794*/
    using System.IO;/*Location5795*/
    using System.Linq;/*Location5796*/
    using System.Runtime.InteropServices;/*Location5797*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetHashSet_Lazinator : ILazinator
    {
        /*Location5799*/public bool IsStruct => false;
        
        /*Location5800*//* Property definitions */
        
        /*Location5801*/        protected int _MyHashSetSerialized_ByteIndex;
        /*Location5802*/private int _DotNetHashSet_Lazinator_EndByteIndex;
        /*Location5803*/protected virtual int _MyHashSetSerialized_ByteLength => _DotNetHashSet_Lazinator_EndByteIndex - _MyHashSetSerialized_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5805*/typedClone.MyHashSetSerialized = CloneOrChange_HashSet_GExampleChild_g(MyHashSetSerialized, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5808*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5809*/yield break;
        }
        /*Location5810*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5811*/yield return ("MyHashSetSerialized", (object)MyHashSetSerialized);
            /*Location5812*/yield break;
        }
        /*Location5813*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5814*/if ((!exploreOnlyDeserializedChildren && MyHashSetSerialized != null) || (_MyHashSetSerialized_Accessed && _MyHashSetSerialized != null))
            {
            ...
            /*Location5815*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5818*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5819*/_MyHashSetSerialized_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5820*/_DotNetHashSet_Lazinator_EndByteIndex = bytesSoFar;
            /*Location5821*/        }
            
            /*Location5822*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5823*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5824*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5825*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5829*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5830*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5831*/}
                                /*Location5832*//*Location5833*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location5837*/if (_MyHashSetSerialized_Accessed && _MyHashSetSerialized != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5840*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5841*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5842*/// write properties
                                    /*Location5843*/startOfObjectPosition = writer.Position;
                                    /*Location5844*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyHashSetSerialized_Accessed)
                                    {
                                        var deserialized = MyHashSetSerialized;
                                    }
                                    /*Location5845*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5846*/if (updateStoredBuffer)
                                    {
                                        _MyHashSetSerialized_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5847*/if (updateStoredBuffer)
                                    {
                                        /*Location5848*/_DotNetHashSet_Lazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location5849*/}
                                        /*Location5850*/}
                                        /*Location5851*/
