//4fba7c7e-083e-758b-dfd8-2dc464aafbd5
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class SpanInDotNetList : ILazinator
    {
        ...
        private void LazinateSpanList()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _SpanList_ByteIndex, _SpanList_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_SpanList = ConvertFromBytes_List_GSpanAndMemory_g(childData);
            }
            _SpanList_Accessed = true;
        }
        ...
        protected virtual int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.Collections.SpanInDotNetList at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine($"Reading SomeInt at byte location {bytesSoFar}"); 
        ...
        protected virtual int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"SpanList: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Collections.SpanInDotNetList at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Collections.SpanInDotNetList.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of SpanInDotNetList) ");
        ...
        {
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, SomeInt value {_SomeInt}");
            TabbedText.Tabs++;
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, SpanList (accessed? {_SpanList_Accessed})");
            TabbedText.Tabs++;
