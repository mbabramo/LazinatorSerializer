...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class SpanInDotNetList : ILazinator
    {
        ...
        private static void ConvertToBytes_List_GSpanAndMemory_g(ref BinaryBufferWriter writer, List<SpanAndMemory> itemToConvert, LazinatorSerializationOptions options)
        {
