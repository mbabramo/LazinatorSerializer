/*Location5952*//*Location5938*///6f60dd2b-98e4-7798-5331-e9de05e1d98f
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5939*/
    using Lazinator.Attributes;/*Location5940*/
    using Lazinator.Buffers;/*Location5941*/
    using Lazinator.Core;/*Location5942*/
    using Lazinator.Exceptions;/*Location5943*/
    using Lazinator.Support;/*Location5944*/
    using System;/*Location5945*/
    using System.Buffers;/*Location5946*/
    using System.Collections.Generic;/*Location5947*/
    using System.Diagnostics;/*Location5948*/
    using System.IO;/*Location5949*/
    using System.Linq;/*Location5950*/
    using System.Runtime.InteropServices;/*Location5951*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ArrayMultidimensional : ILazinator
    {
        /*Location5953*/public bool IsStruct => false;
        
        /*Location5954*//* Property definitions */
        
        /*Location5955*/        protected int _MyArrayInt_ByteIndex;
        /*Location5956*/        protected int _MyCrazyJaggedArray_ByteIndex;
        /*Location5957*/        protected int _MyThreeDimArrayInt_ByteIndex;
        /*Location5958*/protected virtual int _MyArrayInt_ByteLength => _MyCrazyJaggedArray_ByteIndex - _MyArrayInt_ByteIndex;
        /*Location5959*/protected virtual int _MyCrazyJaggedArray_ByteLength => _MyThreeDimArrayInt_ByteIndex - _MyCrazyJaggedArray_ByteIndex;
        /*Location5960*/private int _ArrayMultidimensional_EndByteIndex;
        /*Location5961*/protected virtual int _MyThreeDimArrayInt_ByteLength => _ArrayMultidimensional_EndByteIndex - _MyThreeDimArrayInt_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5966*/typedClone.MyArrayInt = CloneOrChange_int_B_c_b(MyArrayInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5967*/typedClone.MyCrazyJaggedArray = CloneOrChange_int_B_b_B_c_c_b_B_c_c_c_b(MyCrazyJaggedArray, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5968*/typedClone.MyThreeDimArrayInt = CloneOrChange_int_B_c_c_b(MyThreeDimArrayInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5971*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5972*/yield break;
        }
        /*Location5973*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5974*/yield return ("MyArrayInt", (object)MyArrayInt);
            /*Location5975*/yield return ("MyCrazyJaggedArray", (object)MyCrazyJaggedArray);
            /*Location5976*/yield return ("MyThreeDimArrayInt", (object)MyThreeDimArrayInt);
            /*Location5977*/yield break;
        }
        /*Location5978*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5979*/if ((!exploreOnlyDeserializedChildren && MyArrayInt != null) || (_MyArrayInt_Accessed && _MyArrayInt != null))
            {
            ...
            /*Location5980*/if ((!exploreOnlyDeserializedChildren && MyCrazyJaggedArray != null) || (_MyCrazyJaggedArray_Accessed && _MyCrazyJaggedArray != null))
            {
            ...
            /*Location5981*/if ((!exploreOnlyDeserializedChildren && MyThreeDimArrayInt != null) || (_MyThreeDimArrayInt_Accessed && _MyThreeDimArrayInt != null))
            {
            ...
            /*Location5982*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5985*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5986*/_MyArrayInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5987*/_MyCrazyJaggedArray_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5988*/_MyThreeDimArrayInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5989*/_ArrayMultidimensional_EndByteIndex = bytesSoFar;
            /*Location5990*/        }
            
            /*Location5991*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5992*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5993*/int startPosition = writer.Position;
                ...
                /*Location5994*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5998*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5999*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location6000*/}
                                /*Location6001*//*Location6002*/
                            }
                            else
                            {
                            ...
                            protected virtual void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
                            {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location6011*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location6012*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location6013*/// write properties
                                    /*Location6014*/startOfObjectPosition = writer.Position;
                                    /*Location6015*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyArrayInt_Accessed)
                                    {
                                        var deserialized = MyArrayInt;
                                    }
                                    /*Location6016*/WriteNonLazinatorObject(
                                    ...
                                    /*Location6017*/if (updateStoredBuffer)
                                    {
                                        _MyArrayInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6018*/startOfObjectPosition = writer.Position;
                                    /*Location6019*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyCrazyJaggedArray_Accessed)
                                    {
                                        var deserialized = MyCrazyJaggedArray;
                                    }
                                    /*Location6020*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location6021*/if (updateStoredBuffer)
                                    {
                                        _MyCrazyJaggedArray_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6022*/startOfObjectPosition = writer.Position;
                                    /*Location6023*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyThreeDimArrayInt_Accessed)
                                    {
                                        var deserialized = MyThreeDimArrayInt;
                                    }
                                    /*Location6024*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location6025*/if (updateStoredBuffer)
                                    {
                                        _MyThreeDimArrayInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6026*/if (updateStoredBuffer)
                                    {
                                        /*Location6027*/_ArrayMultidimensional_EndByteIndex = writer.Position - startPosition;
                                        /*Location6028*/}
                                        /*Location6029*/}
                                        /*Location6030*/
