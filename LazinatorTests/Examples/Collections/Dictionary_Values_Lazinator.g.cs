//8ed559a1-a8cd-782f-9a8d-adb624f95210
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class Dictionary_Values_Lazinator : ILazinator
    {
        ...
        public Dictionary<Int32, ExampleChild> MyDictionary
        {
            get
            {
        ...
        private void LazinateMyDictionary()
        {
            ...
            {
                _MyDictionary = default(Dictionary<Int32, ExampleChild>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyDictionary_ByteIndex, _MyDictionary_ByteLength, true, false, null);
        ...
        protected Dictionary<WInt32, WInt32> _MyDictionaryStructs;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public Dictionary<WInt32, WInt32> MyDictionaryStructs
        {
            get
            {
        ...
        private void LazinateMyDictionaryStructs()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                _MyDictionaryStructs = default(Dictionary<WInt32, WInt32>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyDictionaryStructs_ByteIndex, _MyDictionaryStructs_ByteLength, true, false, null);
                _MyDictionaryStructs = ConvertFromBytes_Dictionary_GWInt32_c_C32WInt32_g(childData);
            }
        ...
        protected SortedDictionary<Int32, ExampleChild> _MySortedDictionary;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public SortedDictionary<Int32, ExampleChild> MySortedDictionary
        {
            get
            {
        ...
        private void LazinateMySortedDictionary()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                _MySortedDictionary = default(SortedDictionary<Int32, ExampleChild>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MySortedDictionary_ByteIndex, _MySortedDictionary_ByteLength, true, false, null);
        ...
        protected SortedList<Int32, ExampleChild> _MySortedList;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public SortedList<Int32, ExampleChild> MySortedList
        {
            get
            {
        ...
        private void LazinateMySortedList()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                _MySortedList = default(SortedList<Int32, ExampleChild>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MySortedList_ByteIndex, _MySortedList_ByteLength, true, false, null);
        ...
        public Dictionary_Values_Lazinator(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        protected virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.MyDictionaryStructs = CloneOrChange_Dictionary_GWInt32_c_C32WInt32_g(MyDictionaryStructs, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            {
                _MyDictionary = (Dictionary<Int32, ExampleChild>) CloneOrChange_Dictionary_Gint_c_C32ExampleChild_g(_MyDictionary, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
            if ((!exploreOnlyDeserializedChildren && MyDictionaryStructs != null) || (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null))
            {
                _MyDictionaryStructs = (Dictionary<WInt32, WInt32>) CloneOrChange_Dictionary_GWInt32_c_C32WInt32_g(_MyDictionaryStructs, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
            if ((!exploreOnlyDeserializedChildren && MySortedDictionary != null) || (_MySortedDictionary_Accessed && _MySortedDictionary != null))
            {
                _MySortedDictionary = (SortedDictionary<Int32, ExampleChild>) CloneOrChange_SortedDictionary_Gint_c_C32ExampleChild_g(_MySortedDictionary, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
            if ((!exploreOnlyDeserializedChildren && MySortedList != null) || (_MySortedList_Accessed && _MySortedList != null))
            {
                _MySortedList = (SortedList<Int32, ExampleChild>) CloneOrChange_SortedList_Gint_c_C32ExampleChild_g(_MySortedList, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
        ...
        protected virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            ConvertFromBytesForChildProperties(span, includeChildrenMode, serializedVersionNumber, bytesSoFar + 16, ref bytesSoFar);
        }
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);_MyDictionaryStructs_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);_MySortedDictionary_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);_MySortedList_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);_Dictionary_Values_Lazinator_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            Span<byte> lengthsSpan = writer.FreeSpan.Slice(0, 16);
            writer.Skip(16);
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyDictionary_ByteIndex, _MyDictionary_ByteLength, true, false, null),
            ...
            if (updateStoredBuffer)
            {
                _MyDictionary_ByteIndex = writer.Position - startOfObjectPosition;if (_MyDictionary_Accessed && _MyDictionary != null)
                {
                    _MyDictionary = (Dictionary<Int32, ExampleChild>) CloneOrChange_Dictionary_Gint_c_C32ExampleChild_g(_MyDictionary, l => l.RemoveBufferInHierarchy(), true);
                }
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyDictionaryStructs_ByteIndex, _MyDictionaryStructs_ByteLength, true, false, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BinaryBufferWriter w, bool v) =>
            ...
            if (updateStoredBuffer)
            {
                _MyDictionaryStructs_ByteIndex = writer.Position - startOfObjectPosition;if (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null)
                {
                    _MyDictionaryStructs = (Dictionary<WInt32, WInt32>) CloneOrChange_Dictionary_GWInt32_c_C32WInt32_g(_MyDictionaryStructs, l => l.RemoveBufferInHierarchy(), true);
                }
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MySortedDictionary_ByteIndex, _MySortedDictionary_ByteLength, true, false, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BinaryBufferWriter w, bool v) =>
            ...
            if (updateStoredBuffer)
            {
                _MySortedDictionary_ByteIndex = writer.Position - startOfObjectPosition;if (_MySortedDictionary_Accessed && _MySortedDictionary != null)
                {
                    _MySortedDictionary = (SortedDictionary<Int32, ExampleChild>) CloneOrChange_SortedDictionary_Gint_c_C32ExampleChild_g(_MySortedDictionary, l => l.RemoveBufferInHierarchy(), true);
                }
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MySortedList_ByteIndex, _MySortedList_ByteLength, true, false, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BinaryBufferWriter w, bool v) =>
            ...
            if (updateStoredBuffer)
            {
                _MySortedList_ByteIndex = writer.Position - startOfObjectPosition;if (_MySortedList_Accessed && _MySortedList != null)
                {
                    _MySortedList = (SortedList<Int32, ExampleChild>) CloneOrChange_SortedList_Gint_c_C32ExampleChild_g(_MySortedList, l => l.RemoveBufferInHierarchy(), true);
                }
            ...
            if (updateStoredBuffer)
            {
                _Dictionary_Values_Lazinator_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
        ...
        private static Dictionary<Int32, ExampleChild> ConvertFromBytes_Dictionary_Gint_c_C32ExampleChild_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default(Dictionary<Int32, ExampleChild>);
            }
        ...
        private static void ConvertToBytes_Dictionary_Gint_c_C32ExampleChild_g(ref BinaryBufferWriter writer, Dictionary<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static Dictionary<Int32, ExampleChild> CloneOrChange_Dictionary_Gint_c_C32ExampleChild_g(Dictionary<Int32, ExampleChild> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
            ...
            {
                var itemCopied = (KeyValuePair<Int32, ExampleChild>) CloneOrChange_KeyValuePair_Gint_c_C32ExampleChild_g(item, cloneOrChangeFunc, avoidCloningIfPossible);
                collection.Add(itemCopied.Key, itemCopied.Value);
            }
            return collection;
        }
        
        private static KeyValuePair<Int32, ExampleChild> ConvertFromBytes_KeyValuePair_Gint_c_C32ExampleChild_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default;
            ...
            var itemToCreate = new KeyValuePair<Int32, ExampleChild>(item1, item2);
            
            return itemToCreate;
        }
        
        private static void ConvertToBytes_KeyValuePair_Gint_c_C32ExampleChild_g(ref BinaryBufferWriter writer, KeyValuePair<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static Dictionary<WInt32, WInt32> ConvertFromBytes_Dictionary_GWInt32_c_C32WInt32_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default(Dictionary<WInt32, WInt32>);
            }
            ReadOnlySpan<byte> span = storage.InitialMemory.Span;
            int bytesSoFar = 0;
            int collectionLength = span.ToDecompressedInt32(ref bytesSoFar);
            
            Dictionary<WInt32, WInt32> collection = new Dictionary<WInt32, WInt32>(collectionLength);
            for (int itemIndex = 0; itemIndex < collectionLength; itemIndex++)
            {
                int lengthCollectionMember = span.ToInt32(ref bytesSoFar);
                LazinatorMemory childData = storage.Slice(bytesSoFar, lengthCollectionMember);
                var item = ConvertFromBytes_KeyValuePair_GWInt32_c_C32WInt32_g(childData);
                collection.Add(item.Key, item.Value);
                bytesSoFar += lengthCollectionMember;
            }
        ...
        private static void ConvertToBytes_Dictionary_GWInt32_c_C32WInt32_g(ref BinaryBufferWriter writer, Dictionary<WInt32, WInt32> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static Dictionary<WInt32, WInt32> CloneOrChange_Dictionary_GWInt32_c_C32WInt32_g(Dictionary<WInt32, WInt32> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
            ...
            foreach (var item in itemToClone)
            {
                var itemCopied = (KeyValuePair<WInt32, WInt32>) CloneOrChange_KeyValuePair_GWInt32_c_C32WInt32_g(item, cloneOrChangeFunc, avoidCloningIfPossible);
                collection.Add(itemCopied.Key, itemCopied.Value);
            }
            return collection;
        }
        
        private static KeyValuePair<WInt32, WInt32> ConvertFromBytes_KeyValuePair_GWInt32_c_C32WInt32_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default;
            ...
            var itemToCreate = new KeyValuePair<WInt32, WInt32>(item1, item2);
            
            return itemToCreate;
        }
        
        private static void ConvertToBytes_KeyValuePair_GWInt32_c_C32WInt32_g(ref BinaryBufferWriter writer, KeyValuePair<WInt32, WInt32> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        {
            return new KeyValuePair<WInt32, WInt32>((WInt32) (cloneOrChangeFunc((itemToConvert.Key))), (WInt32) (cloneOrChangeFunc((itemToConvert.Value))));
        }
        ...
        private static SortedDictionary<Int32, ExampleChild> ConvertFromBytes_SortedDictionary_Gint_c_C32ExampleChild_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default(SortedDictionary<Int32, ExampleChild>);
            }
            ReadOnlySpan<byte> span = storage.InitialMemory.Span;
            int bytesSoFar = 0;
            int collectionLength = span.ToDecompressedInt32(ref bytesSoFar);
        ...
        private static void ConvertToBytes_SortedDictionary_Gint_c_C32ExampleChild_g(ref BinaryBufferWriter writer, SortedDictionary<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static SortedDictionary<Int32, ExampleChild> CloneOrChange_SortedDictionary_Gint_c_C32ExampleChild_g(SortedDictionary<Int32, ExampleChild> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
        ...
        private static SortedList<Int32, ExampleChild> ConvertFromBytes_SortedList_Gint_c_C32ExampleChild_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default(SortedList<Int32, ExampleChild>);
            }
            ReadOnlySpan<byte> span = storage.InitialMemory.Span;
            int bytesSoFar = 0;
            int collectionLength = span.ToDecompressedInt32(ref bytesSoFar);
        ...
        private static void ConvertToBytes_SortedList_Gint_c_C32ExampleChild_g(ref BinaryBufferWriter writer, SortedList<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static SortedList<Int32, ExampleChild> CloneOrChange_SortedList_Gint_c_C32ExampleChild_g(SortedList<Int32, ExampleChild> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
