...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class Dictionary_Values_Lazinator : ILazinator
    {
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            isAccessed: _MyDictionaryStructs_Accessed, writer: writer,
            ...
            verifyCleanness: false,
            binaryWriterAction: (BinaryBufferWriter w, bool v) =>
            ConvertToBytes_Dictionary_GWInt32_c_C32WInt32_g(w, _MyDictionaryStructs,
            includeChildrenMode, v, updateStoredBuffer));
            if (updateStoredBuffer)
            {
        ...
        private static void ConvertToBytes_Dictionary_Gint_c_C32ExampleChild_g(BinaryBufferWriter writer, Dictionary<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            ...
            {
                void action(BinaryBufferWriter w) => ConvertToBytes_KeyValuePair_Gint_c_C32ExampleChild_g(w, item, includeChildrenMode, verifyCleanness, updateStoredBuffer);
        ...
        private static void ConvertToBytes_KeyValuePair_Gint_c_C32ExampleChild_g(BinaryBufferWriter writer, KeyValuePair<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static void ConvertToBytes_Dictionary_GWInt32_c_C32WInt32_g(BinaryBufferWriter writer, Dictionary<WInt32, WInt32> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            ...
            foreach (var item in itemToConvert)
            {
                void action(BinaryBufferWriter w) => ConvertToBytes_KeyValuePair_GWInt32_c_C32WInt32_g(w, item, includeChildrenMode, verifyCleanness, updateStoredBuffer);
                WriteToBinaryWithIntLengthPrefix(writer, action);
            }
        }
        ...
        private static void ConvertToBytes_KeyValuePair_GWInt32_c_C32WInt32_g(BinaryBufferWriter writer, KeyValuePair<WInt32, WInt32> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            
            void actionKey(BinaryBufferWriter w) => itemToConvert.Key.SerializeExistingBuffer(w, includeChildrenMode, verifyCleanness, updateStoredBuffer);
            WriteToBinaryWithByteLengthPrefix(writer, actionKey);
            
            void actionValue(BinaryBufferWriter w) => itemToConvert.Value.SerializeExistingBuffer(w, includeChildrenMode, verifyCleanness, updateStoredBuffer);
            WriteToBinaryWithByteLengthPrefix(writer, actionValue);
        }
        ...
        private static void ConvertToBytes_SortedDictionary_Gint_c_C32ExampleChild_g(BinaryBufferWriter writer, SortedDictionary<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
        ...
        private static void ConvertToBytes_SortedList_Gint_c_C32ExampleChild_g(BinaryBufferWriter writer, SortedList<Int32, ExampleChild> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
