/*Location5648*//*Location5632*///6efe4c3b-e109-c51f-b4cc-38cfb9dd9ccf
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5633*/
    using Lazinator.Attributes;/*Location5634*/
    using Lazinator.Buffers;/*Location5635*/
    using Lazinator.Core;/*Location5636*/
    using Lazinator.Exceptions;/*Location5637*/
    using Lazinator.Support;/*Location5638*/
    using Lazinator.Wrappers;/*Location5639*/
    using LazinatorTests.Examples;/*Location5640*/
    using System;/*Location5641*/
    using System.Buffers;/*Location5642*/
    using System.Collections.Generic;/*Location5643*/
    using System.Diagnostics;/*Location5644*/
    using System.IO;/*Location5645*/
    using System.Linq;/*Location5646*/
    using System.Runtime.InteropServices;/*Location5647*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class Dictionary_Values_Lazinator : ILazinator
    {
        /*Location5649*/public bool IsStruct => false;
        
        /*Location5650*//* Property definitions */
        
        /*Location5651*/        protected int _MyDictionary_ByteIndex;
        /*Location5652*/        protected int _MyDictionaryStructs_ByteIndex;
        /*Location5653*/        protected int _MySortedDictionary_ByteIndex;
        /*Location5654*/        protected int _MySortedList_ByteIndex;
        /*Location5655*/protected virtual int _MyDictionary_ByteLength => _MyDictionaryStructs_ByteIndex - _MyDictionary_ByteIndex;
        /*Location5656*/protected virtual int _MyDictionaryStructs_ByteLength => _MySortedDictionary_ByteIndex - _MyDictionaryStructs_ByteIndex;
        /*Location5657*/protected virtual int _MySortedDictionary_ByteLength => _MySortedList_ByteIndex - _MySortedDictionary_ByteIndex;
        /*Location5658*/private int _Dictionary_Values_Lazinator_EndByteIndex;
        /*Location5659*/protected virtual int _MySortedList_ByteLength => _Dictionary_Values_Lazinator_EndByteIndex - _MySortedList_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5664*/typedClone.MyDictionary = CloneOrChange_Dictionary_Gint_c_C32ExampleChild_g(MyDictionary, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5665*/typedClone.MyDictionaryStructs = CloneOrChange_Dictionary_GWInt_c_C32WInt_g(MyDictionaryStructs, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5666*/typedClone.MySortedDictionary = CloneOrChange_SortedDictionary_Gint_c_C32ExampleChild_g(MySortedDictionary, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5667*/typedClone.MySortedList = CloneOrChange_SortedList_Gint_c_C32ExampleChild_g(MySortedList, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5670*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5671*/yield break;
        }
        /*Location5672*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5673*/yield return ("MyDictionary", (object)MyDictionary);
            /*Location5674*/yield return ("MyDictionaryStructs", (object)MyDictionaryStructs);
            /*Location5675*/yield return ("MySortedDictionary", (object)MySortedDictionary);
            /*Location5676*/yield return ("MySortedList", (object)MySortedList);
            /*Location5677*/yield break;
        }
        /*Location5678*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5679*/if ((!exploreOnlyDeserializedChildren && MyDictionary != null) || (_MyDictionary_Accessed && _MyDictionary != null))
            {
            ...
            /*Location5680*/if ((!exploreOnlyDeserializedChildren && MyDictionaryStructs != null) || (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null))
            {
            ...
            /*Location5681*/if ((!exploreOnlyDeserializedChildren && MySortedDictionary != null) || (_MySortedDictionary_Accessed && _MySortedDictionary != null))
            {
            ...
            /*Location5682*/if ((!exploreOnlyDeserializedChildren && MySortedList != null) || (_MySortedList_Accessed && _MySortedList != null))
            {
            ...
            /*Location5683*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5686*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5687*/_MyDictionary_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5688*/_MyDictionaryStructs_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5689*/_MySortedDictionary_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5690*/_MySortedList_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5691*/_Dictionary_Values_Lazinator_EndByteIndex = bytesSoFar;
            /*Location5692*/        }
            
            /*Location5693*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5694*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5695*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5696*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5700*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5701*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5702*/}
                                /*Location5703*//*Location5704*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location5708*/if (_MyDictionary_Accessed && _MyDictionary != null)
                                {
                                ...
                                /*Location5709*/if (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null)
                                {
                                ...
                                /*Location5710*/if (_MySortedDictionary_Accessed && _MySortedDictionary != null)
                                {
                                ...
                                /*Location5711*/if (_MySortedList_Accessed && _MySortedList != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5714*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5715*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5716*/// write properties
                                    /*Location5717*/startOfObjectPosition = writer.Position;
                                    /*Location5718*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyDictionary_Accessed)
                                    {
                                        var deserialized = MyDictionary;
                                    }
                                    /*Location5719*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5720*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location5721*/startOfObjectPosition = writer.Position;
                                    /*Location5722*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyDictionaryStructs_Accessed)
                                    {
                                        var deserialized = MyDictionaryStructs;
                                    }
                                    /*Location5723*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5724*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location5725*/startOfObjectPosition = writer.Position;
                                    /*Location5726*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MySortedDictionary_Accessed)
                                    {
                                        var deserialized = MySortedDictionary;
                                    }
                                    /*Location5727*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5728*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location5729*/startOfObjectPosition = writer.Position;
                                    /*Location5730*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MySortedList_Accessed)
                                    {
                                        var deserialized = MySortedList;
                                    }
                                    /*Location5731*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5732*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location5733*/if (updateStoredBuffer)
                                    {
                                        /*Location5734*/_Dictionary_Values_Lazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location5735*/}
                                        /*Location5736*/}
                                        /*Location5737*/
