/*Location4752*//*Location4736*///6efe4c3b-e109-c51f-b4cc-38cfb9dd9ccf
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4737*/
    using Lazinator.Attributes;/*Location4738*/
    using Lazinator.Buffers;/*Location4739*/
    using Lazinator.Core;/*Location4740*/
    using Lazinator.Exceptions;/*Location4741*/
    using Lazinator.Support;/*Location4742*/
    using Lazinator.Wrappers;/*Location4743*/
    using LazinatorTests.Examples;/*Location4744*/
    using System;/*Location4745*/
    using System.Buffers;/*Location4746*/
    using System.Collections.Generic;/*Location4747*/
    using System.Diagnostics;/*Location4748*/
    using System.IO;/*Location4749*/
    using System.Linq;/*Location4750*/
    using System.Runtime.InteropServices;/*Location4751*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class Dictionary_Values_Lazinator : ILazinator
    {
        /*Location4753*/public bool IsStruct => false;
        
        /*Location4754*//* Property definitions */
        
        /*Location4755*/        protected int _MyDictionary_ByteIndex;
        /*Location4756*/        protected int _MyDictionaryStructs_ByteIndex;
        /*Location4757*/        protected int _MySortedDictionary_ByteIndex;
        /*Location4758*/        protected int _MySortedList_ByteIndex;
        /*Location4759*/protected virtual int _MyDictionary_ByteLength => _MyDictionaryStructs_ByteIndex - _MyDictionary_ByteIndex;
        /*Location4760*/protected virtual int _MyDictionaryStructs_ByteLength => _MySortedDictionary_ByteIndex - _MyDictionaryStructs_ByteIndex;
        /*Location4761*/protected virtual int _MySortedDictionary_ByteLength => _MySortedList_ByteIndex - _MySortedDictionary_ByteIndex;
        /*Location4762*/private int _Dictionary_Values_Lazinator_EndByteIndex;
        /*Location4763*/protected virtual int _MySortedList_ByteLength => _Dictionary_Values_Lazinator_EndByteIndex - _MySortedList_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4768*/typedClone.MyDictionary = CloneOrChange_Dictionary_Gint_c_C32ExampleChild_g(MyDictionary, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location4769*/typedClone.MyDictionaryStructs = CloneOrChange_Dictionary_GWInt_c_C32WInt_g(MyDictionaryStructs, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location4770*/typedClone.MySortedDictionary = CloneOrChange_SortedDictionary_Gint_c_C32ExampleChild_g(MySortedDictionary, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location4771*/typedClone.MySortedList = CloneOrChange_SortedList_Gint_c_C32ExampleChild_g(MySortedList, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location4774*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location4775*/yield break;
        }
        /*Location4776*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location4777*/yield return ("MyDictionary", (object)MyDictionary);
            /*Location4778*/yield return ("MyDictionaryStructs", (object)MyDictionaryStructs);
            /*Location4779*/yield return ("MySortedDictionary", (object)MySortedDictionary);
            /*Location4780*/yield return ("MySortedList", (object)MySortedList);
            /*Location4781*/yield break;
        }
        /*Location4782*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location4783*/if ((!exploreOnlyDeserializedChildren && MyDictionary != null) || (_MyDictionary_Accessed && _MyDictionary != null))
            {
            ...
            /*Location4784*/if ((!exploreOnlyDeserializedChildren && MyDictionaryStructs != null) || (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null))
            {
            ...
            /*Location4785*/if ((!exploreOnlyDeserializedChildren && MySortedDictionary != null) || (_MySortedDictionary_Accessed && _MySortedDictionary != null))
            {
            ...
            /*Location4786*/if ((!exploreOnlyDeserializedChildren && MySortedList != null) || (_MySortedList_Accessed && _MySortedList != null))
            {
            ...
            /*Location4787*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4790*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4791*/_MyDictionary_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4792*/_MyDictionaryStructs_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4793*/_MySortedDictionary_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4794*/_MySortedList_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4795*/_Dictionary_Values_Lazinator_EndByteIndex = bytesSoFar;
            /*Location4796*/        }
            
            /*Location4797*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4798*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4799*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4800*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4804*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4805*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location4806*/}
                                /*Location4807*//*Location4808*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location4812*/if (_MyDictionary_Accessed && _MyDictionary != null)
                                {
                                ...
                                /*Location4813*/if (_MyDictionaryStructs_Accessed && _MyDictionaryStructs != null)
                                {
                                ...
                                /*Location4814*/if (_MySortedDictionary_Accessed && _MySortedDictionary != null)
                                {
                                ...
                                /*Location4815*/if (_MySortedList_Accessed && _MySortedList != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4818*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4819*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4820*/// write properties
                                    /*Location4821*/startOfObjectPosition = writer.Position;
                                    /*Location4822*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyDictionary_Accessed)
                                    {
                                        var deserialized = MyDictionary;
                                    }
                                    /*Location4823*/WriteNonLazinatorObject(
                                    ...
                                    /*Location4824*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location4825*/startOfObjectPosition = writer.Position;
                                    /*Location4826*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyDictionaryStructs_Accessed)
                                    {
                                        var deserialized = MyDictionaryStructs;
                                    }
                                    /*Location4827*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location4828*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location4829*/startOfObjectPosition = writer.Position;
                                    /*Location4830*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MySortedDictionary_Accessed)
                                    {
                                        var deserialized = MySortedDictionary;
                                    }
                                    /*Location4831*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location4832*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location4833*/startOfObjectPosition = writer.Position;
                                    /*Location4834*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MySortedList_Accessed)
                                    {
                                        var deserialized = MySortedList;
                                    }
                                    /*Location4835*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location4836*/if (updateStoredBuffer)
                                    {
                                    ...
                                    /*Location4837*/if (updateStoredBuffer)
                                    {
                                        /*Location4838*/_Dictionary_Values_Lazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location4839*/}
                                        /*Location4840*/}
                                        /*Location4841*/
