/*Location5871*//*Location5856*///930e2200-d6a1-238f-02bd-e356b8e28789
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5857*/
    using Lazinator.Attributes;/*Location5858*/
    using Lazinator.Buffers;/*Location5859*/
    using Lazinator.Core;/*Location5860*/
    using Lazinator.Exceptions;/*Location5861*/
    using Lazinator.Support;/*Location5862*/
    using LazinatorTests.Examples;/*Location5863*/
    using System;/*Location5864*/
    using System.Buffers;/*Location5865*/
    using System.Collections.Generic;/*Location5866*/
    using System.Diagnostics;/*Location5867*/
    using System.IO;/*Location5868*/
    using System.Linq;/*Location5869*/
    using System.Runtime.InteropServices;/*Location5870*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_Nested_NonLazinator : ILazinator
    {
        /*Location5872*/public bool IsStruct => false;
        
        /*Location5873*//* Property definitions */
        
        /*Location5874*/        protected int _MyListNestedNonLazinatorType_ByteIndex;
        /*Location5875*/private int _DotNetList_Nested_NonLazinator_EndByteIndex;
        /*Location5876*/protected virtual int _MyListNestedNonLazinatorType_ByteLength => _DotNetList_Nested_NonLazinator_EndByteIndex - _MyListNestedNonLazinatorType_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5878*/typedClone.MyListNestedNonLazinatorType = CloneOrChange_List_GList_GNonLazinatorClass_g_g(MyListNestedNonLazinatorType, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5881*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5882*/yield break;
        }
        /*Location5883*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5884*/yield return ("MyListNestedNonLazinatorType", (object)MyListNestedNonLazinatorType);
            /*Location5885*/yield break;
        }
        /*Location5886*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5887*/if ((!exploreOnlyDeserializedChildren && MyListNestedNonLazinatorType != null) || (_MyListNestedNonLazinatorType_Accessed && _MyListNestedNonLazinatorType != null))
            {
            ...
            /*Location5888*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5891*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5892*/_MyListNestedNonLazinatorType_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5893*/_DotNetList_Nested_NonLazinator_EndByteIndex = bytesSoFar;
            /*Location5894*/        }
            
            /*Location5895*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5896*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5897*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5898*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5902*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5903*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5904*/}
                                /*Location5905*//*Location5906*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location5910*/if (_MyListNestedNonLazinatorType_Accessed && _MyListNestedNonLazinatorType != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5913*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5914*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5915*/// write properties
                                    /*Location5916*/startOfObjectPosition = writer.Position;
                                    /*Location5917*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNestedNonLazinatorType_Accessed)
                                    {
                                        var deserialized = MyListNestedNonLazinatorType;
                                    }
                                    /*Location5918*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5919*/if (updateStoredBuffer)
                                    {
                                        _MyListNestedNonLazinatorType_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5920*/if (updateStoredBuffer)
                                    {
                                        /*Location5921*/_DotNetList_Nested_NonLazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location5922*/}
                                        /*Location5923*/}
                                        /*Location5924*/
