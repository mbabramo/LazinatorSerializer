/*Location4797*//*Location4782*///734a4227-077c-17a0-faec-8c7ad5e2cbd6
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4783*/
    using Lazinator.Attributes;/*Location4784*/
    using Lazinator.Buffers;/*Location4785*/
    using Lazinator.Core;/*Location4786*/
    using Lazinator.Exceptions;/*Location4787*/
    using Lazinator.Support;/*Location4788*/
    using LazinatorTests.Examples;/*Location4789*/
    using System;/*Location4790*/
    using System.Buffers;/*Location4791*/
    using System.Collections.Generic;/*Location4792*/
    using System.Diagnostics;/*Location4793*/
    using System.IO;/*Location4794*/
    using System.Linq;/*Location4795*/
    using System.Runtime.InteropServices;/*Location4796*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class Derived_DotNetList_Nested_NonLazinator : DotNetList_Nested_NonLazinator, ILazinator
    {
        /*Location4798*//* Property definitions */
        
        /*Location4799*/        protected int _MyLevel2ListNestedNonLazinatorType_ByteIndex;
        /*Location4800*/private int _Derived_DotNetList_Nested_NonLazinator_EndByteIndex;
        /*Location4801*/protected virtual int _MyLevel2ListNestedNonLazinatorType_ByteLength => _Derived_DotNetList_Nested_NonLazinator_EndByteIndex - _MyLevel2ListNestedNonLazinatorType_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4804*/typedClone.MyLevel2Int = MyLevel2Int;
            /*Location4805*/typedClone.MyLevel2ListNestedNonLazinatorType = CloneOrChange_List_GList_GNonLazinatorClass_g_g(MyLevel2ListNestedNonLazinatorType, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            ...
            /*Location4810*/yield return ("MyLevel2Int", (object)MyLevel2Int);
            /*Location4811*/yield return ("MyLevel2ListNestedNonLazinatorType", (object)MyLevel2ListNestedNonLazinatorType);
            /*Location4812*/yield break;
        }
        /*Location4813*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            base.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, false);
            /*Location4814*/if ((!exploreOnlyDeserializedChildren && MyLevel2ListNestedNonLazinatorType != null) || (_MyLevel2ListNestedNonLazinatorType_Accessed && _MyLevel2ListNestedNonLazinatorType != null))
            {
            ...
            /*Location4815*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4818*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            base.ConvertFromBytesAfterHeader(OriginalIncludeChildrenMode, serializedVersionNumber, ref bytesSoFar);
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4819*/_MyLevel2Int = span.ToDecompressedInt(ref bytesSoFar);
            /*Location4820*/_MyLevel2ListNestedNonLazinatorType_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4821*/_Derived_DotNetList_Nested_NonLazinator_EndByteIndex = bytesSoFar;
            /*Location4822*/        }
            
            /*Location4823*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4824*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4825*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4826*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4830*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4831*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location4832*/}
                                /*Location4833*//*Location4834*/
                            }
                            else
                            {
                            ...
                            protected override void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
                            {
                                ...
                                /*Location4838*/if (_MyLevel2ListNestedNonLazinatorType_Accessed && _MyLevel2ListNestedNonLazinatorType != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    /*Location4841*/// write properties
                                    /*Location4842*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyLevel2Int);
                                    /*Location4843*/startOfObjectPosition = writer.Position;
                                    /*Location4844*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyLevel2ListNestedNonLazinatorType_Accessed)
                                    {
                                        var deserialized = MyLevel2ListNestedNonLazinatorType;
                                    }
                                    /*Location4845*/WriteNonLazinatorObject(
                                    ...
                                    /*Location4846*/if (updateStoredBuffer)
                                    {
                                        _MyLevel2ListNestedNonLazinatorType_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4847*/if (updateStoredBuffer)
                                    {
                                        /*Location4848*/_Derived_DotNetList_Nested_NonLazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location4849*/}
                                        /*Location4850*/}
                                        /*Location4851*/
