/*Location5947*//*Location5932*///734a4227-077c-17a0-faec-8c7ad5e2cbd6
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5933*/
    using Lazinator.Attributes;/*Location5934*/
    using Lazinator.Buffers;/*Location5935*/
    using Lazinator.Core;/*Location5936*/
    using Lazinator.Exceptions;/*Location5937*/
    using Lazinator.Support;/*Location5938*/
    using LazinatorTests.Examples;/*Location5939*/
    using System;/*Location5940*/
    using System.Buffers;/*Location5941*/
    using System.Collections.Generic;/*Location5942*/
    using System.Diagnostics;/*Location5943*/
    using System.IO;/*Location5944*/
    using System.Linq;/*Location5945*/
    using System.Runtime.InteropServices;/*Location5946*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class Derived_DotNetList_Nested_NonLazinator : DotNetList_Nested_NonLazinator, ILazinator
    {
        /*Location5948*//* Property definitions */
        
        /*Location5949*/        protected int _MyLevel2ListNestedNonLazinatorType_ByteIndex;
        /*Location5950*/private int _Derived_DotNetList_Nested_NonLazinator_EndByteIndex;
        /*Location5951*/protected virtual int _MyLevel2ListNestedNonLazinatorType_ByteLength => _Derived_DotNetList_Nested_NonLazinator_EndByteIndex - _MyLevel2ListNestedNonLazinatorType_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5954*/typedClone.MyLevel2Int = MyLevel2Int;
            /*Location5955*/typedClone.MyLevel2ListNestedNonLazinatorType = CloneOrChange_List_GList_GNonLazinatorClass_g_g(MyLevel2ListNestedNonLazinatorType, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            ...
            /*Location5960*/yield return ("MyLevel2Int", (object)MyLevel2Int);
            /*Location5961*/yield return ("MyLevel2ListNestedNonLazinatorType", (object)MyLevel2ListNestedNonLazinatorType);
            /*Location5962*/yield break;
        }
        /*Location5963*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            base.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, false);
            /*Location5964*/if ((!exploreOnlyDeserializedChildren && MyLevel2ListNestedNonLazinatorType != null) || (_MyLevel2ListNestedNonLazinatorType_Accessed && _MyLevel2ListNestedNonLazinatorType != null))
            {
            ...
            /*Location5965*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5968*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            base.ConvertFromBytesAfterHeader(OriginalIncludeChildrenMode, serializedVersionNumber, ref bytesSoFar);
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5969*/_MyLevel2Int = span.ToDecompressedInt(ref bytesSoFar);
            /*Location5970*/_MyLevel2ListNestedNonLazinatorType_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5971*/_Derived_DotNetList_Nested_NonLazinator_EndByteIndex = bytesSoFar;
            /*Location5972*/        }
            
            /*Location5973*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5974*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5975*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5976*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5980*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5981*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5982*/}
                                /*Location5983*//*Location5984*/
                            }
                            else
                            {
                            ...
                            protected override void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
                            {
                                ...
                                /*Location5988*/if (_MyLevel2ListNestedNonLazinatorType_Accessed && _MyLevel2ListNestedNonLazinatorType != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    /*Location5991*/// write properties
                                    /*Location5992*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyLevel2Int);
                                    /*Location5993*/startOfObjectPosition = writer.Position;
                                    /*Location5994*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyLevel2ListNestedNonLazinatorType_Accessed)
                                    {
                                        var deserialized = MyLevel2ListNestedNonLazinatorType;
                                    }
                                    /*Location5995*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5996*/if (updateStoredBuffer)
                                    {
                                        _MyLevel2ListNestedNonLazinatorType_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5997*/if (updateStoredBuffer)
                                    {
                                        /*Location5998*/_Derived_DotNetList_Nested_NonLazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location5999*/}
                                        /*Location6000*/}
                                        /*Location6001*/
