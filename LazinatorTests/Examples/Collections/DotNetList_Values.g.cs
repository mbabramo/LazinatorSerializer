/*Location5034*//*Location5019*///34298c90-16da-f44b-487e-148678e38ae1
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5020*/
    using Lazinator.Attributes;/*Location5021*/
    using Lazinator.Buffers;/*Location5022*/
    using Lazinator.Core;/*Location5023*/
    using Lazinator.Exceptions;/*Location5024*/
    using Lazinator.Support;/*Location5025*/
    using LazinatorTests.Examples.ExampleHierarchy;/*Location5026*/
    using System;/*Location5027*/
    using System.Buffers;/*Location5028*/
    using System.Collections.Generic;/*Location5029*/
    using System.Diagnostics;/*Location5030*/
    using System.IO;/*Location5031*/
    using System.Linq;/*Location5032*/
    using System.Runtime.InteropServices;/*Location5033*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_Values : ILazinator
    {
        /*Location5035*/public bool IsStruct => false;
        
        /*Location5036*//* Property definitions */
        
        /*Location5037*/        protected int _MyLinkedListInt_ByteIndex;
        /*Location5038*/        protected int _MyListInt_ByteIndex;
        /*Location5039*/        protected int _MyListInt2_ByteIndex;
        /*Location5040*/        protected int _MyListNullableEnabledContext_ByteIndex;
        /*Location5041*/        protected int _MySortedSetInt_ByteIndex;
        /*Location5042*/protected virtual int _MyLinkedListInt_ByteLength => _MyListInt_ByteIndex - _MyLinkedListInt_ByteIndex;
        /*Location5043*/protected virtual int _MyListInt_ByteLength => _MyListInt2_ByteIndex - _MyListInt_ByteIndex;
        /*Location5044*/protected virtual int _MyListInt2_ByteLength => _MyListNullableEnabledContext_ByteIndex - _MyListInt2_ByteIndex;
        /*Location5045*/protected virtual int _MyListNullableEnabledContext_ByteLength => _MySortedSetInt_ByteIndex - _MyListNullableEnabledContext_ByteIndex;
        /*Location5046*/private int _DotNetList_Values_EndByteIndex;
        /*Location5047*/protected virtual int _MySortedSetInt_ByteLength => _DotNetList_Values_EndByteIndex - _MySortedSetInt_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5056*/typedClone.MyLinkedListInt = CloneOrChange_LinkedList_Gint_g(MyLinkedListInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5057*/typedClone.MyListInt = CloneOrChange_List_Gint_g(MyListInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5058*/typedClone.MyListInt2 = CloneOrChange_List_Gint_g(MyListInt2, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5059*/typedClone.MyListNullableEnabledContext = CloneOrChange_List_GNullableEnabledContext_g(MyListNullableEnabledContext, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5060*/typedClone.MySortedSetInt = CloneOrChange_SortedSet_Gint_g(MySortedSetInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5063*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5064*/yield break;
        }
        /*Location5065*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5066*/yield return ("MyLinkedListInt", (object)MyLinkedListInt);
            /*Location5067*/yield return ("MyListInt", (object)MyListInt);
            /*Location5068*/yield return ("MyListInt2", (object)MyListInt2);
            /*Location5069*/yield return ("MyListNullableEnabledContext", (object)MyListNullableEnabledContext);
            /*Location5070*/yield return ("MySortedSetInt", (object)MySortedSetInt);
            /*Location5071*/yield break;
        }
        /*Location5072*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5073*/if ((!exploreOnlyDeserializedChildren && MyLinkedListInt != null) || (_MyLinkedListInt_Accessed && _MyLinkedListInt != null))
            {
            ...
            /*Location5074*/if ((!exploreOnlyDeserializedChildren && MyListInt != null) || (_MyListInt_Accessed && _MyListInt != null))
            {
            ...
            /*Location5075*/if ((!exploreOnlyDeserializedChildren && MyListInt2 != null) || (_MyListInt2_Accessed && _MyListInt2 != null))
            {
            ...
            /*Location5076*/if ((!exploreOnlyDeserializedChildren && MyListNullableEnabledContext != null) || (_MyListNullableEnabledContext_Accessed && _MyListNullableEnabledContext != null))
            {
            ...
            /*Location5077*/if ((!exploreOnlyDeserializedChildren && MySortedSetInt != null) || (_MySortedSetInt_Accessed && _MySortedSetInt != null))
            {
            ...
            /*Location5078*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5081*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5082*/_MyLinkedListInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5083*/_MyListInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5084*/_MyListInt2_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5085*/_MyListNullableEnabledContext_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5086*/_MySortedSetInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5087*/_DotNetList_Values_EndByteIndex = bytesSoFar;
            /*Location5088*/        }
            
            /*Location5089*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5090*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5091*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5092*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5096*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5097*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5098*/}
                                /*Location5099*//*Location5100*/
                            }
                            else
                            {
                            ...
                            protected virtual void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
                            {
                                ...
                                /*Location5108*/if (_MySortedSetInt_Accessed && _MySortedSetInt != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5111*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5112*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5113*/// write properties
                                    /*Location5114*/startOfObjectPosition = writer.Position;
                                    /*Location5115*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyLinkedListInt_Accessed)
                                    {
                                        var deserialized = MyLinkedListInt;
                                    }
                                    /*Location5116*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5117*/if (updateStoredBuffer)
                                    {
                                        _MyLinkedListInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5118*/startOfObjectPosition = writer.Position;
                                    /*Location5119*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListInt_Accessed)
                                    {
                                        var deserialized = MyListInt;
                                    }
                                    /*Location5120*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5121*/if (updateStoredBuffer)
                                    {
                                        _MyListInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5122*/startOfObjectPosition = writer.Position;
                                    /*Location5123*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListInt2_Accessed)
                                    {
                                        var deserialized = MyListInt2;
                                    }
                                    /*Location5124*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5125*/if (updateStoredBuffer)
                                    {
                                        _MyListInt2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5126*/startOfObjectPosition = writer.Position;
                                    /*Location5127*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNullableEnabledContext_Accessed)
                                    {
                                        var deserialized = MyListNullableEnabledContext;
                                    }
                                    /*Location5128*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5129*/if (updateStoredBuffer)
                                    {
                                        _MyListNullableEnabledContext_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5130*/startOfObjectPosition = writer.Position;
                                    /*Location5131*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MySortedSetInt_Accessed)
                                    {
                                        var deserialized = MySortedSetInt;
                                    }
                                    /*Location5132*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5133*/if (updateStoredBuffer)
                                    {
                                        _MySortedSetInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5134*/if (updateStoredBuffer)
                                    {
                                        /*Location5135*/_DotNetList_Values_EndByteIndex = writer.Position - startPosition;
                                        /*Location5136*/}
                                        /*Location5137*/}
                                        /*Location5138*/
