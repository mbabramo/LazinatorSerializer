...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetList_Values : ILazinator
    {
        ...
        private void LazinateMyLinkedListInt()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyLinkedListInt_ByteIndex, _MyLinkedListInt_ByteLength, true, false, null);_MyLinkedListInt = ConvertFromBytes_LinkedList_Gint_g(childData);
            }
            _MyLinkedListInt_Accessed = true;
        }
        ...
        private void LazinateMyListInt()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyListInt_ByteIndex, _MyListInt_ByteLength, true, false, null);_MyListInt = ConvertFromBytes_List_Gint_g(childData);
            }
            _MyListInt_Accessed = true;
        }
        ...
        private void LazinateMyListInt2()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyListInt2_ByteIndex, _MyListInt2_ByteLength, true, false, null);_MyListInt2 = ConvertFromBytes_List_Gint_g(childData);
            }
            _MyListInt2_Accessed = true;
        }
        ...
        private void LazinateMyListNullableEnabledContext()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyListNullableEnabledContext_ByteIndex, _MyListNullableEnabledContext_ByteLength, true, false, null);_MyListNullableEnabledContext = ConvertFromBytes_List_GNullableEnabledContext_g(childData);
            }
            _MyListNullableEnabledContext_Accessed = true;
        }
        ...
        private void LazinateMySortedSetInt()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MySortedSetInt_ByteIndex, _MySortedSetInt_ByteLength, true, false, null);_MySortedSetInt = ConvertFromBytes_SortedSet_Gint_g(childData);
            }
            _MySortedSetInt_Accessed = true;
        }
