...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetList_Values : ILazinator
    {
        ...
        public LinkedList<int> MyLinkedListInt
        {
            ...
            get
            {
                if (!_MyLinkedListInt_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyLinkedListInt_ByteIndex, _MyLinkedListInt_ByteLength, false, null);
        ...
        public List<int> MyListInt
        {
            ...
            get
            {
                if (!_MyListInt_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyListInt_ByteIndex, _MyListInt_ByteLength, false, null);
        ...
        public SortedSet<int> MySortedSetInt
        {
            ...
            get
            {
                if (!_MySortedSetInt_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MySortedSetInt_ByteIndex, _MySortedSetInt_ByteLength, false, null);
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyLinkedListInt_ByteIndex, _MyLinkedListInt_ByteLength, false, null),
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyListInt_ByteIndex, _MyListInt_ByteLength, false, null),
            verifyCleanness: verifyCleanness,
            binaryWriterAction: (w, v) =>
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MySortedSetInt_ByteIndex, _MySortedSetInt_ByteLength, false, null),
            verifyCleanness: verifyCleanness,
            binaryWriterAction: (w, v) =>
