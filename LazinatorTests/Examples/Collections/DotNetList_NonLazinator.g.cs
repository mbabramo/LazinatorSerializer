/*Location6008*//*Location5993*///82d755c6-9e8b-cb76-c11f-f5df86cf82ad
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5994*/
    using Lazinator.Attributes;/*Location5995*/
    using Lazinator.Buffers;/*Location5996*/
    using Lazinator.Core;/*Location5997*/
    using Lazinator.Exceptions;/*Location5998*/
    using Lazinator.Support;/*Location5999*/
    using LazinatorTests.Examples;/*Location6000*/
    using System;/*Location6001*/
    using System.Buffers;/*Location6002*/
    using System.Collections.Generic;/*Location6003*/
    using System.Diagnostics;/*Location6004*/
    using System.IO;/*Location6005*/
    using System.Linq;/*Location6006*/
    using System.Runtime.InteropServices;/*Location6007*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_NonLazinator : ILazinator
    {
        /*Location6009*/public bool IsStruct => false;
        
        /*Location6010*//* Property definitions */
        
        /*Location6011*/        protected int _MyListNonLazinatorType_ByteIndex;
        /*Location6012*/        protected int _MyListNonLazinatorType2_ByteIndex;
        /*Location6013*/protected virtual int _MyListNonLazinatorType_ByteLength => _MyListNonLazinatorType2_ByteIndex - _MyListNonLazinatorType_ByteIndex;
        /*Location6014*/private int _DotNetList_NonLazinator_EndByteIndex;
        /*Location6015*/protected virtual int _MyListNonLazinatorType2_ByteLength => _DotNetList_NonLazinator_EndByteIndex - _MyListNonLazinatorType2_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location6019*/typedClone.MyListNonLazinatorType = CloneOrChange_List_GNonLazinatorClass_g(MyListNonLazinatorType, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location6020*/typedClone.MyListNonLazinatorType2 = CloneOrChange_List_GNonLazinatorClass_g(MyListNonLazinatorType2, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location6023*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location6024*/yield break;
        }
        /*Location6025*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location6026*/yield return ("MyListNonLazinatorType", (object)MyListNonLazinatorType);
            /*Location6027*/yield return ("MyListNonLazinatorType2", (object)MyListNonLazinatorType2);
            /*Location6028*/yield break;
        }
        /*Location6029*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location6030*/if ((!exploreOnlyDeserializedChildren && MyListNonLazinatorType != null) || (_MyListNonLazinatorType_Accessed && _MyListNonLazinatorType != null))
            {
            ...
            /*Location6031*/if ((!exploreOnlyDeserializedChildren && MyListNonLazinatorType2 != null) || (_MyListNonLazinatorType2_Accessed && _MyListNonLazinatorType2 != null))
            {
            ...
            /*Location6032*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location6035*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location6036*/_MyListNonLazinatorType_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location6037*/_MyListNonLazinatorType2_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location6038*/_DotNetList_NonLazinator_EndByteIndex = bytesSoFar;
            /*Location6039*/        }
            
            /*Location6040*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location6041*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location6042*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location6043*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location6047*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location6048*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location6049*/}
                                /*Location6050*//*Location6051*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location6055*/if (_MyListNonLazinatorType_Accessed && _MyListNonLazinatorType != null)
                                {
                                ...
                                /*Location6056*/if (_MyListNonLazinatorType2_Accessed && _MyListNonLazinatorType2 != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location6059*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location6060*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location6061*/// write properties
                                    /*Location6062*/startOfObjectPosition = writer.Position;
                                    /*Location6063*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNonLazinatorType_Accessed)
                                    {
                                        var deserialized = MyListNonLazinatorType;
                                    }
                                    /*Location6064*/WriteNonLazinatorObject(
                                    ...
                                    /*Location6065*/if (updateStoredBuffer)
                                    {
                                        _MyListNonLazinatorType_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6066*/startOfObjectPosition = writer.Position;
                                    /*Location6067*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNonLazinatorType2_Accessed)
                                    {
                                        var deserialized = MyListNonLazinatorType2;
                                    }
                                    /*Location6068*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location6069*/if (updateStoredBuffer)
                                    {
                                        _MyListNonLazinatorType2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6070*/if (updateStoredBuffer)
                                    {
                                        /*Location6071*/_DotNetList_NonLazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location6072*/}
                                        /*Location6073*/}
                                        /*Location6074*/
