/*Location5112*//*Location5097*///82d755c6-9e8b-cb76-c11f-f5df86cf82ad
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5098*/
    using Lazinator.Attributes;/*Location5099*/
    using Lazinator.Buffers;/*Location5100*/
    using Lazinator.Core;/*Location5101*/
    using Lazinator.Exceptions;/*Location5102*/
    using Lazinator.Support;/*Location5103*/
    using LazinatorTests.Examples;/*Location5104*/
    using System;/*Location5105*/
    using System.Buffers;/*Location5106*/
    using System.Collections.Generic;/*Location5107*/
    using System.Diagnostics;/*Location5108*/
    using System.IO;/*Location5109*/
    using System.Linq;/*Location5110*/
    using System.Runtime.InteropServices;/*Location5111*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_NonLazinator : ILazinator
    {
        /*Location5113*/public bool IsStruct => false;
        
        /*Location5114*//* Property definitions */
        
        /*Location5115*/        protected int _MyListNonLazinatorType_ByteIndex;
        /*Location5116*/        protected int _MyListNonLazinatorType2_ByteIndex;
        /*Location5117*/protected virtual int _MyListNonLazinatorType_ByteLength => _MyListNonLazinatorType2_ByteIndex - _MyListNonLazinatorType_ByteIndex;
        /*Location5118*/private int _DotNetList_NonLazinator_EndByteIndex;
        /*Location5119*/protected virtual int _MyListNonLazinatorType2_ByteLength => _DotNetList_NonLazinator_EndByteIndex - _MyListNonLazinatorType2_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5123*/typedClone.MyListNonLazinatorType = CloneOrChange_List_GNonLazinatorClass_g(MyListNonLazinatorType, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5124*/typedClone.MyListNonLazinatorType2 = CloneOrChange_List_GNonLazinatorClass_g(MyListNonLazinatorType2, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5127*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5128*/yield break;
        }
        /*Location5129*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5130*/yield return ("MyListNonLazinatorType", (object)MyListNonLazinatorType);
            /*Location5131*/yield return ("MyListNonLazinatorType2", (object)MyListNonLazinatorType2);
            /*Location5132*/yield break;
        }
        /*Location5133*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5134*/if ((!exploreOnlyDeserializedChildren && MyListNonLazinatorType != null) || (_MyListNonLazinatorType_Accessed && _MyListNonLazinatorType != null))
            {
            ...
            /*Location5135*/if ((!exploreOnlyDeserializedChildren && MyListNonLazinatorType2 != null) || (_MyListNonLazinatorType2_Accessed && _MyListNonLazinatorType2 != null))
            {
            ...
            /*Location5136*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5139*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5140*/_MyListNonLazinatorType_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5141*/_MyListNonLazinatorType2_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5142*/_DotNetList_NonLazinator_EndByteIndex = bytesSoFar;
            /*Location5143*/        }
                ...
                /*Location5147*/if (updateStoredBuffer)
                {
                    ...
                    public virtual void UpdateStoredBuffer(ref BinaryBufferWriter writer, int startPosition, int length, IncludeChildrenMode includeChildrenMode, bool updateDeserializedChildren)
                    {
                        ...
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            ...
                            {
                                /*Location5159*/if (_MyListNonLazinatorType_Accessed && _MyListNonLazinatorType != null)
                                {
                                ...
                                /*Location5160*/if (_MyListNonLazinatorType2_Accessed && _MyListNonLazinatorType2 != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5163*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5164*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5165*/// write properties
                                    /*Location5166*/startOfObjectPosition = writer.Position;
                                    /*Location5167*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNonLazinatorType_Accessed)
                                    {
                                        var deserialized = MyListNonLazinatorType;
                                    }
                                    /*Location5168*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5169*/if (updateStoredBuffer)
                                    {
                                        _MyListNonLazinatorType_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5170*/startOfObjectPosition = writer.Position;
                                    /*Location5171*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNonLazinatorType2_Accessed)
                                    {
                                        var deserialized = MyListNonLazinatorType2;
                                    }
                                    /*Location5172*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5173*/if (updateStoredBuffer)
                                    {
                                        _MyListNonLazinatorType2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5174*/if (updateStoredBuffer)
                                    {
                                        /*Location5175*/_DotNetList_NonLazinator_EndByteIndex = writer.Position - startPosition;
                                        /*Location5176*/}
                                        /*Location5177*/}
                                        /*Location5178*/
