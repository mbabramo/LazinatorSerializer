//18dcf8b7-ba72-51cf-2f23-bfe01025a22f
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class SpanAndMemory : ILazinator
    {
        ...
        public ReadOnlyMemory<char> MyReadOnlyMemoryChar
        {
            get
            {
                if (!_MyReadOnlyMemoryChar_Accessed)
                {
                    if (_LazinatorObjectBytes.Length == 0)
                    {
                        _MyReadOnlyMemoryChar = default(Memory<char>);
                    }
                    else
                    {
        ...
        {
            _MyMemoryInt_Accessed = _MyNullableMemoryInt_Accessed = _MyReadOnlyMemoryByte_Accessed = _MyReadOnlyMemoryChar_Accessed = _MyReadOnlySpanByte_Accessed = _MyReadOnlySpanChar_Accessed = _MyReadOnlySpanDateTime_Accessed = _MyReadOnlySpanLong_Accessed = false;
            IsDirty = false;
