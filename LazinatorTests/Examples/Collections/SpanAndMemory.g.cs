//63594f5a-f6cc-93a6-7b5d-78996054d2b4
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class SpanAndMemory : ILazinator
    {
        ...
        protected virtual int _MyReadOnlyMemoryChar_ByteLength => _MyReadOnlySpanByte_ByteIndex - _MyReadOnlyMemoryChar_ByteIndex;
            ...
            get
            {
                if (!_MyNullableReadOnlyMemoryInt_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _MyNullableReadOnlyMemoryInt = ConvertFromBytes_ReadOnlyMemory_Gint_g(childData);
                    }
        ...
        {
            _MyMemoryInt_Accessed = _MyNullableMemoryInt_Accessed = _MyNullableReadOnlyMemoryInt_Accessed = _MyReadOnlyMemoryByte_Accessed = _MyReadOnlyMemoryChar_Accessed = _MyReadOnlySpanByte_Accessed = _MyReadOnlySpanChar_Accessed = _MyReadOnlySpanDateTime_Accessed = _MyReadOnlySpanLong_Accessed = false;
            IsDirty = false;
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            verifyCleanness: false,
            binaryWriterAction: (ref BinaryBufferWriter w, bool v) =>
            ConvertToBytes_ReadOnlyMemory_Gint_g(ref w, _MyNullableReadOnlyMemoryInt,
            includeChildrenMode, v, updateStoredBuffer));
            if (updateStoredBuffer)
            {
