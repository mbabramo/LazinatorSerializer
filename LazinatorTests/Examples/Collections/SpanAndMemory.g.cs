/*Location5727*//*Location5713*///a6d6426b-9aab-b020-0277-ee9ec6edaf87
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5714*/
    using Lazinator.Attributes;/*Location5715*/
    using Lazinator.Buffers;/*Location5716*/
    using Lazinator.Core;/*Location5717*/
    using Lazinator.Exceptions;/*Location5718*/
    using Lazinator.Support;/*Location5719*/
    using System;/*Location5720*/
    using System.Buffers;/*Location5721*/
    using System.Collections.Generic;/*Location5722*/
    using System.Diagnostics;/*Location5723*/
    using System.IO;/*Location5724*/
    using System.Linq;/*Location5725*/
    using System.Runtime.InteropServices;/*Location5726*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class SpanAndMemory : ILazinator
    {
        /*Location5728*/public bool IsStruct => false;
        
        /*Location5729*//* Property definitions */
        
        /*Location5730*/        protected int _MyMemoryByte_ByteIndex;
        /*Location5731*/        protected int _MyMemoryInt_ByteIndex;
        /*Location5732*/        protected int _MyNullableMemoryByte_ByteIndex;
        /*Location5733*/        protected int _MyNullableMemoryInt_ByteIndex;
        /*Location5734*/        protected int _MyNullableReadOnlyMemoryInt_ByteIndex;
        /*Location5735*/        protected int _MyReadOnlyMemoryByte_ByteIndex;
        /*Location5736*/        protected int _MyReadOnlyMemoryChar_ByteIndex;
        /*Location5737*/        protected int _MyReadOnlyMemoryInt_ByteIndex;
        /*Location5738*/        protected int _MyReadOnlySpanByte_ByteIndex;
        /*Location5739*/        protected int _MyReadOnlySpanChar_ByteIndex;
        /*Location5740*/        protected int _MyReadOnlySpanLong_ByteIndex;
        /*Location5741*/protected virtual int _MyMemoryByte_ByteLength => _MyMemoryInt_ByteIndex - _MyMemoryByte_ByteIndex;
        /*Location5742*/protected virtual int _MyMemoryInt_ByteLength => _MyNullableMemoryByte_ByteIndex - _MyMemoryInt_ByteIndex;
        /*Location5743*/protected virtual int _MyNullableMemoryByte_ByteLength => _MyNullableMemoryInt_ByteIndex - _MyNullableMemoryByte_ByteIndex;
        /*Location5744*/protected virtual int _MyNullableMemoryInt_ByteLength => _MyNullableReadOnlyMemoryInt_ByteIndex - _MyNullableMemoryInt_ByteIndex;
        /*Location5745*/protected virtual int _MyNullableReadOnlyMemoryInt_ByteLength => _MyReadOnlyMemoryByte_ByteIndex - _MyNullableReadOnlyMemoryInt_ByteIndex;
        /*Location5746*/protected virtual int _MyReadOnlyMemoryByte_ByteLength => _MyReadOnlyMemoryChar_ByteIndex - _MyReadOnlyMemoryByte_ByteIndex;
        /*Location5747*/protected virtual int _MyReadOnlyMemoryChar_ByteLength => _MyReadOnlyMemoryInt_ByteIndex - _MyReadOnlyMemoryChar_ByteIndex;
        /*Location5748*/protected virtual int _MyReadOnlyMemoryInt_ByteLength => _MyReadOnlySpanByte_ByteIndex - _MyReadOnlyMemoryInt_ByteIndex;
        /*Location5749*/protected virtual int _MyReadOnlySpanByte_ByteLength => _MyReadOnlySpanChar_ByteIndex - _MyReadOnlySpanByte_ByteIndex;
        /*Location5750*/protected virtual int _MyReadOnlySpanChar_ByteLength => _MyReadOnlySpanLong_ByteIndex - _MyReadOnlySpanChar_ByteIndex;
        /*Location5751*/private int _SpanAndMemory_EndByteIndex;
        /*Location5752*/protected virtual int _MyReadOnlySpanLong_ByteLength => _SpanAndMemory_EndByteIndex - _MyReadOnlySpanLong_ByteIndex;
        ...
        /*Location5761*/private ReadOnlyMemory<byte> _MyReadOnlySpanByte;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        /*Location5762*/private ReadOnlyMemory<byte> _MyReadOnlySpanChar;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        /*Location5763*/private ReadOnlyMemory<byte> _MyReadOnlySpanLong;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5764*/typedClone.MyMemoryByte = CloneOrChange_Memory_Gbyte_g(MyMemoryByte, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5765*/typedClone.MyMemoryInt = CloneOrChange_Memory_Gint_g(MyMemoryInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5766*/typedClone.MyNullableMemoryByte = CloneOrChange_Memory_Gbyte_g_C63(MyNullableMemoryByte, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5767*/typedClone.MyNullableMemoryInt = CloneOrChange_Memory_Gint_g_C63(MyNullableMemoryInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5768*/typedClone.MyNullableReadOnlyMemoryInt = CloneOrChange_ReadOnlyMemory_Gint_g_C63(MyNullableReadOnlyMemoryInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5769*/typedClone.MyReadOnlyMemoryByte = CloneOrChange_ReadOnlyMemory_Gbyte_g(MyReadOnlyMemoryByte, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5770*/typedClone.MyReadOnlyMemoryChar = CloneOrChange_ReadOnlyMemory_Gchar_g(MyReadOnlyMemoryChar, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5771*/typedClone.MyReadOnlyMemoryInt = CloneOrChange_ReadOnlyMemory_Gint_g(MyReadOnlyMemoryInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5772*/typedClone.MyReadOnlySpanByte = CloneOrChange_ReadOnlySpan_Gbyte_g(MyReadOnlySpanByte, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5773*/typedClone.MyReadOnlySpanChar = CloneOrChange_ReadOnlySpan_Gchar_g(MyReadOnlySpanChar, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5774*/typedClone.MyReadOnlySpanLong = CloneOrChange_ReadOnlySpan_Glong_g(MyReadOnlySpanLong, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5777*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5778*/yield break;
        }
        /*Location5779*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5780*/yield return ("MyMemoryByte", (object)MyMemoryByte);
            /*Location5781*/yield return ("MyMemoryInt", (object)MyMemoryInt);
            /*Location5782*/yield return ("MyNullableMemoryByte", (object)MyNullableMemoryByte);
            /*Location5783*/yield return ("MyNullableMemoryInt", (object)MyNullableMemoryInt);
            /*Location5784*/yield return ("MyNullableReadOnlyMemoryInt", (object)MyNullableReadOnlyMemoryInt);
            /*Location5785*/yield return ("MyReadOnlyMemoryByte", (object)MyReadOnlyMemoryByte);
            /*Location5786*/yield return ("MyReadOnlyMemoryChar", (object)MyReadOnlyMemoryChar);
            /*Location5787*/yield return ("MyReadOnlyMemoryInt", (object)MyReadOnlyMemoryInt);
            /*Location5788*/yield return ("MyReadOnlySpanByte", (object)MyReadOnlySpanByte.ToString());
            /*Location5789*/yield return ("MyReadOnlySpanChar", (object)MyReadOnlySpanChar.ToString());
            /*Location5790*/yield return ("MyReadOnlySpanLong", (object)MyReadOnlySpanLong.ToString());
            /*Location5791*/yield break;
        }
        /*Location5792*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5793*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyMemoryByte = MyMemoryByte;
            }
            /*Location5794*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyMemoryInt = MyMemoryInt;
            }
            /*Location5795*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyNullableMemoryByte = MyNullableMemoryByte;
            }
            /*Location5796*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyNullableMemoryInt = MyNullableMemoryInt;
            }
            /*Location5797*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyNullableReadOnlyMemoryInt = MyNullableReadOnlyMemoryInt;
            }
            /*Location5798*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyReadOnlyMemoryByte = MyReadOnlyMemoryByte;
            }
            /*Location5799*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyReadOnlyMemoryChar = MyReadOnlyMemoryChar;
            }
            /*Location5800*/if (!exploreOnlyDeserializedChildren)
            {
                var deserialized_MyReadOnlyMemoryInt = MyReadOnlyMemoryInt;
            }
            /*Location5801*/if (!exploreOnlyDeserializedChildren)
            {
            ...
            /*Location5802*/if (!exploreOnlyDeserializedChildren)
            {
            ...
            /*Location5803*/if (!exploreOnlyDeserializedChildren)
            {
            ...
            /*Location5804*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5807*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5808*/_MyMemoryByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5809*/_MyMemoryInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5810*/_MyNullableMemoryByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5811*/_MyNullableMemoryInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5812*/_MyNullableReadOnlyMemoryInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5813*/_MyReadOnlyMemoryByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5814*/_MyReadOnlyMemoryChar_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5815*/_MyReadOnlyMemoryInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5816*/_MyReadOnlySpanByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5817*/_MyReadOnlySpanChar_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5818*/_MyReadOnlySpanLong_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5819*/_SpanAndMemory_EndByteIndex = bytesSoFar;
            /*Location5820*/        }
            
            /*Location5821*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5822*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5823*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5824*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5828*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5829*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5830*/}
                                /*Location5831*//*Location5832*/
                            }
                            else
                            {
                            ...
                            protected virtual void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
                            {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5838*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5839*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5840*/// write properties
                                    /*Location5841*/startOfObjectPosition = writer.Position;
                                    /*Location5842*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyMemoryByte_Accessed)
                                    {
                                        var deserialized = MyMemoryByte;
                                    }
                                    /*Location5843*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5844*/if (updateStoredBuffer)
                                    {
                                        _MyMemoryByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5845*/startOfObjectPosition = writer.Position;
                                    /*Location5846*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyMemoryInt_Accessed)
                                    {
                                        var deserialized = MyMemoryInt;
                                    }
                                    /*Location5847*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5848*/if (updateStoredBuffer)
                                    {
                                        _MyMemoryInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5849*/startOfObjectPosition = writer.Position;
                                    /*Location5850*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyNullableMemoryByte_Accessed)
                                    {
                                        var deserialized = MyNullableMemoryByte;
                                    }
                                    /*Location5851*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5852*/if (updateStoredBuffer)
                                    {
                                        _MyNullableMemoryByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5853*/startOfObjectPosition = writer.Position;
                                    /*Location5854*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyNullableMemoryInt_Accessed)
                                    {
                                        var deserialized = MyNullableMemoryInt;
                                    }
                                    /*Location5855*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5856*/if (updateStoredBuffer)
                                    {
                                        _MyNullableMemoryInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5857*/startOfObjectPosition = writer.Position;
                                    /*Location5858*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyNullableReadOnlyMemoryInt_Accessed)
                                    {
                                        var deserialized = MyNullableReadOnlyMemoryInt;
                                    }
                                    /*Location5859*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5860*/if (updateStoredBuffer)
                                    {
                                        _MyNullableReadOnlyMemoryInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5861*/startOfObjectPosition = writer.Position;
                                    /*Location5862*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlyMemoryByte_Accessed)
                                    {
                                        var deserialized = MyReadOnlyMemoryByte;
                                    }
                                    /*Location5863*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5864*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlyMemoryByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5865*/startOfObjectPosition = writer.Position;
                                    /*Location5866*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlyMemoryChar_Accessed)
                                    {
                                        var deserialized = MyReadOnlyMemoryChar;
                                    }
                                    /*Location5867*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5868*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlyMemoryChar_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5869*/startOfObjectPosition = writer.Position;
                                    /*Location5870*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlyMemoryInt_Accessed)
                                    {
                                        var deserialized = MyReadOnlyMemoryInt;
                                    }
                                    /*Location5871*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5872*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlyMemoryInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5873*/startOfObjectPosition = writer.Position;
                                    /*Location5874*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlySpanByte_Accessed)
                                    {
                                        var deserialized = MyReadOnlySpanByte;
                                    }
                                    /*Location5875*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5876*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlySpanByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5877*/startOfObjectPosition = writer.Position;
                                    /*Location5878*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlySpanChar_Accessed)
                                    {
                                        var deserialized = MyReadOnlySpanChar;
                                    }
                                    /*Location5879*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5880*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlySpanChar_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5881*/startOfObjectPosition = writer.Position;
                                    /*Location5882*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyReadOnlySpanLong_Accessed)
                                    {
                                        var deserialized = MyReadOnlySpanLong;
                                    }
                                    /*Location5883*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5884*/if (updateStoredBuffer)
                                    {
                                        _MyReadOnlySpanLong_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5885*/if (updateStoredBuffer)
                                    {
                                        /*Location5886*/_SpanAndMemory_EndByteIndex = writer.Position - startPosition;
                                        /*Location5887*/}
                                        /*Location5888*/}
                                        /*Location5889*/
                                        ...
                                        {
                                            /*Location5891*/return storage.Memory.ToArray();
                                        }/*Location5892*/
                                        ...
                                        {
                                            /*Location5893*/writer.Write(itemToConvert.Span);
                                        }
                                        /*Location5894*/
                                        ...
                                        {
                                            /*Location5901*/if (itemToConvert == null)
                                            {
                                        ...
                                        {
                                            /*Location5910*/return storage.Memory.ToArray();
                                        }/*Location5911*/
                                        ...
                                        {
                                            /*Location5912*/writer.Write(itemToConvert.Span);
                                        }
                                        /*Location5913*/
                                        ...
                                        /*Location5921*/private static ReadOnlySpan<byte> CloneOrChange_ReadOnlySpan_Gbyte_g(ReadOnlySpan<byte> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
                                        {
                                        ...
                                        /*Location5923*/private static ReadOnlySpan<char> CloneOrChange_ReadOnlySpan_Gchar_g(ReadOnlySpan<char> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
                                        {
                                        ...
                                        /*Location5925*/private static ReadOnlySpan<long> CloneOrChange_ReadOnlySpan_Glong_g(ReadOnlySpan<long> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
                                        {
