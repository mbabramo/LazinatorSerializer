...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetList_Wrapper : ILazinator
    {
        ...
        public List<WNullableByte> MyListNullableByte
        {
            ...
            get
            {
                if (!_MyListNullableByte_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyListNullableByte_ByteIndex, _MyListNullableByte_ByteLength, false, null);
        ...
        public List<WNullableInt> MyListNullableInt
        {
            ...
            get
            {
                if (!_MyListNullableInt_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyListNullableInt_ByteIndex, _MyListNullableInt_ByteLength, false, null);
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyListNullableByte_ByteIndex, _MyListNullableByte_ByteLength, false, null),
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyListNullableInt_ByteIndex, _MyListNullableInt_ByteLength, false, null),
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
