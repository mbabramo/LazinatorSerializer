/*Location5167*//*Location5152*///3c6fc457-861a-ed1f-b68f-45588e292467
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5153*/
    using Lazinator.Attributes;/*Location5154*/
    using Lazinator.Buffers;/*Location5155*/
    using Lazinator.Core;/*Location5156*/
    using Lazinator.Exceptions;/*Location5157*/
    using Lazinator.Support;/*Location5158*/
    using Lazinator.Wrappers;/*Location5159*/
    using System;/*Location5160*/
    using System.Buffers;/*Location5161*/
    using System.Collections.Generic;/*Location5162*/
    using System.Diagnostics;/*Location5163*/
    using System.IO;/*Location5164*/
    using System.Linq;/*Location5165*/
    using System.Runtime.InteropServices;/*Location5166*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_Wrapper : ILazinator
    {
        /*Location5168*/public bool IsStruct => false;
        
        /*Location5169*//* Property definitions */
        
        /*Location5170*/        protected int _MyListInt_ByteIndex;
        /*Location5171*/        protected int _MyListNullableByte_ByteIndex;
        /*Location5172*/        protected int _MyListNullableInt_ByteIndex;
        /*Location5173*/protected virtual int _MyListInt_ByteLength => _MyListNullableByte_ByteIndex - _MyListInt_ByteIndex;
        /*Location5174*/protected virtual int _MyListNullableByte_ByteLength => _MyListNullableInt_ByteIndex - _MyListNullableByte_ByteIndex;
        /*Location5175*/private int _DotNetList_Wrapper_EndByteIndex;
        /*Location5176*/protected virtual int _MyListNullableInt_ByteLength => _DotNetList_Wrapper_EndByteIndex - _MyListNullableInt_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5181*/typedClone.MyListInt = CloneOrChange_List_GWInt_g(MyListInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5182*/typedClone.MyListNullableByte = CloneOrChange_List_GWNullableByte_g(MyListNullableByte, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location5183*/typedClone.MyListNullableInt = CloneOrChange_List_GWNullableInt_g(MyListNullableInt, l => l.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location5186*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5187*/yield break;
        }
        /*Location5188*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5189*/yield return ("MyListInt", (object)MyListInt);
            /*Location5190*/yield return ("MyListNullableByte", (object)MyListNullableByte);
            /*Location5191*/yield return ("MyListNullableInt", (object)MyListNullableInt);
            /*Location5192*/yield break;
        }
        /*Location5193*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5194*/if ((!exploreOnlyDeserializedChildren && MyListInt != null) || (_MyListInt_Accessed && _MyListInt != null))
            {
            ...
            /*Location5195*/if ((!exploreOnlyDeserializedChildren && MyListNullableByte != null) || (_MyListNullableByte_Accessed && _MyListNullableByte != null))
            {
            ...
            /*Location5196*/if ((!exploreOnlyDeserializedChildren && MyListNullableInt != null) || (_MyListNullableInt_Accessed && _MyListNullableInt != null))
            {
            ...
            /*Location5197*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5200*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5201*/_MyListInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5202*/_MyListNullableByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5203*/_MyListNullableInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location5204*/_DotNetList_Wrapper_EndByteIndex = bytesSoFar;
            /*Location5205*/        }
            
            /*Location5206*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5207*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5208*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5209*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5213*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5214*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5215*/}
                                /*Location5216*//*Location5217*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location5221*/if (_MyListInt_Accessed && _MyListInt != null)
                                {
                                    _MyListInt = (List<WInt>) CloneOrChange_List_GWInt_g(_MyListInt, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location5222*/if (_MyListNullableByte_Accessed && _MyListNullableByte != null)
                                {
                                ...
                                /*Location5223*/if (_MyListNullableInt_Accessed && _MyListNullableInt != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5226*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5227*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5228*/// write properties
                                    /*Location5229*/startOfObjectPosition = writer.Position;
                                    /*Location5230*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListInt_Accessed)
                                    {
                                        var deserialized = MyListInt;
                                    }
                                    /*Location5231*/WriteNonLazinatorObject(
                                    ...
                                    /*Location5232*/if (updateStoredBuffer)
                                    {
                                        _MyListInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5233*/startOfObjectPosition = writer.Position;
                                    /*Location5234*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNullableByte_Accessed)
                                    {
                                        var deserialized = MyListNullableByte;
                                    }
                                    /*Location5235*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5236*/if (updateStoredBuffer)
                                    {
                                        _MyListNullableByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5237*/startOfObjectPosition = writer.Position;
                                    /*Location5238*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNullableInt_Accessed)
                                    {
                                        var deserialized = MyListNullableInt;
                                    }
                                    /*Location5239*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location5240*/if (updateStoredBuffer)
                                    {
                                        _MyListNullableInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5241*/if (updateStoredBuffer)
                                    {
                                        /*Location5242*/_DotNetList_Wrapper_EndByteIndex = writer.Position - startPosition;
                                        /*Location5243*/}
                                        /*Location5244*/}
                                        /*Location5245*/
