/*Location6301*//*Location6286*///3c6fc457-861a-ed1f-b68f-45588e292467
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location6287*/
    using Lazinator.Attributes;/*Location6288*/
    using Lazinator.Buffers;/*Location6289*/
    using Lazinator.Core;/*Location6290*/
    using Lazinator.Exceptions;/*Location6291*/
    using Lazinator.Support;/*Location6292*/
    using Lazinator.Wrappers;/*Location6293*/
    using System;/*Location6294*/
    using System.Buffers;/*Location6295*/
    using System.Collections.Generic;/*Location6296*/
    using System.Diagnostics;/*Location6297*/
    using System.IO;/*Location6298*/
    using System.Linq;/*Location6299*/
    using System.Runtime.InteropServices;/*Location6300*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DotNetList_Wrapper : ILazinator
    {
        /*Location6302*/public bool IsStruct => false;
        
        /*Location6303*//* Property definitions */
        
        /*Location6304*/        protected int _MyListInt_ByteIndex;
        /*Location6305*/        protected int _MyListNullableByte_ByteIndex;
        /*Location6306*/        protected int _MyListNullableInt_ByteIndex;
        /*Location6307*/protected virtual int _MyListInt_ByteLength => _MyListNullableByte_ByteIndex - _MyListInt_ByteIndex;
        /*Location6308*/protected virtual int _MyListNullableByte_ByteLength => _MyListNullableInt_ByteIndex - _MyListNullableByte_ByteIndex;
        /*Location6309*/private int _DotNetList_Wrapper_EndByteIndex;
        /*Location6310*/protected virtual int _MyListNullableInt_ByteLength => _DotNetList_Wrapper_EndByteIndex - _MyListNullableInt_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location6315*/typedClone.MyListInt = CloneOrChange_List_GWInt_g(MyListInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location6316*/typedClone.MyListNullableByte = CloneOrChange_List_GWNullableByte_g(MyListNullableByte, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location6317*/typedClone.MyListNullableInt = CloneOrChange_List_GWNullableInt_g(MyListNullableInt, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location6320*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location6321*/yield break;
        }
        /*Location6322*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location6323*/yield return ("MyListInt", (object)MyListInt);
            /*Location6324*/yield return ("MyListNullableByte", (object)MyListNullableByte);
            /*Location6325*/yield return ("MyListNullableInt", (object)MyListNullableInt);
            /*Location6326*/yield break;
        }
        /*Location6327*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location6328*/if ((!exploreOnlyDeserializedChildren && MyListInt != null) || (_MyListInt_Accessed && _MyListInt != null))
            {
            ...
            /*Location6329*/if ((!exploreOnlyDeserializedChildren && MyListNullableByte != null) || (_MyListNullableByte_Accessed && _MyListNullableByte != null))
            {
            ...
            /*Location6330*/if ((!exploreOnlyDeserializedChildren && MyListNullableInt != null) || (_MyListNullableInt_Accessed && _MyListNullableInt != null))
            {
            ...
            /*Location6331*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location6334*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location6335*/_MyListInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location6336*/_MyListNullableByte_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location6337*/_MyListNullableInt_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location6338*/_DotNetList_Wrapper_EndByteIndex = bytesSoFar;
            /*Location6339*/        }
            
            /*Location6340*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location6341*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location6342*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location6343*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location6347*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location6348*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location6349*/}
                                /*Location6350*//*Location6351*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location6355*/if (_MyListInt_Accessed && _MyListInt != null)
                                {
                                    _MyListInt = (List<WInt>) CloneOrChange_List_GWInt_g(_MyListInt, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location6356*/if (_MyListNullableByte_Accessed && _MyListNullableByte != null)
                                {
                                ...
                                /*Location6357*/if (_MyListNullableInt_Accessed && _MyListNullableInt != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location6360*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location6361*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location6362*/// write properties
                                    /*Location6363*/startOfObjectPosition = writer.Position;
                                    /*Location6364*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListInt_Accessed)
                                    {
                                        var deserialized = MyListInt;
                                    }
                                    /*Location6365*/WriteNonLazinatorObject(
                                    ...
                                    /*Location6366*/if (updateStoredBuffer)
                                    {
                                        _MyListInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6367*/startOfObjectPosition = writer.Position;
                                    /*Location6368*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNullableByte_Accessed)
                                    {
                                        var deserialized = MyListNullableByte;
                                    }
                                    /*Location6369*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location6370*/if (updateStoredBuffer)
                                    {
                                        _MyListNullableByte_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6371*/startOfObjectPosition = writer.Position;
                                    /*Location6372*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListNullableInt_Accessed)
                                    {
                                        var deserialized = MyListNullableInt;
                                    }
                                    /*Location6373*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location6374*/if (updateStoredBuffer)
                                    {
                                        _MyListNullableInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6375*/if (updateStoredBuffer)
                                    {
                                        /*Location6376*/_DotNetList_Wrapper_EndByteIndex = writer.Position - startPosition;
                                        /*Location6377*/}
                                        /*Location6378*/}
                                        /*Location6379*/
