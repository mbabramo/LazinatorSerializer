...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetList_Lazinator : ILazinator
    {
        ...
        protected int _MyListSerialized_ByteLength => _DotNetList_Lazinator_EndByteIndex - _MyListSerialized_ByteIndex;
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading length of MyListSerialized at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Collections.DotNetList_Lazinator starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of DotNetList_Lazinator) ");
        }
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyListSerialized_ByteIndex, _MyListSerialized_ByteLength, true, false, null),
            ...
            if (updateStoredBuffer)
            {
                _DotNetList_Lazinator_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
