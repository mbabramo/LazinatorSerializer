...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class Dictionary_Values_SelfSerialized : ILazinator
    {
        ...
        public Dictionary<int, ExampleChild> MyDictionary
        {
            ...
            get
            {
                if (!_MyDictionary_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyDictionary_ByteIndex, _MyDictionary_ByteLength, false, null);
        ...
        public SortedDictionary<int, ExampleChild> MySortedDictionary
        {
            ...
            get
            {
                if (!_MySortedDictionary_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MySortedDictionary_ByteIndex, _MySortedDictionary_ByteLength, false, null);
        ...
        public SortedList<int, ExampleChild> MySortedList
        {
            ...
            get
            {
                if (!_MySortedList_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MySortedList_ByteIndex, _MySortedList_ByteLength, false, null);
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyDictionary_ByteIndex, _MyDictionary_ByteLength, false, null),
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MySortedDictionary_ByteIndex, _MySortedDictionary_ByteLength, false, null),
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MySortedList_ByteIndex, _MySortedList_ByteLength, false, null),
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
