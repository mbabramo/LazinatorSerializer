//dbc2ccb9-6bcb-28d5-b370-323bee1db719
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public LazinatorList<ExampleChild> MyList
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property MyList cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AllowMovedAttribute.");
                    }
