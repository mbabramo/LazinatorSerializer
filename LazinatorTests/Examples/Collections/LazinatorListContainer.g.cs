/*Location6302*//*Location6285*///f3539c5a-bb86-2072-ef98-20274c580a93
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location6286*/
    using Lazinator.Attributes;/*Location6287*/
    using Lazinator.Buffers;/*Location6288*/
    using Lazinator.Core;/*Location6289*/
    using Lazinator.Exceptions;/*Location6290*/
    using Lazinator.Support;/*Location6291*/
    using Lazinator.Wrappers;/*Location6292*/
    using LazinatorCollections;/*Location6293*/
    using LazinatorTests.Examples;/*Location6294*/
    using System;/*Location6295*/
    using System.Buffers;/*Location6296*/
    using System.Collections.Generic;/*Location6297*/
    using System.Diagnostics;/*Location6298*/
    using System.IO;/*Location6299*/
    using System.Linq;/*Location6300*/
    using System.Runtime.InteropServices;/*Location6301*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class LazinatorListContainer : ILazinator
    {
        /*Location6303*/public bool IsStruct => false;
        
        /*Location6304*//* Property definitions */
        
        /*Location6305*/        protected int _MyList_ByteIndex;
        /*Location6306*/        protected int _MyStructList_ByteIndex;
        /*Location6307*/protected virtual int _MyList_ByteLength => _MyStructList_ByteIndex - _MyList_ByteIndex;
        /*Location6308*/private int _LazinatorListContainer_EndByteIndex;
        /*Location6309*/protected virtual int _MyStructList_ByteLength => _LazinatorListContainer_EndByteIndex - _MyStructList_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location6314*/typedClone.MyInt = MyInt;
            /*Location6315*/typedClone.MyLong = MyLong;
            /*Location6316*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyList == null)
                {
            ...
            /*Location6317*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        {
            /*Location6321*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyList_Accessed) && MyList == null)
            {
            ...
            /*Location6322*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyStructList_Accessed) && MyStructList == null)
            {
            ...
            /*Location6323*/yield break;
        }
        /*Location6324*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location6325*/yield return ("MyInt", (object)MyInt);
            /*Location6326*/yield return ("MyLong", (object)MyLong);
            /*Location6327*/yield break;
        }
        /*Location6328*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location6329*/if ((!exploreOnlyDeserializedChildren && MyList != null) || (_MyList_Accessed && _MyList != null))
            {
                _MyList = (LazinatorList<ExampleChild>) _MyList.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location6330*/if ((!exploreOnlyDeserializedChildren && MyStructList != null) || (_MyStructList_Accessed && _MyStructList != null))
            {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location6335*/_MyInt = span.ToDecompressedInt(ref bytesSoFar);
            /*Location6336*/_MyLong = span.ToDecompressedLong(ref bytesSoFar);
            /*Location6337*/_MyList_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location6338*/_MyStructList_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location6339*/_LazinatorListContainer_EndByteIndex = bytesSoFar;
            /*Location6340*/        }
            
            /*Location6341*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location6342*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location6343*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location6344*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location6348*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location6349*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location6350*/}
                                /*Location6351*//*Location6352*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location6356*/if (_MyList_Accessed && _MyList != null)
                                {
                                ...
                                /*Location6357*/if (_MyStructList_Accessed && _MyStructList != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    /*Location6363*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyInt);
                                    /*Location6364*/CompressedIntegralTypes.WriteCompressedLong(ref writer, _MyLong);
                                    /*Location6365*/startOfObjectPosition = writer.Position;
                                    /*Location6366*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location6367*/if (updateStoredBuffer)
                                    {
                                        _MyList_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location6368*/startOfObjectPosition = writer.Position;
                                    /*Location6369*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location6371*/if (updateStoredBuffer)
                                    {
                                        /*Location6372*/_LazinatorListContainer_EndByteIndex = writer.Position - startPosition;
                                        /*Location6373*/}
                                        /*Location6374*/}
                                        /*Location6375*/
                                    }
