//f1297a13-f5dd-0a4b-0331-893a1fa7af43
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class ArrayMultidimensional_Values : ILazinator
    {
        ...
        public int[][,,][,,,] MyCrazyJaggedArray
        {
            ...
            get
            {
                if (!_MyCrazyJaggedArray_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyCrazyJaggedArray_ByteIndex, _MyCrazyJaggedArray_ByteLength, false, null);
        ...
        public int[,,] MyThreeDimArrayInt
        {
            ...
            get
            {
                if (!_MyThreeDimArrayInt_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyThreeDimArrayInt_ByteIndex, _MyThreeDimArrayInt_ByteLength, false, null);
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyCrazyJaggedArray_ByteIndex, _MyCrazyJaggedArray_ByteLength, false, null),
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _MyThreeDimArrayInt_ByteIndex, _MyThreeDimArrayInt_ByteLength, false, null),
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
