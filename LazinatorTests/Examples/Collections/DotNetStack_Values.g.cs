...
namespace LazinatorTests.Examples.Collections
{
    ...
    public partial class DotNetStack_Values : ILazinator
    {
        ...
        private static void ConvertToBytes_Stack_Gint_g(BinaryBufferWriter writer, Stack<Int32> itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
