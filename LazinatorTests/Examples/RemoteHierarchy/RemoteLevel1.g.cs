...
namespace LazinatorTests.Examples.RemoteHierarchy
{
    ...
    public partial class RemoteLevel1 : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Reading RemoteLevel1Int at byte location {bytesSoFar}"); 
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading length of RemoteLevel2Item at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
