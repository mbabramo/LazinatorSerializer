//c1ed5df3-a502-ade1-0f08-9ba0b83dd1aa
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.RemoteHierarchy
{
    ...
    public partial class RemoteLevel1 : ILazinator
    {
        ...
        protected virtual void UpdateDeserializedChildren(BinaryBufferWriter writer, int startPosition)
        {
            ...
            {
                RemoteLevel2Item.UpdateStoredBuffer(writer, startPosition + _RemoteLevel2Item_ByteIndex + sizeof(int), _RemoteLevel2Item_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
            }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            // write properties
            CompressedIntegralTypes.WriteCompressedInt(writer, _RemoteLevel1Int);
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                WriteChild(writer, ref _RemoteLevel2Item, includeChildrenMode, _RemoteLevel2Item_Accessed, () => GetChildSlice(LazinatorMemoryStorage, _RemoteLevel2Item_ByteIndex, _RemoteLevel2Item_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
