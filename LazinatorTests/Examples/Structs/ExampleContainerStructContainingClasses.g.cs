//5c2f0e0c-7979-45fa-4d0b-e18b665e6051
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.405, on 2024/01/27 02:29:52.107 PM.
//
...
namespace LazinatorTests.Examples
{
    ...
    [Autogenerated]
    public partial class ExampleContainerStructContainingClasses : ILazinator
    {
        ...
        private int _ExampleContainerStructContainingClasses_EndByteIndex;
        protected virtual  int _MyListUnwrappedNullableExampleStruct_ByteLength => _ExampleContainerStructContainingClasses_EndByteIndex - _MyListUnwrappedNullableExampleStruct_ByteIndex;
        protected virtual int _OverallEndByteIndex => _ExampleContainerStructContainingClasses_EndByteIndex;
        ...
        private void LazinateIntWrapper()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _IntWrapper.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateMyExampleStructContainingClasses()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _MyExampleStructContainingClasses.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        public ExampleContainerStructContainingClasses(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public ExampleContainerStructContainingClasses(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        {
            ExampleContainerStructContainingClasses clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new ExampleContainerStructContainingClasses(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (ExampleContainerStructContainingClasses)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new ExampleContainerStructContainingClasses(bytes);
            }
            return clone;
        }
        ...
        protected virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            ExampleContainerStructContainingClasses typedClone = (ExampleContainerStructContainingClasses) clone;
        ...
        protected virtual int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            _ExampleContainerStructContainingClasses_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.UpdateStoredBuffer)
            {
                _ExampleContainerStructContainingClasses_EndByteIndex = writer.ActiveMemoryPosition - startOfObjectPosition;
            }
