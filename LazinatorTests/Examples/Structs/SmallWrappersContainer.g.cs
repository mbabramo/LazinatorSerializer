//83b131e6-fe0b-acb2-b0a4-54a58b3d7c58
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public virtual void UpdateStoredBuffer(ref BinaryBufferWriter writer, int startPosition, IncludeChildrenMode includeChildrenMode, bool updateDeserializedChildren)
        {
            ...
            if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
            {
                ...
                if (updateDeserializedChildren)
                {
                    ...
                    {
                        _WrappedNullableByte.UpdateStoredBuffer(ref writer, startPosition + _WrappedNullableByte_ByteIndex, IncludeChildrenMode.IncludeAllChildren, true);
                    }
                    ...
                    {
                        _WrappedNullableChar.UpdateStoredBuffer(ref writer, startPosition + _WrappedNullableChar_ByteIndex, IncludeChildrenMode.IncludeAllChildren, true);
                    }
                    ...
                    {
                        _WrappedNullableSByte.UpdateStoredBuffer(ref writer, startPosition + _WrappedNullableSByte_ByteIndex, IncludeChildrenMode.IncludeAllChildren, true);
                    }
