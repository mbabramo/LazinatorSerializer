//e1c9dec3-1582-4273-38ae-225cc116bd20
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.420, on 2024/02/06 07:55:01.928 PM.
//
    ...
    public partial class SmallWrappersContainer : ILazinator
    {
        ...
        private void LazinateWrappedBool()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedBool.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedByte()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedByte.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedChar()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedChar.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedNullableBool()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedNullableBool.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedNullableByte()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedNullableByte.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedNullableChar()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedNullableChar.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedNullableSByte()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedNullableSByte.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
        ...
        private void LazinateWrappedSByte()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _WrappedSByte.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
