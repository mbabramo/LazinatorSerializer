//bc2d0259-6a75-71fe-8030-b939172def04
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.432, on 2024/03/21 11:39:56.257 AM.
//
    ...
    public partial class ContainerForExampleStructWithoutClass : ILazinator
    {
        ...
        private void LazinateExampleStructWithoutClass()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                _ExampleStructWithoutClass.LazinatorParents = new LazinatorParentsCollection(this, null);
            }
            else
            {
