...
namespace LazinatorTests.Examples.Structs
{
    ...
    public partial class ContainerForExampleStructWithoutClass : ILazinator
    {
        ...
        protected virtual IEnumerable<ILazinator> EnumerateLazinatorNodes_Helper(bool exploreOnlyDeserializedChildren, Func<ILazinator, bool> matchCriterion, Func<ILazinator, bool> exploreCriterion, bool stopExploringBelowMatch)
        {
            ...
            {
                foreach (ILazinator toYield in _ExampleStructWithoutClass.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, matchCriterion, exploreCriterion, stopExploringBelowMatch))
                {
