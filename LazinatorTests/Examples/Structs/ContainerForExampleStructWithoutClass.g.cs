/*Location1827*//*Location1813*///89d82994-9804-5ae4-3a9a-7cd861505b36
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1814*/
    using Lazinator.Attributes;/*Location1815*/
    using Lazinator.Buffers;/*Location1816*/
    using Lazinator.Core;/*Location1817*/
    using Lazinator.Exceptions;/*Location1818*/
    using Lazinator.Support;/*Location1819*/
    using System;/*Location1820*/
    using System.Buffers;/*Location1821*/
    using System.Collections.Generic;/*Location1822*/
    using System.Diagnostics;/*Location1823*/
    using System.IO;/*Location1824*/
    using System.Linq;/*Location1825*/
    using System.Runtime.InteropServices;/*Location1826*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ContainerForExampleStructWithoutClass : ILazinator
    {
        /*Location1828*/public bool IsStruct => false;
        
        /*Location1829*//* Property definitions */
        
        /*Location1830*/        protected int _ExampleNullableStruct_ByteIndex;
        /*Location1831*/        protected int _ExampleStructWithoutClass_ByteIndex;
        /*Location1832*/protected virtual int _ExampleNullableStruct_ByteLength => _ExampleStructWithoutClass_ByteIndex - _ExampleNullableStruct_ByteIndex;
        /*Location1833*/private int _ContainerForExampleStructWithoutClass_EndByteIndex;
        /*Location1834*/protected virtual int _ExampleStructWithoutClass_ByteLength => _ContainerForExampleStructWithoutClass_EndByteIndex - _ExampleStructWithoutClass_ByteIndex;
        ...
        /*Location1837*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        /*Location1839*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1840*/typedClone.MyInt = MyInt;
            /*Location1841*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location1842*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location1845*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1846*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ExampleNullableStruct_Accessed) && ExampleNullableStruct == null)
            {
            ...
            /*Location1847*/bool isMatch_ExampleStructWithoutClass = matchCriterion == null || matchCriterion(ExampleStructWithoutClass);
            ...
            /*Location1848*/yield break;
        }
        /*Location1849*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location1850*/yield return ("MyInt", (object)MyInt);
            /*Location1851*/yield break;
        }
        /*Location1852*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location1853*/if ((!exploreOnlyDeserializedChildren && ExampleNullableStruct != null) || (_ExampleNullableStruct_Accessed && _ExampleNullableStruct != null))
            {
            ...
            /*Location1854*/var deserialized_ExampleStructWithoutClass = ExampleStructWithoutClass;
            _ExampleStructWithoutClass = (ExampleStructWithoutClass) _ExampleStructWithoutClass.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);/*Location1855*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1858*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1859*/_MyInt = span.ToDecompressedInt(ref bytesSoFar);
            /*Location1860*/_ExampleNullableStruct_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1861*/_ExampleStructWithoutClass_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1862*/_ContainerForExampleStructWithoutClass_EndByteIndex = bytesSoFar;
            /*Location1863*/        }
            
            /*Location1864*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1865*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1866*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1867*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1871*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1872*/
                            if (updateDeserializedChildren)
                            {
                                ...
                                _ExampleStructWithoutClass_Accessed = false;/*Location1875*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1879*/if (_ExampleNullableStruct_Accessed && _ExampleNullableStruct != null)
                                {
                                ...
                                /*Location1880*/ExampleStructWithoutClass.UpdateStoredBuffer(ref writer, startPosition + _ExampleStructWithoutClass_ByteIndex + sizeof(int), _ExampleStructWithoutClass_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
                                /*Location1881*/}
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1883*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location1884*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1885*/// write properties
                                    /*Location1886*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyInt);
                                    /*Location1887*/startOfObjectPosition = writer.Position;
                                    /*Location1888*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1889*/if (updateStoredBuffer)
                                    {
                                        _ExampleNullableStruct_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1890*/startOfObjectPosition = writer.Position;
                                    /*Location1891*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1892*/if (updateStoredBuffer)
                                    {
                                        _ExampleStructWithoutClass_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1893*/if (updateStoredBuffer)
                                    {
                                        /*Location1894*/_ContainerForExampleStructWithoutClass_EndByteIndex = writer.Position - startPosition;
                                        /*Location1895*/}
                                        /*Location1896*/}
                                        /*Location1897*/
                                    }
