...
namespace LazinatorTests.Examples.Structs
{
    ...
    public partial class ExampleStructContainingStructContainer : ILazinator
    {
        ...
        protected int _Subcontainer_ByteLength => _ExampleStructContainingStructContainer_EndByteIndex - _Subcontainer_ByteIndex;
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading length of Subcontainer at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
