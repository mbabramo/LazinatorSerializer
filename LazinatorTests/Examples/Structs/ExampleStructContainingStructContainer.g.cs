...
namespace LazinatorTests.Examples.Structs
{
    ...
    public partial class ExampleStructContainingStructContainer : ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Structs.ExampleStructContainingStructContainer starting at {writer.Position}.");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, ref Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _ExampleStructContainingStructContainer_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
