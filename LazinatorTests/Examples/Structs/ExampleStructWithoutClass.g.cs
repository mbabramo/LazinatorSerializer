...
namespace LazinatorTests.Examples.Structs
{
    ...
    public partial struct ExampleStructWithoutClass : ILazinator
    {
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.Structs.ExampleStructWithoutClass at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Structs.ExampleStructWithoutClass at position {writer.ToLocationString()}");
        ...
        void WritePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of ExampleStructWithoutClass) ");
