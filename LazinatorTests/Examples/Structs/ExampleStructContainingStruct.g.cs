/*Location1838*//*Location1824*///796e292a-1d10-2226-42e1-b2f0f941ffa5
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1825*/
    using Lazinator.Attributes;/*Location1826*/
    using Lazinator.Buffers;/*Location1827*/
    using Lazinator.Core;/*Location1828*/
    using Lazinator.Exceptions;/*Location1829*/
    using Lazinator.Support;/*Location1830*/
    using System;/*Location1831*/
    using System.Buffers;/*Location1832*/
    using System.Collections.Generic;/*Location1833*/
    using System.Diagnostics;/*Location1834*/
    using System.IO;/*Location1835*/
    using System.Linq;/*Location1836*/
    using System.Runtime.InteropServices;/*Location1837*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct ExampleStructContainingStruct : ILazinator
    {
        /*Location1839*/public bool IsStruct => true;
        
        /*Location1840*//* Property definitions */
        
        /*Location1841*/        int _MyExampleNullableStruct_ByteIndex;
        /*Location1842*/        int _MyExampleStructContainingClasses_ByteIndex;
        /*Location1843*/int _MyExampleNullableStruct_ByteLength => _MyExampleStructContainingClasses_ByteIndex - _MyExampleNullableStruct_ByteIndex;
        /*Location1844*/private int _ExampleStructContainingStruct_EndByteIndex;
        /*Location1845*/int _MyExampleStructContainingClasses_ByteLength => _ExampleStructContainingStruct_EndByteIndex - _MyExampleStructContainingClasses_ByteIndex;
        ...
        /*Location1849*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1851*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location1854*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1855*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyExampleNullableStruct_Accessed) && MyExampleNullableStruct == null)
            {
            ...
            /*Location1856*/bool isMatch_MyExampleStructContainingClasses = matchCriterion == null || matchCriterion(MyExampleStructContainingClasses);
        ...
        {
            /*Location1861*/if ((!exploreOnlyDeserializedChildren && MyExampleNullableStruct != null) || (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null))
            {
            ...
            /*Location1862*/var deserialized_MyExampleStructContainingClasses = MyExampleStructContainingClasses;
            _MyExampleStructContainingClasses = (ExampleStructContainingClasses) _MyExampleStructContainingClasses.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);/*Location1863*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1866*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1867*/_MyExampleNullableStruct_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1868*/_MyExampleStructContainingClasses_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1869*/_ExampleStructContainingStruct_EndByteIndex = bytesSoFar;
            /*Location1870*/        }
            
            /*Location1871*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1872*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1873*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1874*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1878*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1879*/
                            if (updateDeserializedChildren)
                            {
                                ...
                                _MyExampleStructContainingClasses_Accessed = false;/*Location1882*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1886*/if (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null)
                                {
                                ...
                                /*Location1887*/MyExampleStructContainingClasses.UpdateStoredBuffer(ref writer, startPosition + _MyExampleStructContainingClasses_ByteIndex + sizeof(int), _MyExampleStructContainingClasses_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
                                /*Location1888*/}
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1890*/if (includeUniqueID)
                                    {
                                        CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorUniqueID);
                                    }
                                    
                                    /*Location1891*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1892*/// write properties
                                    /*Location1893*/startOfObjectPosition = writer.Position;
                                    /*Location1894*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1895*/if (updateStoredBuffer)
                                    {
                                        _MyExampleNullableStruct_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1896*/startOfObjectPosition = writer.Position;
                                    /*Location1897*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1898*/if (updateStoredBuffer)
                                    {
                                        _MyExampleStructContainingClasses_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1899*/if (updateStoredBuffer)
                                    {
                                        /*Location1900*/_ExampleStructContainingStruct_EndByteIndex = writer.Position - startPosition;
                                        /*Location1901*/}
                                        /*Location1902*/}
                                        /*Location1903*/
                                    }
