/*Location1920*//*Location1906*///796e292a-1d10-2226-42e1-b2f0f941ffa5
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1907*/
    using Lazinator.Attributes;/*Location1908*/
    using Lazinator.Buffers;/*Location1909*/
    using Lazinator.Core;/*Location1910*/
    using Lazinator.Exceptions;/*Location1911*/
    using Lazinator.Support;/*Location1912*/
    using System;/*Location1913*/
    using System.Buffers;/*Location1914*/
    using System.Collections.Generic;/*Location1915*/
    using System.Diagnostics;/*Location1916*/
    using System.IO;/*Location1917*/
    using System.Linq;/*Location1918*/
    using System.Runtime.InteropServices;/*Location1919*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct ExampleStructContainingStruct : ILazinator
    {
        /*Location1921*/public bool IsStruct => true;
        
        /*Location1922*//* Property definitions */
        
        /*Location1923*/        int _MyExampleNullableStruct_ByteIndex;
        /*Location1924*/        int _MyExampleStructContainingClasses_ByteIndex;
        /*Location1925*/int _MyExampleNullableStruct_ByteLength => _MyExampleStructContainingClasses_ByteIndex - _MyExampleNullableStruct_ByteIndex;
        /*Location1926*/private int _ExampleStructContainingStruct_EndByteIndex;
        /*Location1927*/int _MyExampleStructContainingClasses_ByteLength => _ExampleStructContainingStruct_EndByteIndex - _MyExampleStructContainingClasses_ByteIndex;
        ...
        /*Location1929*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        /*Location1931*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1932*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location1933*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location1936*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1937*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyExampleNullableStruct_Accessed) && MyExampleNullableStruct == null)
            {
            ...
            /*Location1938*/bool isMatch_MyExampleStructContainingClasses = matchCriterion == null || matchCriterion(MyExampleStructContainingClasses);
            ...
            /*Location1939*/yield break;
        }
        /*Location1940*/
        
        public IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location1941*/yield break;
        }
        /*Location1942*/
        public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location1943*/if ((!exploreOnlyDeserializedChildren && MyExampleNullableStruct != null) || (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null))
            {
            ...
            /*Location1944*/var deserialized_MyExampleStructContainingClasses = MyExampleStructContainingClasses;
            _MyExampleStructContainingClasses = (ExampleStructContainingClasses) _MyExampleStructContainingClasses.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);/*Location1945*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1948*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1949*/_MyExampleNullableStruct_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1950*/_MyExampleStructContainingClasses_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1951*/_ExampleStructContainingStruct_EndByteIndex = bytesSoFar;
            /*Location1952*/        }
            
            /*Location1953*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1954*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1955*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1956*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1960*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1961*/
                            if (updateDeserializedChildren)
                            {
                                ...
                                _MyExampleStructContainingClasses_Accessed = false;/*Location1964*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1968*/if (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null)
                                {
                                ...
                                /*Location1969*/MyExampleStructContainingClasses.UpdateStoredBuffer(ref writer, startPosition + _MyExampleStructContainingClasses_ByteIndex + sizeof(int), _MyExampleStructContainingClasses_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
                                /*Location1970*/}
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1972*/if (includeUniqueID)
                                    {
                                        CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorUniqueID);
                                    }
                                    
                                    /*Location1973*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1974*/// write properties
                                    /*Location1975*/startOfObjectPosition = writer.Position;
                                    /*Location1976*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1977*/if (updateStoredBuffer)
                                    {
                                        _MyExampleNullableStruct_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1978*/startOfObjectPosition = writer.Position;
                                    /*Location1979*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1980*/if (updateStoredBuffer)
                                    {
                                        _MyExampleStructContainingClasses_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1981*/if (updateStoredBuffer)
                                    {
                                        /*Location1982*/_ExampleStructContainingStruct_EndByteIndex = writer.Position - startPosition;
                                        /*Location1983*/}
                                        /*Location1984*/}
                                        /*Location1985*/
                                    }
