//9027a853-c342-3886-1774-ab4d0d58f5df
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.432, on 2024/03/23 04:24:48.379 PM.
//
...
namespace LazinatorTests.Examples
{
    ...
    public partial struct ExampleStructContainingStruct : ILazinator
    {
        ...
        {
            [DebuggerStepThrough]
            get => _DescendantHasChanged || (_MyExampleNullableStruct_Accessed && (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null && (MyExampleNullableStruct.Value.HasChanged || MyExampleNullableStruct.Value.DescendantHasChanged))) || (_MyExampleStructContainingClasses_Accessed && (MyExampleStructContainingClasses.HasChanged || MyExampleStructContainingClasses.DescendantHasChanged));
            [DebuggerStepThrough]
            set
            {
        ...
        {
            [DebuggerStepThrough]
            get => _DescendantIsDirty || (_MyExampleNullableStruct_Accessed && (_MyExampleNullableStruct_Accessed && _MyExampleNullableStruct != null && (MyExampleNullableStruct.Value.IsDirty || MyExampleNullableStruct.Value.DescendantIsDirty))) || (_MyExampleStructContainingClasses_Accessed && (MyExampleStructContainingClasses.IsDirty || MyExampleStructContainingClasses.DescendantIsDirty));
            [DebuggerStepThrough]
            set
            {
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                {
                    var serializedBytesCopy_MyExampleNullableStruct = LazinatorMemoryStorage;
                    var byteIndexCopy_MyExampleNullableStruct = _MyExampleNullableStruct_ByteIndex;
                    var byteLengthCopy_MyExampleNullableStruct = _MyExampleNullableStruct_ByteLength;
                    var copy = _MyExampleNullableStruct.Value;
                    WriteChild(ref writer, ref copy, options, _MyExampleNullableStruct_Accessed, () => GetChildSlice(serializedBytesCopy_MyExampleNullableStruct, byteIndexCopy_MyExampleNullableStruct, byteLengthCopy_MyExampleNullableStruct, null), null);
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                var serializedBytesCopy_MyExampleStructContainingClasses = LazinatorMemoryStorage;
                var byteIndexCopy_MyExampleStructContainingClasses = _MyExampleStructContainingClasses_ByteIndex;
                var byteLengthCopy_MyExampleStructContainingClasses = _MyExampleStructContainingClasses_ByteLength;
                WriteChild(ref writer, ref _MyExampleStructContainingClasses, options, _MyExampleStructContainingClasses_Accessed, () => GetChildSlice(serializedBytesCopy_MyExampleStructContainingClasses, byteIndexCopy_MyExampleStructContainingClasses, byteLengthCopy_MyExampleStructContainingClasses, null), null);
                lengthValue = writer.ActiveMemoryPosition - startOfChildPosition;
                if (lengthValue > int.MaxValue)
                {
                    ThrowHelper.ThrowTooLargeException(int.MaxValue);
