/*Location1497*//*Location1483*///2dc4d73f-192d-4b52-e07f-0b93f442da08
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1484*/
    using Lazinator.Attributes;/*Location1485*/
    using Lazinator.Buffers;/*Location1486*/
    using Lazinator.Core;/*Location1487*/
    using Lazinator.Exceptions;/*Location1488*/
    using Lazinator.Support;/*Location1489*/
    using System;/*Location1490*/
    using System.Buffers;/*Location1491*/
    using System.Collections.Generic;/*Location1492*/
    using System.Diagnostics;/*Location1493*/
    using System.IO;/*Location1494*/
    using System.Linq;/*Location1495*/
    using System.Runtime.InteropServices;/*Location1496*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct ExampleStructContainingClasses : ILazinator
    {
        /*Location1498*/public bool IsStruct => true;
        
        /*Location1499*//* Property definitions */
        
        /*Location1500*/        int _MyChild1_ByteIndex;
        /*Location1501*/        int _MyChild2_ByteIndex;
        /*Location1502*/        int _MyLazinatorList_ByteIndex;
        /*Location1503*/        int _MyListValues_ByteIndex;
        /*Location1504*/        int _MyTuple_ByteIndex;
        /*Location1505*/int _MyChild1_ByteLength => _MyChild2_ByteIndex - _MyChild1_ByteIndex;
        /*Location1506*/int _MyChild2_ByteLength => _MyLazinatorList_ByteIndex - _MyChild2_ByteIndex;
        /*Location1507*/int _MyLazinatorList_ByteLength => _MyListValues_ByteIndex - _MyLazinatorList_ByteIndex;
        /*Location1508*/int _MyListValues_ByteLength => _MyTuple_ByteIndex - _MyListValues_ByteIndex;
        /*Location1509*/private int _ExampleStructContainingClasses_EndByteIndex;
        /*Location1510*/int _MyTuple_ByteLength => _ExampleStructContainingClasses_EndByteIndex - _MyTuple_ByteIndex;
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1519*/typedClone.MyBool = MyBool;
            /*Location1520*/typedClone.MyChar = MyChar;
            /*Location1521*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild1 == null)
                {
            ...
            /*Location1522*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild2 == null)
                {
            ...
            /*Location1523*/typedClone.MyLazinatorList = CloneOrChange_List_GExample_g(MyLazinatorList, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location1524*/typedClone.MyListValues = CloneOrChange_List_Gint_g(MyListValues, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location1525*/typedClone.MyTuple = CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p(MyTuple, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location1528*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1529*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild1_Accessed) && MyChild1 == null)
            {
            ...
            /*Location1530*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild2_Accessed) && MyChild2 == null)
            {
            ...
            /*Location1531*/yield break;
        }
        /*Location1532*/
        
        public IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location1533*/yield return ("MyBool", (object)MyBool);
            /*Location1534*/yield return ("MyChar", (object)MyChar);
            /*Location1535*/yield return ("MyLazinatorList", (object)MyLazinatorList);
            /*Location1536*/yield return ("MyListValues", (object)MyListValues);
            /*Location1537*/yield return ("MyTuple", (object)MyTuple);
            /*Location1538*/yield break;
        }
        /*Location1539*/
        public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location1540*/if ((!exploreOnlyDeserializedChildren && MyChild1 != null) || (_MyChild1_Accessed && _MyChild1 != null))
            {
                _MyChild1 = (ExampleChild) _MyChild1.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location1541*/if ((!exploreOnlyDeserializedChildren && MyChild2 != null) || (_MyChild2_Accessed && _MyChild2 != null))
            {
                _MyChild2 = (ExampleChild) _MyChild2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location1542*/if ((!exploreOnlyDeserializedChildren && MyLazinatorList != null) || (_MyLazinatorList_Accessed && _MyLazinatorList != null))
            {
            ...
            /*Location1543*/if ((!exploreOnlyDeserializedChildren && MyListValues != null) || (_MyListValues_Accessed && _MyListValues != null))
            {
            ...
            /*Location1544*/var deserialized_MyTuple = MyTuple;
            _MyTuple = ((NonLazinatorClass myitem1, int? myitem2)) CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p(_MyTuple, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);/*Location1545*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1548*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1549*/_MyBool = span.ToBoolean(ref bytesSoFar);
            /*Location1550*/_MyChar = span.ToChar(ref bytesSoFar);
            /*Location1551*/_MyChild1_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1552*/_MyChild2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1553*/_MyLazinatorList_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1554*/_MyListValues_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1555*/_MyTuple_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1556*/_ExampleStructContainingClasses_EndByteIndex = bytesSoFar;
            /*Location1557*/        }
            
            /*Location1558*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1559*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1560*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1561*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1565*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1566*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location1567*/}
                                /*Location1568*//*Location1569*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1573*/if (_MyChild1_Accessed && _MyChild1 != null)
                                {
                                ...
                                /*Location1574*/if (_MyChild2_Accessed && _MyChild2 != null)
                                {
                                ...
                                /*Location1575*/if (_MyLazinatorList_Accessed && _MyLazinatorList != null)
                                {
                                    _MyLazinatorList = (List<Example>) CloneOrChange_List_GExample_g(_MyLazinatorList, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location1576*/if (_MyListValues_Accessed && _MyListValues != null)
                                {
                                    _MyListValues = (List<int>) CloneOrChange_List_Gint_g(_MyListValues, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location1577*/_MyTuple = ((NonLazinatorClass myitem1, int? myitem2)) CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p(_MyTuple, l => l.RemoveBufferInHierarchy(), true);/*Location1578*/}
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1580*/if (includeUniqueID)
                                    {
                                        CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorUniqueID);
                                    }
                                    
                                    /*Location1581*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1582*/// write properties
                                    /*Location1583*/WriteUncompressedPrimitives.WriteBool(ref writer, _MyBool);
                                    /*Location1584*/EncodeCharAndString.WriteCharInTwoBytes(ref writer, _MyChar);
                                    /*Location1585*/startOfObjectPosition = writer.Position;
                                    /*Location1586*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1587*/if (updateStoredBuffer)
                                    {
                                        _MyChild1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1588*/startOfObjectPosition = writer.Position;
                                    /*Location1589*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1590*/if (updateStoredBuffer)
                                    {
                                        _MyChild2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1591*/startOfObjectPosition = writer.Position;
                                    /*Location1592*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyLazinatorList_Accessed)
                                    {
                                        var deserialized = MyLazinatorList;
                                    }
                                    /*Location1593*/var serializedBytesCopy_MyLazinatorList = LazinatorMemoryStorage;
                                    ...
                                    /*Location1594*/if (updateStoredBuffer)
                                    {
                                        _MyLazinatorList_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1595*/startOfObjectPosition = writer.Position;
                                    /*Location1596*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListValues_Accessed)
                                    {
                                        var deserialized = MyListValues;
                                    }
                                    /*Location1597*/var serializedBytesCopy_MyListValues = LazinatorMemoryStorage;
                                    ...
                                    /*Location1598*/if (updateStoredBuffer)
                                    {
                                        _MyListValues_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1599*/startOfObjectPosition = writer.Position;
                                    /*Location1600*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyTuple_Accessed)
                                    {
                                        var deserialized = MyTuple;
                                    }
                                    /*Location1601*/var serializedBytesCopy_MyTuple = LazinatorMemoryStorage;
                                    ...
                                    /*Location1602*/if (updateStoredBuffer)
                                    {
                                        _MyTuple_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1603*/if (updateStoredBuffer)
                                    {
                                        /*Location1604*/_ExampleStructContainingClasses_EndByteIndex = writer.Position - startPosition;
                                        /*Location1605*/}
                                        /*Location1606*/}
                                        /*Location1607*/
                                        ...
                                        /*Location1614*/
                                        private static (NonLazinatorClass myitem1, int? myitem2) ConvertFromBytes__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p(LazinatorMemory storage)
                                        {
                                            if (storage.Length == 0)
                                            {
                                                return default;
                                        ...
                                        private static void ConvertToBytes__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p(ref BinaryBufferWriter writer, (NonLazinatorClass myitem1, int? myitem2) itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
                                        {
                                            /*Location1618*/
                                            ...
                                            /*Location1620*/}
                                            /*Location1621*/
                                            private static (NonLazinatorClass myitem1, int? myitem2) CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_n_C32myitem2_p((NonLazinatorClass myitem1, int? myitem2) itemToConvert, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
                                            {
