/*Location1489*//*Location1475*///2dc4d73f-192d-4b52-e07f-0b93f442da08
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1476*/
    using Lazinator.Attributes;/*Location1477*/
    using Lazinator.Buffers;/*Location1478*/
    using Lazinator.Core;/*Location1479*/
    using Lazinator.Exceptions;/*Location1480*/
    using Lazinator.Support;/*Location1481*/
    using System;/*Location1482*/
    using System.Buffers;/*Location1483*/
    using System.Collections.Generic;/*Location1484*/
    using System.Diagnostics;/*Location1485*/
    using System.IO;/*Location1486*/
    using System.Linq;/*Location1487*/
    using System.Runtime.InteropServices;/*Location1488*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct ExampleStructContainingClasses : ILazinator
    {
        /*Location1490*/public bool IsStruct => true;
        
        /*Location1491*//* Property definitions */
        
        /*Location1492*/        int _MyChild1_ByteIndex;
        /*Location1493*/        int _MyChild2_ByteIndex;
        /*Location1494*/        int _MyLazinatorList_ByteIndex;
        /*Location1495*/        int _MyListValues_ByteIndex;
        /*Location1496*/        int _MyTuple_ByteIndex;
        /*Location1497*/int _MyChild1_ByteLength => _MyChild2_ByteIndex - _MyChild1_ByteIndex;
        /*Location1498*/int _MyChild2_ByteLength => _MyLazinatorList_ByteIndex - _MyChild2_ByteIndex;
        /*Location1499*/int _MyLazinatorList_ByteLength => _MyListValues_ByteIndex - _MyLazinatorList_ByteIndex;
        /*Location1500*/int _MyListValues_ByteLength => _MyTuple_ByteIndex - _MyListValues_ByteIndex;
        /*Location1501*/private int _ExampleStructContainingClasses_EndByteIndex;
        /*Location1502*/int _MyTuple_ByteLength => _ExampleStructContainingClasses_EndByteIndex - _MyTuple_ByteIndex;
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1511*/typedClone.MyBool = MyBool;
            /*Location1512*/typedClone.MyChar = MyChar;
            /*Location1513*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild1 == null)
                {
            ...
            /*Location1514*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild2 == null)
                {
            ...
            /*Location1515*/typedClone.MyLazinatorList = CloneOrChange_List_GExample_g(MyLazinatorList, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location1516*/typedClone.MyListValues = CloneOrChange_List_Gint_g(MyListValues, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location1517*/typedClone.MyTuple = CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_C63_C32myitem2_p(MyTuple, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location1520*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1521*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild1_Accessed) && MyChild1 == null)
            {
            ...
            /*Location1522*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild2_Accessed) && MyChild2 == null)
            {
            ...
            /*Location1523*/yield break;
        }
        /*Location1524*/
        
        public IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location1525*/yield return ("MyBool", (object)MyBool);
            /*Location1526*/yield return ("MyChar", (object)MyChar);
            /*Location1527*/yield return ("MyLazinatorList", (object)MyLazinatorList);
            /*Location1528*/yield return ("MyListValues", (object)MyListValues);
            /*Location1529*/yield return ("MyTuple", (object)MyTuple);
            /*Location1530*/yield break;
        }
        /*Location1531*/
        public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location1532*/if ((!exploreOnlyDeserializedChildren && MyChild1 != null) || (_MyChild1_Accessed && _MyChild1 != null))
            {
                _MyChild1 = (ExampleChild) _MyChild1.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location1533*/if ((!exploreOnlyDeserializedChildren && MyChild2 != null) || (_MyChild2_Accessed && _MyChild2 != null))
            {
                _MyChild2 = (ExampleChild) _MyChild2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location1534*/if ((!exploreOnlyDeserializedChildren && MyLazinatorList != null) || (_MyLazinatorList_Accessed && _MyLazinatorList != null))
            {
            ...
            /*Location1535*/if ((!exploreOnlyDeserializedChildren && MyListValues != null) || (_MyListValues_Accessed && _MyListValues != null))
            {
            ...
            /*Location1536*/var deserialized_MyTuple = MyTuple;
            _MyTuple = ((NonLazinatorClass myitem1, int? myitem2)) CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_C63_C32myitem2_p(_MyTuple, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);/*Location1537*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1540*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1541*/_MyBool = span.ToBoolean(ref bytesSoFar);
            /*Location1542*/_MyChar = span.ToChar(ref bytesSoFar);
            /*Location1543*/_MyChild1_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1544*/_MyChild2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1545*/_MyLazinatorList_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1546*/_MyListValues_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1547*/_MyTuple_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1548*/_ExampleStructContainingClasses_EndByteIndex = bytesSoFar;
            /*Location1549*/        }
            
            /*Location1550*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1551*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1552*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1553*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1557*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1558*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location1559*/}
                                /*Location1560*//*Location1561*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1565*/if (_MyChild1_Accessed && _MyChild1 != null)
                                {
                                ...
                                /*Location1566*/if (_MyChild2_Accessed && _MyChild2 != null)
                                {
                                ...
                                /*Location1567*/if (_MyLazinatorList_Accessed && _MyLazinatorList != null)
                                {
                                    _MyLazinatorList = (List<Example>) CloneOrChange_List_GExample_g(_MyLazinatorList, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location1568*/if (_MyListValues_Accessed && _MyListValues != null)
                                {
                                    _MyListValues = (List<int>) CloneOrChange_List_Gint_g(_MyListValues, l => l.RemoveBufferInHierarchy(), true);
                                }
                                /*Location1569*/_MyTuple = ((NonLazinatorClass myitem1, int? myitem2)) CloneOrChange__PNonLazinatorClass_C32myitem1_c_C32int_C63_C32myitem2_p(_MyTuple, l => l.RemoveBufferInHierarchy(), true);/*Location1570*/}
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1572*/if (includeUniqueID)
                                    {
                                        CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorUniqueID);
                                    }
                                    
                                    /*Location1573*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1574*/// write properties
                                    /*Location1575*/WriteUncompressedPrimitives.WriteBool(ref writer, _MyBool);
                                    /*Location1576*/EncodeCharAndString.WriteCharInTwoBytes(ref writer, _MyChar);
                                    /*Location1577*/startOfObjectPosition = writer.Position;
                                    /*Location1578*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location1579*/if (updateStoredBuffer)
                                    {
                                        _MyChild1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1580*/startOfObjectPosition = writer.Position;
                                    ...
                                    /*Location1582*/if (updateStoredBuffer)
                                    {
                                        _MyChild2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1583*/startOfObjectPosition = writer.Position;
                                    /*Location1584*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyLazinatorList_Accessed)
                                    {
                                        var deserialized = MyLazinatorList;
                                    }
                                    /*Location1585*/var serializedBytesCopy_MyLazinatorList = LazinatorMemoryStorage;
                                    ...
                                    /*Location1586*/if (updateStoredBuffer)
                                    {
                                        _MyLazinatorList_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1587*/startOfObjectPosition = writer.Position;
                                    /*Location1588*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListValues_Accessed)
                                    {
                                        var deserialized = MyListValues;
                                    }
                                    /*Location1589*/var serializedBytesCopy_MyListValues = LazinatorMemoryStorage;
                                    ...
                                    /*Location1592*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyTuple_Accessed)
                                    {
                                        var deserialized = MyTuple;
                                    }
                                    /*Location1593*/var serializedBytesCopy_MyTuple = LazinatorMemoryStorage;
                                    ...
                                    /*Location1595*/if (updateStoredBuffer)
                                    {
                                        /*Location1596*/_ExampleStructContainingClasses_EndByteIndex = writer.Position - startPosition;
                                        /*Location1597*/}
                                        /*Location1598*/}
                                        /*Location1599*/
