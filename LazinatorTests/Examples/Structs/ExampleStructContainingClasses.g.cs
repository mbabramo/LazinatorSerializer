//743bcb0f-0967-7e6e-8d63-544df8ba1e74
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.432, on 2024/03/23 04:24:48.287 PM.
//
    ...
    public partial struct ExampleStructContainingClasses : ILazinator
    {
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                var serializedBytesCopy_MyChild1 = LazinatorMemoryStorage;
                var byteIndexCopy_MyChild1 = _MyChild1_ByteIndex;
                var byteLengthCopy_MyChild1 = _MyChild1_ByteLength;
                WriteChild(ref writer, ref _MyChild1, options, _MyChild1_Accessed, () => GetChildSlice(serializedBytesCopy_MyChild1, byteIndexCopy_MyChild1, byteLengthCopy_MyChild1, null), null);
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                var serializedBytesCopy_MyChild2 = LazinatorMemoryStorage;
                var byteIndexCopy_MyChild2 = _MyChild2_ByteIndex;
                var byteLengthCopy_MyChild2 = _MyChild2_ByteLength;
                WriteChild(ref writer, ref _MyChild2, options, _MyChild2_Accessed, () => GetChildSlice(serializedBytesCopy_MyChild2, byteIndexCopy_MyChild2, byteLengthCopy_MyChild2, null), null);
                lengthValue = writer.ActiveMemoryPosition - startOfChildPosition;
                if (lengthValue > int.MaxValue)
                {
                    ThrowHelper.ThrowTooLargeException(int.MaxValue);
