//4622a73b-472a-aef0-e1d5-bc0c6b666701
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class RecordLikeContainer : ILazinator
    {
        ...
        protected RecordLikeStruct _MyRecordLikeType;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public RecordLikeStruct MyRecordLikeType
        {
            get
            {
        ...
        private void Lazinate_MyRecordLikeType()
        {
            if (LazinatorObjectBytes.Length == 0)
            {
                _MyRecordLikeType = default(RecordLikeStruct);
            }
            else
            {
                ...
                _MyRecordLikeType = ConvertFromBytes_RecordLikeStruct(childData);
            }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.MyRecordLikeType = CloneOrChange_RecordLikeStruct(MyRecordLikeType, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            _MyRecordLikeType = (RecordLikeStruct) CloneOrChange_RecordLikeStruct(_MyRecordLikeType, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);var deserialized_MyRecordLikeTypeWithLazinator = MyRecordLikeTypeWithLazinator;
        ...
        protected virtual void UpdateDeserializedChildren(ref BinaryBufferWriter writer, int startPosition)
        {
            ...
            _MyRecordLikeType = (RecordLikeStruct) CloneOrChange_RecordLikeStruct(_MyRecordLikeType, l => l.RemoveBufferInHierarchy(), true);_MyRecordLikeTypeWithLazinator = (RecordLikeTypeWithLazinator) CloneOrChange_RecordLikeTypeWithLazinator(_MyRecordLikeTypeWithLazinator, l => l.RemoveBufferInHierarchy(), true);}
            ...
            protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
            {
                ...
                verifyCleanness: false,
                binaryWriterAction: (ref BinaryBufferWriter w, bool v) =>
                ConvertToBytes_RecordLikeStruct(ref w, _MyRecordLikeType,
                includeChildrenMode, v, updateStoredBuffer));
                if (updateStoredBuffer)
                {
