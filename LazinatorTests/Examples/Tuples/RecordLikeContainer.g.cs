//12531c5d-6a0a-2012-1b52-80acaaf54208
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class RecordLikeContainer : ILazinator
    {
        ...
        protected virtual int _MyNonLazinatorRecordWithoutConstructor_ByteLength => _MyRecordLikeClass_ByteIndex - _MyNonLazinatorRecordWithoutConstructor_ByteIndex;
        ...
        public virtual void FreeInMemoryObjects()
        {
            ...
            _MyMismatchedRecordLikeType_Accessed = _MyNonLazinatorRecordWithConstructor_Accessed = _MyNonLazinatorRecordWithoutConstructor_Accessed = _MyRecordLikeClass_Accessed = _MyRecordLikeStruct_Accessed = _MyRecordLikeTypeWithLazinator_Accessed = false;
            IsDirty = false;
        ...
        {
            _MyMismatchedRecordLikeType = (MismatchedRecordLikeType) CloneOrChange_MismatchedRecordLikeType(_MyMismatchedRecordLikeType, l => l.RemoveBufferInHierarchy(), true);if (_MyNonLazinatorRecordWithConstructor_Accessed && _MyNonLazinatorRecordWithConstructor != null)
            {
