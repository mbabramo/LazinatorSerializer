...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class RegularTuple : ILazinator
    {
        ...
        protected virtual void AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.MyTupleSerialized4 = Clone_Tuple_Gint_c_C32ExampleStructContainingClasses_g(MyTupleSerialized4, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer));
        }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren)
        {
            ...
            {
                _MyTupleSerialized4 = (Tuple<int, ExampleStructContainingClasses>) Clone_Tuple_Gint_c_C32ExampleStructContainingClasses_g(_MyTupleSerialized4, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren));
            }
        ...
        public virtual void UpdateStoredBuffer(ref BinaryBufferWriter writer, int startPosition, int length, IncludeChildrenMode includeChildrenMode, bool updateDeserializedChildren)
        {
            ...
            if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
            {
                ...
                if (updateDeserializedChildren)
                {
                    ...
                    {
                        _MyTupleSerialized4 = (Tuple<int, ExampleStructContainingClasses>) Clone_Tuple_Gint_c_C32ExampleStructContainingClasses_g(_MyTupleSerialized4, l => l.RemoveBufferInHierarchy());
                    }
                }
        ...
        private static Tuple<int, ExampleStructContainingClasses> Clone_Tuple_Gint_c_C32ExampleStructContainingClasses_g(Tuple<int, ExampleStructContainingClasses> itemToConvert, Func<ILazinator, ILazinator> cloneOrChangeFunc)
        {
            if (itemToConvert == null)
            {
