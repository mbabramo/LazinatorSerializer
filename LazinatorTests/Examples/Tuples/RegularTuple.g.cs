//da8705e7-add2-0650-b592-e886915fcf34
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class RegularTuple : ILazinator
    {
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren && !_MyListTuple_Accessed)
            {
        ...
        private static List<Tuple<uint, ExampleChild, NonLazinatorClass>> Clone_List_GTuple_Guint_c_C32ExampleChild_c_C32NonLazinatorClass_g_g(List<Tuple<uint, ExampleChild, NonLazinatorClass>> itemToClone)
        {
            if (itemToClone == null)
            {
                return default;
