//717dc6fe-8cf5-8232-bb26-44ce6412fb5a
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class StructTuple : ILazinator
    {
        ...
        protected int _MyValueTupleNullableStructs_ByteIndex;
        ...
        protected virtual int _MyNullableTuple_ByteLength => _MyValueTupleNullableStructs_ByteIndex - _MyNullableTuple_ByteIndex;
        ...
        private void LazinateEnumTuple()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _EnumTuple_ByteIndex, _EnumTuple_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_EnumTuple = ConvertFromBytes__PTestEnum_C32firstEnum_c_C32TestEnum_C32anotherEnum_p(childData);
            }
            _EnumTuple_Accessed = true;
        }
        
        
        protected (Int32 MyFirstItem, Double MySecondItem) _MyNamedTuple;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public (Int32 MyFirstItem, Double MySecondItem) MyNamedTuple
        {
            get
            {
        ...
        private void LazinateMyNamedTuple()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyNamedTuple_ByteIndex, _MyNamedTuple_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_MyNamedTuple = ConvertFromBytes__Pint_C32MyFirstItem_c_C32double_C32MySecondItem_p(childData);
            }
            _MyNamedTuple_Accessed = true;
        }
        
        
        protected (Int32, Double)? _MyNullableTuple;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public (Int32, Double)? MyNullableTuple
        {
            get
            {
        ...
        private void LazinateMyNullableTuple()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyNullableTuple_ByteIndex, _MyNullableTuple_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_MyNullableTuple = ConvertFromBytes__Pint_c_C32double_p_n(childData);
            }
            _MyNullableTuple_Accessed = true;
        }
        ...
        private void LazinateMyValueTupleNullableStructs()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyValueTupleNullableStructs_ByteIndex, _MyValueTupleNullableStructs_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_MyValueTupleNullableStructs = ConvertFromBytes__PExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_p(childData);
            }
            _MyValueTupleNullableStructs_Accessed = true;
        }
        
        
        protected (UInt32, ExampleChild, NonLazinatorClass) _MyValueTupleSerialized;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public (UInt32, ExampleChild, NonLazinatorClass) MyValueTupleSerialized
        {
            get
            {
        ...
        private void LazinateMyValueTupleSerialized()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyValueTupleSerialized_ByteIndex, _MyValueTupleSerialized_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_MyValueTupleSerialized = ConvertFromBytes__Puint_c_C32ExampleChild_c_C32NonLazinatorClass_p(childData);
            }
            _MyValueTupleSerialized_Accessed = true;
        }
        
        
        protected (WInt32, WInt32) _MyValueTupleStructs;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public (WInt32, WInt32) MyValueTupleStructs
        {
            get
            {
        ...
        private void LazinateMyValueTupleStructs()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyValueTupleStructs_ByteIndex, _MyValueTupleStructs_ByteLength, null);
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_MyValueTupleStructs = ConvertFromBytes__PWInt32_c_C32WInt32_p(childData);
            }
            _MyValueTupleStructs_Accessed = true;
        }
        ...
        public StructTuple(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
        ...
        protected virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.MyValueTupleStructs = CloneOrChange__PWInt32_c_C32WInt32_p(MyValueTupleStructs, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            ...
            yield return ("MyValueTupleNullableStructs", (object)MyValueTupleNullableStructs);
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            var deserialized_MyNamedTuple = MyNamedTuple;
            _MyNamedTuple = ((Int32 MyFirstItem, Double MySecondItem)) CloneOrChange__Pint_C32MyFirstItem_c_C32double_C32MySecondItem_p(_MyNamedTuple, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            if ((!exploreOnlyDeserializedChildren && MyNullableTuple != null) || (_MyNullableTuple_Accessed && _MyNullableTuple != null))
            {
                _MyNullableTuple = ((Int32, Double)?) CloneOrChange__Pint_c_C32double_p_n(_MyNullableTuple, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
            ...
            var deserialized_MyValueTupleSerialized = MyValueTupleSerialized;
            _MyValueTupleSerialized = ((UInt32, ExampleChild, NonLazinatorClass)) CloneOrChange__Puint_c_C32ExampleChild_c_C32NonLazinatorClass_p(_MyValueTupleSerialized, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            var deserialized_MyValueTupleStructs = MyValueTupleStructs;
            _MyValueTupleStructs = ((WInt32, WInt32)) CloneOrChange__PWInt32_c_C32WInt32_p(_MyValueTupleStructs, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
        ...
        protected virtual int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.Tuples.StructTuple at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        protected virtual int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"EnumTuple: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
            _EnumTuple_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            TabbedText.WriteLine($"MyNamedTuple: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
            _MyNamedTuple_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            TabbedText.WriteLine($"MyNullableTuple: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
            _MyNullableTuple_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            TabbedText.WriteLine($"MyValueTupleNullableStructs: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
            _MyValueTupleNullableStructs_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            TabbedText.WriteLine($"MyValueTupleSerialized: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
            _MyValueTupleSerialized_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            TabbedText.WriteLine($"MyValueTupleStructs: Length is {bytesSoFar} past above position; start location is {indexOfFirstChild + totalChildrenBytes} past above position"); 
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Tuples.StructTuple at position {writer.ToLocationString()}");
        ...
        protected virtual void UpdateDeserializedChildren(ref BufferWriter writer, long startPosition)
        {
            ...
            {
                _MyNullableTuple = ((Int32, Double)?) CloneOrChange__Pint_c_C32double_p_n(_MyNullableTuple, l => l.RemoveBufferInHierarchy(), true);
            }
            _MyValueTupleNullableStructs = ((ExampleStructContainingClasses?, ExampleStructContainingClasses?, ExampleStructContainingClasses?)) CloneOrChange__PExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_p(_MyValueTupleNullableStructs, l => l.RemoveBufferInHierarchy(), true);
            _MyValueTupleSerialized = ((UInt32, ExampleChild, NonLazinatorClass)) CloneOrChange__Puint_c_C32ExampleChild_c_C32NonLazinatorClass_p(_MyValueTupleSerialized, l => l.RemoveBufferInHierarchy(), true);
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Tuples.StructTuple.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of StructTuple) ");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, EnumTuple (accessed? {_EnumTuple_Accessed})");
            TabbedText.Tabs++;
            ...
            nonLazinatorObject: _EnumTuple, isBelievedDirty: _EnumTuple_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _EnumTuple_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _EnumTuple_ByteIndex, _EnumTuple_ByteLength, null),
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, MyNamedTuple (accessed? {_MyNamedTuple_Accessed})");
            TabbedText.Tabs++;
            startOfChildPosition = writer.ActiveMemoryPosition;
            if ((options.IncludeChildrenMode != IncludeChildrenMode.IncludeAllChildren || options.IncludeChildrenMode != OriginalIncludeChildrenMode) && !_MyNamedTuple_Accessed)
            {
                var deserialized = MyNamedTuple;
            }
            WriteNonLazinatorObject(
            nonLazinatorObject: _MyNamedTuple, isBelievedDirty: _MyNamedTuple_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _MyNamedTuple_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyNamedTuple_ByteIndex, _MyNamedTuple_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, MyNullableTuple (accessed? {_MyNullableTuple_Accessed})");
            TabbedText.Tabs++;
            startOfChildPosition = writer.ActiveMemoryPosition;
            if ((options.IncludeChildrenMode != IncludeChildrenMode.IncludeAllChildren || options.IncludeChildrenMode != OriginalIncludeChildrenMode) && !_MyNullableTuple_Accessed)
            {
                var deserialized = MyNullableTuple;
            }
            WriteNonLazinatorObject(
            nonLazinatorObject: _MyNullableTuple, isBelievedDirty: _MyNullableTuple_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _MyNullableTuple_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyNullableTuple_ByteIndex, _MyNullableTuple_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, MyValueTupleNullableStructs (accessed? {_MyValueTupleNullableStructs_Accessed})");
            TabbedText.Tabs++;
            startOfChildPosition = writer.ActiveMemoryPosition;
            if ((options.IncludeChildrenMode != IncludeChildrenMode.IncludeAllChildren || options.IncludeChildrenMode != OriginalIncludeChildrenMode) && !_MyValueTupleNullableStructs_Accessed)
            {
                var deserialized = MyValueTupleNullableStructs;
            }
            WriteNonLazinatorObject(
            nonLazinatorObject: _MyValueTupleNullableStructs, isBelievedDirty: _MyValueTupleNullableStructs_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _MyValueTupleNullableStructs_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyValueTupleNullableStructs_ByteIndex, _MyValueTupleNullableStructs_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, MyValueTupleSerialized (accessed? {_MyValueTupleSerialized_Accessed})");
            TabbedText.Tabs++;
            startOfChildPosition = writer.ActiveMemoryPosition;
            if ((options.IncludeChildrenMode != IncludeChildrenMode.IncludeAllChildren || options.IncludeChildrenMode != OriginalIncludeChildrenMode) && !_MyValueTupleSerialized_Accessed)
            {
                var deserialized = MyValueTupleSerialized;
            }
            WriteNonLazinatorObject(
            nonLazinatorObject: _MyValueTupleSerialized, isBelievedDirty: _MyValueTupleSerialized_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _MyValueTupleSerialized_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyValueTupleSerialized_ByteIndex, _MyValueTupleSerialized_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, MyValueTupleStructs (accessed? {_MyValueTupleStructs_Accessed})");
            TabbedText.Tabs++;
            startOfChildPosition = writer.ActiveMemoryPosition;
            if ((options.IncludeChildrenMode != IncludeChildrenMode.IncludeAllChildren || options.IncludeChildrenMode != OriginalIncludeChildrenMode) && !_MyValueTupleStructs_Accessed)
            {
                var deserialized = MyValueTupleStructs;
            }
            WriteNonLazinatorObject(
            nonLazinatorObject: _MyValueTupleStructs, isBelievedDirty: _MyValueTupleStructs_Accessed || (options.IncludeChildrenMode != OriginalIncludeChildrenMode),
            isAccessed: _MyValueTupleStructs_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MyValueTupleStructs_ByteIndex, _MyValueTupleStructs_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
        ...
        private static (TestEnum firstEnum, TestEnum anotherEnum) ConvertFromBytes__PTestEnum_C32firstEnum_c_C32TestEnum_C32anotherEnum_p(LazinatorMemory storage)
        {
            ...
            TestEnum item1 = (TestEnum)span.ToDecompressedInt32(ref bytesSoFar);
            
            TestEnum item2 = (TestEnum)span.ToDecompressedInt32(ref bytesSoFar);
        ...
        private static void ConvertToBytes__PTestEnum_C32firstEnum_c_C32TestEnum_C32anotherEnum_p(ref BufferWriter writer, (TestEnum firstEnum, TestEnum anotherEnum) itemToConvert, LazinatorSerializationOptions options)
        {
        ...
        private static void ConvertToBytes__Pint_C32MyFirstItem_c_C32double_C32MySecondItem_p(ref BufferWriter writer, (Int32 MyFirstItem, Double MySecondItem) itemToConvert, LazinatorSerializationOptions options)
        {
        ...
        private static void ConvertToBytes__Pint_c_C32double_p_n(ref BufferWriter writer, (Int32, Double)? itemToConvert, LazinatorSerializationOptions options)
        {
        ...
        private static void ConvertToBytes__PExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_c_C32ExampleStructContainingClasses_n_p(ref BufferWriter writer, (ExampleStructContainingClasses?, ExampleStructContainingClasses?, ExampleStructContainingClasses?) itemToConvert, LazinatorSerializationOptions options)
        {
            ...
            void actionItem2(ref BufferWriter w) => itemToConvert.Item2?.SerializeToExistingBuffer(ref w, options);
            WriteToBinaryWithInt32LengthPrefix(ref writer, actionItem2);
            
            void actionItem3(ref BufferWriter w) => itemToConvert.Item3?.SerializeToExistingBuffer(ref w, options);
        ...
        private static void ConvertToBytes__Puint_c_C32ExampleChild_c_C32NonLazinatorClass_p(ref BufferWriter writer, (UInt32, ExampleChild, NonLazinatorClass) itemToConvert, LazinatorSerializationOptions options)
        {
        ...
        private static (WInt32, WInt32) ConvertFromBytes__PWInt32_c_C32WInt32_p(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default;
        ...
        private static void ConvertToBytes__PWInt32_c_C32WInt32_p(ref BufferWriter writer, (WInt32, WInt32) itemToConvert, LazinatorSerializationOptions options)
        {
        ...
        {
            return ((WInt32) (cloneOrChangeFunc((itemToConvert.Item1))), (WInt32) (cloneOrChangeFunc((itemToConvert.Item2))));
        }
