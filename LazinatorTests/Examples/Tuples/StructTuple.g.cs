//c5e42297-8e76-9f61-a3a6-6b41870fab85
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Tuples
{
    ...
    public partial class StructTuple : ILazinator
    {
        ...
        private ValueTuple<>? _MyNullableTuple;
        public ValueTuple<>? MyNullableTuple
        {
            [DebuggerStepThrough]
            get
            {
                if (!_MyNullableTuple_Accessed)
                {
                    ...
                    {
                        _MyNullableTuple = default(ValueTuple<>?);
                    }
                    else
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyNullableTuple_ByteIndex, _MyNullableTuple_ByteLength);
                        _MyNullableTuple = ConvertFromBytes_Nullable_ValueTuple(childData, DeserializationFactory, null);
                    }
        ...
        private ValueTuple<> _MyValueTupleSerialized;
        public ValueTuple<> MyValueTupleSerialized
        {
            [DebuggerStepThrough]
            get
            {
                if (!_MyValueTupleSerialized_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _MyValueTupleSerialized = default(ValueTuple<>);
                    }
                    else
                    {
                        ...
                        _MyValueTupleSerialized = ConvertFromBytes_ValueTuple(childData, DeserializationFactory, null);
                    }
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_Nullable_ValueTuple(w, MyNullableTuple,
            ...
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
            ConvertToBytes_ValueTuple(w, MyValueTupleSerialized,
            includeChildrenMode, v));
        }
        
        /* Conversion of supported collections and tuples */
        
        private static ValueTuple<>? ConvertFromBytes_Nullable_ValueTuple(ReadOnlyMemory<byte> storage, DeserializationFactory deserializationFactory, InformParentOfDirtinessDelegate informParentOfDirtinessDelegate)
        {
            if (storage.Length == 0)
            {
                return default;
        ...
        private static void ConvertToBytes_Nullable_ValueTuple(BinaryBufferWriter writer, ValueTuple<>? itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
