//15796619-68b0-ac74-3341-0830073972fa
//------------------------------------------------------------------------------
// <auto-generated>
    ...
    public partial class StructTuple : ILazinator
    {
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren)
        {
            ...
            if ((!exploreOnlyDeserializedChildren && true) || (true))
            {
                ...
                _MyValueTupleStructs = ((WInt, WInt)) CloneOrChange__PWInt_c_C32WInt_p(_MyValueTupleStructs, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren), true);
            }
