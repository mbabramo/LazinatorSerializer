...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class ConcreteGenericContainer : ILazinator
    {
        ...
        public override IAbstractGeneric1<int> Item
        {
            ...
            get
            {
                if (!_Item_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _Item_ByteIndex, _Item_ByteLength, false, null);
                        
                        if (DeserializationFactory == null)
                        {
                            DeserializationFactory = DeserializationFactory.GetInstance();
                        }
                        _Item = DeserializationFactory.CreateBasedOnType<IAbstractGeneric1<int>>(childData, this); 
                    }
                    _Item_Accessed = true;
                }
                return _Item;
        ...
        protected override void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _Item, includeChildrenMode, _Item_Accessed, () => GetChildSlice(LazinatorObjectBytes, _Item_ByteIndex, _Item_ByteLength, false, null), verifyCleanness, false, false, this);
            }
        }
