//de7fe258-014a-84c7-3d95-a2eac8b9e649
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public override IAbstractGeneric1<int> Item
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property Item cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AllowMovedAttribute.");
                    }
