//6fc63ad0-ede0-a028-d666-618f41fcb28a
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public override IAbstractGeneric1<int> Item
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property Item cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
