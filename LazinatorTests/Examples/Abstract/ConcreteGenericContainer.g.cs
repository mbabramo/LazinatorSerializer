//7c39a32d-9a0d-f9ce-031f-2bd565df1d94
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public override IAbstractGeneric1<int> Item
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property Item cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
