//2741ef4f-04b1-14e6-13e9-fb8ef3c34b14
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class ConcreteGenericContainer : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_Item_Accessed && _Item != null))
            {
                foreach (ILazinator toYield in _Item.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
