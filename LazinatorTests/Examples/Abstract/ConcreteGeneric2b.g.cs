/*Location4315*//*Location4300*///281d3e9e-6aa8-707e-96fd-ab8038d6c5ad
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4301*/
    using Lazinator.Attributes;/*Location4302*/
    using Lazinator.Buffers;/*Location4303*/
    using Lazinator.Core;/*Location4304*/
    using Lazinator.Exceptions;/*Location4305*/
    using Lazinator.Support;/*Location4306*/
    using LazinatorTests.Examples;/*Location4307*/
    using System;/*Location4308*/
    using System.Buffers;/*Location4309*/
    using System.Collections.Generic;/*Location4310*/
    using System.Diagnostics;/*Location4311*/
    using System.IO;/*Location4312*/
    using System.Linq;/*Location4313*/
    using System.Runtime.InteropServices;/*Location4314*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ConcreteGeneric2b : ILazinator
    {
        /*Location4316*//* Property definitions */
        
        /*Location4317*/        protected int _LazinatorExample_ByteIndex;
        /*Location4318*/protected override int _MyT_ByteLength => _LazinatorExample_ByteIndex - _MyT_ByteIndex;
        /*Location4319*/private int _ConcreteGeneric2b_EndByteIndex;
        /*Location4320*/protected virtual int _LazinatorExample_ByteLength => _ConcreteGeneric2b_EndByteIndex - _LazinatorExample_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4327*/typedClone.MyEnumWithinAbstractGeneric = MyEnumWithinAbstractGeneric;
            /*Location4328*/typedClone.MyEnumWithinAbstractGeneric2 = MyEnumWithinAbstractGeneric2;
            /*Location4329*/typedClone.MyUnofficialInt = MyUnofficialInt;
            /*Location4330*/typedClone.AnotherProperty = AnotherProperty;
            /*Location4331*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyT == null)
                {
                    typedClone.MyT = null;
            ...
            /*Location4332*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location4335*/public override IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location4336*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyT_Accessed) && MyT == null)
            {
            ...
            /*Location4337*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _LazinatorExample_Accessed) && LazinatorExample == null)
            {
            ...
            /*Location4338*/yield break;
        }
        /*Location4339*/
        
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location4340*/yield return ("MyEnumWithinAbstractGeneric", (object)MyEnumWithinAbstractGeneric);
            /*Location4341*/yield return ("MyEnumWithinAbstractGeneric2", (object)MyEnumWithinAbstractGeneric2);
            /*Location4342*/yield return ("MyUnofficialInt", (object)MyUnofficialInt);
            /*Location4343*/yield return ("AnotherProperty", (object)AnotherProperty);
            /*Location4344*/yield break;
        }
        /*Location4345*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location4346*/if ((!exploreOnlyDeserializedChildren && MyT != null) || (_MyT_Accessed && _MyT != null))
            {
                _MyT = (Example) _MyT.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location4347*/if ((!exploreOnlyDeserializedChildren && LazinatorExample != null) || (_LazinatorExample_Accessed && _LazinatorExample != null))
            {
                _LazinatorExample = (Example) _LazinatorExample.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location4348*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4351*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4352*/_MyEnumWithinAbstractGeneric = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<global::LazinatorTests.Examples.Example>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4353*/_MyEnumWithinAbstractGeneric2 = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<int>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4354*/_MyUnofficialInt = span.ToDecompressedInt(ref bytesSoFar);
            /*Location4355*/_AnotherProperty = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location4356*/_MyT_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4357*/_LazinatorExample_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4358*/_ConcreteGeneric2b_EndByteIndex = bytesSoFar;
            /*Location4359*/        }
            
            /*Location4360*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4361*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4362*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4363*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4367*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4368*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location4369*/}
                                /*Location4370*//*Location4371*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location4375*/if (_MyT_Accessed && _MyT != null)
                                {
                                ...
                                /*Location4376*/if (_LazinatorExample_Accessed && _LazinatorExample != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4379*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4380*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4381*/// write properties
                                    /*Location4382*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric);
                                    /*Location4383*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric2);
                                    /*Location4384*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyUnofficialInt);
                                    /*Location4385*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _AnotherProperty);
                                    /*Location4386*/startOfObjectPosition = writer.Position;
                                    /*Location4387*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4388*/if (updateStoredBuffer)
                                    {
                                        _MyT_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4389*/startOfObjectPosition = writer.Position;
                                    /*Location4390*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4391*/if (updateStoredBuffer)
                                    {
                                        _LazinatorExample_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4392*/if (updateStoredBuffer)
                                    {
                                        /*Location4393*/_ConcreteGeneric2b_EndByteIndex = writer.Position - startPosition;
                                        /*Location4394*/}
                                        /*Location4395*/}
                                        /*Location4396*/
                                    }
