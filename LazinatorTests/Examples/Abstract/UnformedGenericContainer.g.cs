//c09c7222-dcd2-74e6-4824-9c8f017ef682
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Abstract
{
    ...
    [Autogenerated]
    public partial class UnformedGenericContainer<T> : ILazinator
    {
        /* Serialization, deserialization, and object relationships */
        
        public UnformedGenericContainer() : base()
        {
        }
        ...
        public virtual ILazinator CloneLazinator(IncludeChildrenMode includeChildrenMode)
        {
            ...
            var clone = new UnformedGenericContainer<T>()
            {
        ...
        private int _UnformedGenericContainer_T_EndByteIndex;
        protected virtual int _Item_ByteLength => _UnformedGenericContainer_T_EndByteIndex - _Item_ByteIndex;
            ...
            get
            {
                if (!_Item_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Item = DeserializationFactory.CreateAbstractType<AbstractGeneric1<T>>(childData, this); 
                    }
                    _Item_Accessed = true;
                }
                return _Item;
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _UnformedGenericContainer_T_EndByteIndex = bytesSoFar;
        }
