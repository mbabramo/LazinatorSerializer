...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class Concrete6 : Concrete5, ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Abstract.Concrete6 starting at {writer.Position}.");
        ...
        protected override void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _IntList6_ByteIndex = writer.Position - startOfObjectPosition;
            }
            TabbedText.Tabs--;
            if (updateStoredBuffer)
            {
                _Concrete6_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
