//2e6d3485-3c72-17d8-cc8a-15f755afed2d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class BaseContainer : ILazinator
    {
        ...
        {
            if (_MyBase_Accessed && _MyBase != null && (_MyBase.IsDirty || _MyBase.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _MyBase.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestDirty))
                {
