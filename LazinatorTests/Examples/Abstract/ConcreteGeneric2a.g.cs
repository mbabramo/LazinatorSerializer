/*Location4412*//*Location4397*///16fef5c2-d209-765a-0c18-736d147c6cdd
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4398*/
    using Lazinator.Attributes;/*Location4399*/
    using Lazinator.Buffers;/*Location4400*/
    using Lazinator.Core;/*Location4401*/
    using Lazinator.Exceptions;/*Location4402*/
    using Lazinator.Support;/*Location4403*/
    using LazinatorTests.Examples;/*Location4404*/
    using System;/*Location4405*/
    using System.Buffers;/*Location4406*/
    using System.Collections.Generic;/*Location4407*/
    using System.Diagnostics;/*Location4408*/
    using System.IO;/*Location4409*/
    using System.Linq;/*Location4410*/
    using System.Runtime.InteropServices;/*Location4411*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ConcreteGeneric2a : ILazinator
    {
        /*Location4413*//* Property definitions */
        
        /*Location4414*/        protected int _LazinatorExample_ByteIndex;
        /*Location4415*/private int _ConcreteGeneric2a_EndByteIndex;
        /*Location4416*/protected virtual int _LazinatorExample_ByteLength => _ConcreteGeneric2a_EndByteIndex - _LazinatorExample_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4423*/typedClone.MyEnumWithinAbstractGeneric = MyEnumWithinAbstractGeneric;
            /*Location4424*/typedClone.MyEnumWithinAbstractGeneric2 = MyEnumWithinAbstractGeneric2;
            /*Location4425*/typedClone.MyT = MyT;
            /*Location4426*/typedClone.MyUnofficialInt = MyUnofficialInt;
            /*Location4427*/typedClone.AnotherProperty = AnotherProperty;
            /*Location4428*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location4431*/public override IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location4432*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _LazinatorExample_Accessed) && LazinatorExample == null)
            {
            ...
            /*Location4433*/yield break;
        }
        /*Location4434*/
        
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location4435*/yield return ("MyEnumWithinAbstractGeneric", (object)MyEnumWithinAbstractGeneric);
            /*Location4436*/yield return ("MyEnumWithinAbstractGeneric2", (object)MyEnumWithinAbstractGeneric2);
            /*Location4437*/yield return ("MyT", (object)MyT);
            /*Location4438*/yield return ("MyUnofficialInt", (object)MyUnofficialInt);
            /*Location4439*/yield return ("AnotherProperty", (object)AnotherProperty);
            /*Location4440*/yield break;
        }
        /*Location4441*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location4442*/if ((!exploreOnlyDeserializedChildren && LazinatorExample != null) || (_LazinatorExample_Accessed && _LazinatorExample != null))
            {
                _LazinatorExample = (Example) _LazinatorExample.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location4443*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4446*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4447*/_MyEnumWithinAbstractGeneric = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<int>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4448*/_MyEnumWithinAbstractGeneric2 = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<int>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4449*/_MyT = span.ToDecompressedInt(ref bytesSoFar);
            /*Location4450*/_MyUnofficialInt = span.ToDecompressedInt(ref bytesSoFar);
            /*Location4451*/_AnotherProperty = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location4452*/_LazinatorExample_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4453*/_ConcreteGeneric2a_EndByteIndex = bytesSoFar;
            /*Location4454*/        }
            
            /*Location4455*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4456*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4457*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4458*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4462*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4463*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location4464*/}
                                /*Location4465*//*Location4466*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location4470*/if (_LazinatorExample_Accessed && _LazinatorExample != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4473*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4474*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4475*/// write properties
                                    /*Location4476*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric);
                                    /*Location4477*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric2);
                                    /*Location4478*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyT);
                                    /*Location4479*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyUnofficialInt);
                                    /*Location4480*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _AnotherProperty);
                                    /*Location4481*/startOfObjectPosition = writer.Position;
                                    /*Location4482*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4483*/if (updateStoredBuffer)
                                    {
                                        _LazinatorExample_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4484*/if (updateStoredBuffer)
                                    {
                                        /*Location4485*/_ConcreteGeneric2a_EndByteIndex = writer.Position - startPosition;
                                        /*Location4486*/}
                                        /*Location4487*/}
                                        /*Location4488*/
                                    }
