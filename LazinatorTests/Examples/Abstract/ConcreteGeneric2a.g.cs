//1222811e-ef10-3e47-c827-1129da3720b8
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class ConcreteGeneric2a : ILazinator
    {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;_MyEnumWithinAbstractGeneric = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<int>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
        ...
        protected override void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            // write properties
            TabbedText.WriteLine($"Now at {writer.Position}, before MyEnumWithinAbstractGeneric value {MyEnumWithinAbstractGeneric}");
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedInt(writer, (int) _MyEnumWithinAbstractGeneric);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyEnumWithinAbstractGeneric2 value {MyEnumWithinAbstractGeneric2}");
            TabbedText.Tabs++;
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before AnotherProperty value {AnotherProperty}");
            TabbedText.Tabs++;
