...
{
    public class ConcreteGeneric2b : AbstractGeneric1<Example>, IConcreteGeneric2b
    {
        ...
        public override Example MyT { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
