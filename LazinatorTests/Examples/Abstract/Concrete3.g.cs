/*Location3690*//*Location3675*///3d6ff8f3-3fa4-9774-d05b-69c24310ef13
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location3676*/
    using Lazinator.Attributes;/*Location3677*/
    using Lazinator.Buffers;/*Location3678*/
    using Lazinator.Core;/*Location3679*/
    using Lazinator.Exceptions;/*Location3680*/
    using Lazinator.Support;/*Location3681*/
    using LazinatorTests.Examples;/*Location3682*/
    using System;/*Location3683*/
    using System.Buffers;/*Location3684*/
    using System.Collections.Generic;/*Location3685*/
    using System.Diagnostics;/*Location3686*/
    using System.IO;/*Location3687*/
    using System.Linq;/*Location3688*/
    using System.Runtime.InteropServices;/*Location3689*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class Concrete3 : ILazinator
    {
        /*Location3691*//* Property definitions */
        
        /*Location3692*/        protected int _IntList3_ByteIndex;
        /*Location3693*/protected override int _Example2_ByteLength => _Example3_ByteIndex - _Example2_ByteIndex;
        /*Location3694*/protected override int _Example3_ByteLength => _IntList1_ByteIndex - _Example3_ByteIndex;
        /*Location3695*/protected override int _IntList1_ByteLength => _IntList2_ByteIndex - _IntList1_ByteIndex;
        /*Location3696*/protected override int _IntList2_ByteLength => _IntList3_ByteIndex - _IntList2_ByteIndex;
        /*Location3697*/private int _Concrete3_EndByteIndex;
        /*Location3698*/protected virtual int _IntList3_ByteLength => _Concrete3_EndByteIndex - _IntList3_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location3707*/typedClone.String1 = String1;
            /*Location3708*/typedClone.String2 = String2;
            /*Location3709*/typedClone.String3 = String3;
            /*Location3710*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Example2 == null)
                {
            ...
            /*Location3711*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Example3 == null)
                {
            ...
            /*Location3712*/typedClone.IntList1 = CloneOrChange_List_Gint_g(IntList1, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location3713*/typedClone.IntList2 = CloneOrChange_List_Gint_g(IntList2, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location3714*/typedClone.IntList3 = CloneOrChange_List_Gint_g(IntList3, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location3717*/public override IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location3718*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Example2_Accessed) && Example2 == null)
            {
            ...
            /*Location3719*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Example3_Accessed) && Example3 == null)
            {
            ...
            /*Location3720*/yield break;
        }
        /*Location3721*/
        
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location3722*/yield return ("String1", (object)String1);
            /*Location3723*/yield return ("String2", (object)String2);
            /*Location3724*/yield return ("String3", (object)String3);
            /*Location3725*/yield return ("IntList1", (object)IntList1);
            /*Location3726*/yield return ("IntList2", (object)IntList2);
            /*Location3727*/yield return ("IntList3", (object)IntList3);
            /*Location3728*/yield break;
        }
        /*Location3729*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location3730*/if ((!exploreOnlyDeserializedChildren && Example2 != null) || (_Example2_Accessed && _Example2 != null))
            {
                _Example2 = (Example) _Example2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location3731*/if ((!exploreOnlyDeserializedChildren && Example3 != null) || (_Example3_Accessed && _Example3 != null))
            {
                _Example3 = (Example) _Example3.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location3732*/if ((!exploreOnlyDeserializedChildren && IntList1 != null) || (_IntList1_Accessed && _IntList1 != null))
            {
            ...
            /*Location3733*/if ((!exploreOnlyDeserializedChildren && IntList2 != null) || (_IntList2_Accessed && _IntList2 != null))
            {
            ...
            /*Location3734*/if ((!exploreOnlyDeserializedChildren && IntList3 != null) || (_IntList3_Accessed && _IntList3 != null))
            {
            ...
            /*Location3735*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location3738*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location3739*/_String1 = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location3740*/_String2 = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location3741*/_String3 = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location3742*/_Example2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location3743*/_Example3_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location3744*/_IntList1_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location3745*/_IntList2_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location3746*/_IntList3_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location3747*/_Concrete3_EndByteIndex = bytesSoFar;
            /*Location3748*/        }
            
            /*Location3749*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location3750*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location3751*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location3752*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location3756*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location3757*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location3758*/}
                                /*Location3759*//*Location3760*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location3764*/if (_Example2_Accessed && _Example2 != null)
                                {
                                ...
                                /*Location3765*/if (_Example3_Accessed && _Example3 != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location3771*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location3772*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location3773*/// write properties
                                    /*Location3774*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _String1);
                                    /*Location3775*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _String2);
                                    /*Location3776*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _String3);
                                    /*Location3777*/startOfObjectPosition = writer.Position;
                                    /*Location3778*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location3780*/startOfObjectPosition = writer.Position;
                                    /*Location3781*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location3782*/if (updateStoredBuffer)
                                    {
                                        _Example3_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3783*/startOfObjectPosition = writer.Position;
                                    /*Location3784*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_IntList1_Accessed)
                                    {
                                        var deserialized = IntList1;
                                    }
                                    /*Location3785*/WriteNonLazinatorObject(
                                    ...
                                    /*Location3786*/if (updateStoredBuffer)
                                    {
                                        _IntList1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3787*/startOfObjectPosition = writer.Position;
                                    /*Location3788*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_IntList2_Accessed)
                                    {
                                        var deserialized = IntList2;
                                    }
                                    /*Location3789*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location3790*/if (updateStoredBuffer)
                                    {
                                        _IntList2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3791*/startOfObjectPosition = writer.Position;
                                    /*Location3792*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_IntList3_Accessed)
                                    {
                                        var deserialized = IntList3;
                                    }
                                    /*Location3793*/WriteNonLazinatorObject(
                                    ...
                                    includeChildrenMode, v, updateStoredBuffer));
                                    /*Location3794*/if (updateStoredBuffer)
                                    {
                                        _IntList3_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3795*/if (updateStoredBuffer)
                                    {
                                        /*Location3796*/_Concrete3_EndByteIndex = writer.Position - startPosition;
                                        /*Location3797*/}
                                        /*Location3798*/}
                                        /*Location3799*/
