//e2473939-6bd3-e8c0-6b9b-d4c97228d18c
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class ContainerWithAbstract1 : ILazinator
    {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;_AbstractProperty_ByteIndex = bytesSoFar;
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            // write properties
            TabbedText.WriteLine($"Now at {writer.Position}, before AbstractProperty (accessed? {_AbstractProperty_Accessed}) (empty storage? {_AbstractProperty == null}) ");
            TabbedText.Tabs++;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _AbstractProperty, includeChildrenMode, _AbstractProperty_Accessed, () => GetChildSlice(LazinatorObjectBytes, _AbstractProperty_ByteIndex, _AbstractProperty_ByteLength, false, false, null), verifyCleanness, false, false, this);
            }
            TabbedText.Tabs--;
        }
