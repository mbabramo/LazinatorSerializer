...
namespace LazinatorTests.Examples.Abstract
{
    ...
    public partial class DerivedGeneric2c<T> : ILazinator
    {
        ...
        {
            _MyEnumWithinAbstractGeneric = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<T>.EnumWithinAbstractGeneric)span.ToDecompressedInt32(ref bytesSoFar);_MyEnumWithinAbstractGeneric2 = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<global::System.Int32>.EnumWithinAbstractGeneric)span.ToDecompressedInt32(ref bytesSoFar);_MyUnofficialInt = span.ToDecompressedInt32(ref bytesSoFar);        }
            ...
            {
                TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.Abstract.DerivedGeneric2c<T> ");
            ...
            {
                int startPosition = writer.Position;
                TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.Abstract.DerivedGeneric2c<T> starting at {writer.Position}.");
                ...
                TabbedText.WriteLine($"Byte {writer.Position} (end of DerivedGeneric2c<T>) ");
            }
            ...
            protected override void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
            {
                ...
                if (updateStoredBuffer)
                {
                    _DerivedGeneric2c_T_EndByteIndex = writer.Position - startOfObjectPosition;
                }
            }
