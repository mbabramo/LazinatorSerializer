/*Location4503*//*Location4489*///5bdce112-9b1f-632a-3024-970eded660a2
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4490*/
    using Lazinator.Attributes;/*Location4491*/
    using Lazinator.Buffers;/*Location4492*/
    using Lazinator.Core;/*Location4493*/
    using Lazinator.Exceptions;/*Location4494*/
    using Lazinator.Support;/*Location4495*/
    using System;/*Location4496*/
    using System.Buffers;/*Location4497*/
    using System.Collections.Generic;/*Location4498*/
    using System.Diagnostics;/*Location4499*/
    using System.IO;/*Location4500*/
    using System.Linq;/*Location4501*/
    using System.Runtime.InteropServices;/*Location4502*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class DerivedGeneric2c<T> : ILazinator
    {
        /*Location4504*//* Property definitions */
        
        /*Location4505*/private int _DerivedGeneric2c_T_EndByteIndex = 0;
        /*Location4506*/protected override int _MyT_ByteLength => _DerivedGeneric2c_T_EndByteIndex - _MyT_ByteIndex;
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4511*/typedClone.MyEnumWithinAbstractGeneric = MyEnumWithinAbstractGeneric;
            /*Location4512*/typedClone.MyEnumWithinAbstractGeneric2 = MyEnumWithinAbstractGeneric2;
            /*Location4513*/typedClone.MyUnofficialInt = MyUnofficialInt;
            /*Location4514*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyT == null)
                {
        ...
        /*Location4517*/public override IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location4518*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyT_Accessed) && MyT == null)
            {
            ...
            /*Location4519*/yield break;
        }
        /*Location4520*/
        
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location4521*/yield return ("MyEnumWithinAbstractGeneric", (object)MyEnumWithinAbstractGeneric);
            /*Location4522*/yield return ("MyEnumWithinAbstractGeneric2", (object)MyEnumWithinAbstractGeneric2);
            /*Location4523*/yield return ("MyUnofficialInt", (object)MyUnofficialInt);
            /*Location4524*/yield break;
        }
        /*Location4525*/
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location4526*/if ((!exploreOnlyDeserializedChildren && MyT != null) || (_MyT_Accessed && _MyT != null))
            {
                _MyT = (T) _MyT.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location4527*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4530*/public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4531*/_MyEnumWithinAbstractGeneric = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<T>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4532*/_MyEnumWithinAbstractGeneric2 = (global::LazinatorTests.Examples.Abstract.AbstractGeneric1<int>.EnumWithinAbstractGeneric)span.ToDecompressedInt(ref bytesSoFar);
            /*Location4533*/_MyUnofficialInt = span.ToDecompressedInt(ref bytesSoFar);
            /*Location4534*/_MyT_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4535*/_DerivedGeneric2c_T_EndByteIndex = bytesSoFar;
            /*Location4536*/        }
            
            /*Location4537*/public override void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4538*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4539*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4540*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4544*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4545*/
                            ...
                            {
                                /*Location4552*/if (_MyT_Accessed && _MyT != null)
                                {
                                ...
                                protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4555*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4556*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4557*/// write properties
                                    /*Location4558*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric);
                                    /*Location4559*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyEnumWithinAbstractGeneric2);
                                    /*Location4560*/CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyUnofficialInt);
                                    /*Location4561*/startOfObjectPosition = writer.Position;
                                    /*Location4562*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4563*/if (updateStoredBuffer)
                                    {
                                        _MyT_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4564*/if (updateStoredBuffer)
                                    {
                                        /*Location4565*/_DerivedGeneric2c_T_EndByteIndex = writer.Position - startPosition;
                                        /*Location4566*/}
                                        /*Location4567*/}
                                        /*Location4568*/
                                    }
