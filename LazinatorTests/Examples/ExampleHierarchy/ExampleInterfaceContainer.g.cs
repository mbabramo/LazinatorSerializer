//ebf519f5-5441-1470-911c-2cdb85457337
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Hierarchy
{
    ...
    public partial class ExampleInterfaceContainer : ILazinator
    {
        ...
        {
            if (_ExampleByInterface_Accessed && _ExampleByInterface != null && (_ExampleByInterface.IsDirty || _ExampleByInterface.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _ExampleByInterface.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestDirty))
                {
