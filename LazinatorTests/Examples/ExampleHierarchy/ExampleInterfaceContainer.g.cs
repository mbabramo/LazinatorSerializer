/*Location1126*//*Location1111*///de7a213e-74fe-8448-8ad7-cbe77e8b762f
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location1112*/
    using Lazinator.Attributes;/*Location1113*/
    using Lazinator.Buffers;/*Location1114*/
    using Lazinator.Core;/*Location1115*/
    using Lazinator.Exceptions;/*Location1116*/
    using Lazinator.Support;/*Location1117*/
    using LazinatorTests.Examples;/*Location1118*/
    using System;/*Location1119*/
    using System.Buffers;/*Location1120*/
    using System.Collections.Generic;/*Location1121*/
    using System.Diagnostics;/*Location1122*/
    using System.IO;/*Location1123*/
    using System.Linq;/*Location1124*/
    using System.Runtime.InteropServices;/*Location1125*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class ExampleInterfaceContainer : ILazinator
    {
        /*Location1127*/public bool IsStruct => false;
        
        /*Location1128*//* Property definitions */
        
        /*Location1129*/        protected int _ExampleByInterface_ByteIndex;
        /*Location1130*/        protected int _ExampleListByInterface_ByteIndex;
        /*Location1131*/protected virtual int _ExampleByInterface_ByteLength => _ExampleListByInterface_ByteIndex - _ExampleByInterface_ByteIndex;
        /*Location1132*/private int _ExampleInterfaceContainer_EndByteIndex;
        /*Location1133*/protected virtual int _ExampleListByInterface_ByteLength => _ExampleInterfaceContainer_EndByteIndex - _ExampleListByInterface_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location1136*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
            {
            ...
            /*Location1137*/typedClone.ExampleListByInterface = CloneOrChange_List_GIExample_g(ExampleListByInterface, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        /*Location1140*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location1141*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ExampleByInterface_Accessed) && ExampleByInterface == null)
            {
            ...
            /*Location1142*/yield break;
        }
        /*Location1143*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location1144*/yield return ("ExampleListByInterface", (object)ExampleListByInterface);
            /*Location1145*/yield break;
        }
        /*Location1146*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location1147*/if ((!exploreOnlyDeserializedChildren && ExampleByInterface != null) || (_ExampleByInterface_Accessed && _ExampleByInterface != null))
            {
                _ExampleByInterface = (IExample) _ExampleByInterface.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location1148*/if ((!exploreOnlyDeserializedChildren && ExampleListByInterface != null) || (_ExampleListByInterface_Accessed && _ExampleListByInterface != null))
            {
            ...
            /*Location1149*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location1152*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location1153*/_ExampleByInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location1154*/_ExampleListByInterface_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location1155*/_ExampleInterfaceContainer_EndByteIndex = bytesSoFar;
            /*Location1156*/        }
            
            /*Location1157*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location1158*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location1159*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location1160*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location1164*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location1165*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location1166*/}
                                /*Location1167*//*Location1168*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location1172*/if (_ExampleByInterface_Accessed && _ExampleByInterface != null)
                                {
                                ...
                                /*Location1173*/if (_ExampleListByInterface_Accessed && _ExampleListByInterface != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location1176*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location1177*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location1178*/// write properties
                                    /*Location1179*/startOfObjectPosition = writer.Position;
                                    /*Location1180*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
                                    {
                                    ...
                                    /*Location1181*/if (updateStoredBuffer)
                                    {
                                        _ExampleByInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1182*/startOfObjectPosition = writer.Position;
                                    /*Location1183*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_ExampleListByInterface_Accessed)
                                    {
                                        var deserialized = ExampleListByInterface;
                                    }
                                    /*Location1184*/WriteNonLazinatorObject(
                                    ...
                                    /*Location1185*/if (updateStoredBuffer)
                                    {
                                        _ExampleListByInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location1186*/if (updateStoredBuffer)
                                    {
                                        /*Location1187*/_ExampleInterfaceContainer_EndByteIndex = writer.Position - startPosition;
                                        /*Location1188*/}
                                        /*Location1189*/}
                                        /*Location1190*/
