//648c0949-986b-1339-a884-88866f2c7d84
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Hierarchy
{
    ...
    public partial class ExampleInterfaceContainer : ILazinator
    {
        ...
        public IExample ExampleByInterface
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property ExampleByInterface cannot be set to a Lazinator object with a defined LazinatorParentClass, because AutoChangeParent is set to false in the configuration file and no attribute providing an exception is present.");
                    }
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_ExampleByInterface_Accessed && _ExampleByInterface != null))
            {
                foreach (ILazinator toYield in ExampleByInterface.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            ...
            if (updateStoredBuffer)
            {
                ...
                _IsDirty = false;
                _DescendantIsDirty = includeChildrenMode != IncludeChildrenMode.IncludeAllChildren && ((_ExampleByInterface_Accessed && _ExampleByInterface != null && (ExampleByInterface.IsDirty || ExampleByInterface.DescendantIsDirty)));
