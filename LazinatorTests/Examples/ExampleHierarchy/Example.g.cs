//33d6226c-09ce-5a4c-408b-a882df51a7c2
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class Example : ILazinator
    {
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            // write properties
            TabbedText.WriteLine($"Now at {writer.Position}, before MyBool value {MyBool}");
            TabbedText.Tabs++;
            WriteUncompressedPrimitives.WriteBool(writer, _MyBool);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyChar value {MyChar}");
            TabbedText.Tabs++;
            EncodeCharAndString.WriteCharInTwoBytes(writer, _MyChar);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyDateTime value {MyDateTime}");
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedDateTime(writer, _MyDateTime);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyNewString value {MyNewString}");
            TabbedText.Tabs++;
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyNullableDecimal value {MyNullableDecimal}");
            TabbedText.Tabs++;
            CompressedDecimal.WriteCompressedNullableDecimal(writer, _MyNullableDecimal);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyNullableDouble value {MyNullableDouble}");
            TabbedText.Tabs++;
            WriteUncompressedPrimitives.WriteNullableDouble(writer, _MyNullableDouble);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyNullableTimeSpan value {MyNullableTimeSpan}");
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedNullableTimeSpan(writer, _MyNullableTimeSpan);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyOldString value {MyOldString}");
            TabbedText.Tabs++;
            if (LazinatorObjectVersion < 3) 
            {
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyTestEnum value {MyTestEnum}");
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedInt(writer, (int) _MyTestEnum);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyTestEnumByteNullable value {MyTestEnumByteNullable}");
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedNullableByte(writer, (byte?) _MyTestEnumByteNullable);
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyUint value {MyUint}");
            TabbedText.Tabs++;
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _MyInterfaceImplementer, includeChildrenMode, _MyInterfaceImplementer_Accessed, () => GetChildSlice(LazinatorObjectBytes, _MyInterfaceImplementer_ByteIndex, _MyInterfaceImplementer_ByteLength, false, false, null), verifyCleanness, false, false, this);
            }
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Now at {writer.Position}, before MyNonLazinatorChild (accessed? {_MyNonLazinatorChild_Accessed}) (dirty? {_MyNonLazinatorChild_Dirty})");
            TabbedText.Tabs++;
