/*Location763*//*Location748*///cbebe696-bbce-cdca-d47c-b2e2da72f308
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location749*/
    using Lazinator.Attributes;/*Location750*/
    using Lazinator.Buffers;/*Location751*/
    using Lazinator.Core;/*Location752*/
    using Lazinator.Exceptions;/*Location753*/
    using Lazinator.Support;/*Location754*/
    using Lazinator.Wrappers;/*Location755*/
    using System;/*Location756*/
    using System.Buffers;/*Location757*/
    using System.Collections.Generic;/*Location758*/
    using System.Diagnostics;/*Location759*/
    using System.IO;/*Location760*/
    using System.Linq;/*Location761*/
    using System.Runtime.InteropServices;/*Location762*/
    ...
    {
        /*Location764*/
        /*Location765*//* This is code added with an InsertCode attribute. */ 
        
        /*Location766*/public bool IsStruct => false;
        
        /*Location767*//* Property definitions */
        
        /*Location768*/        protected int _IncludableChild_ByteIndex;
        /*Location769*/        protected int _MyChild1_ByteIndex;
        /*Location770*/        protected int _MyChild2_ByteIndex;
        /*Location771*/        protected int _MyChild2Previous_ByteIndex;
        /*Location772*/        protected int _MyInterfaceImplementer_ByteIndex;
        /*Location773*/        protected int _MyNonLazinatorChild_ByteIndex;
        /*Location774*/        protected int _WrappedInt_ByteIndex;
        /*Location775*/        protected int _ExcludableChild_ByteIndex;
        /*Location776*/protected virtual int _IncludableChild_ByteLength => _MyChild1_ByteIndex - _IncludableChild_ByteIndex;
        /*Location777*/protected virtual int _MyChild1_ByteLength => _MyChild2_ByteIndex - _MyChild1_ByteIndex;
        /*Location778*/protected virtual int _MyChild2_ByteLength => _MyChild2Previous_ByteIndex - _MyChild2_ByteIndex;
        /*Location779*/protected virtual int _MyChild2Previous_ByteLength => _MyInterfaceImplementer_ByteIndex - _MyChild2Previous_ByteIndex;
        /*Location780*/protected virtual int _MyInterfaceImplementer_ByteLength => _MyNonLazinatorChild_ByteIndex - _MyInterfaceImplementer_ByteIndex;
        /*Location781*/protected virtual int _MyNonLazinatorChild_ByteLength => _WrappedInt_ByteIndex - _MyNonLazinatorChild_ByteIndex;
        /*Location782*/protected virtual int _WrappedInt_ByteLength => _ExcludableChild_ByteIndex - _WrappedInt_ByteIndex;
        /*Location783*/private int _Example_EndByteIndex;
        /*Location784*/protected virtual int _ExcludableChild_ByteLength => _Example_EndByteIndex - _ExcludableChild_ByteIndex;
        ...
        /*Location806*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location808*/typedClone.MyNullableDouble = MyNullableDouble;
            /*Location809*/typedClone.MyBool = MyBool;
            /*Location810*/typedClone.MyChar = MyChar;
            /*Location811*/typedClone.MyDateTime = MyDateTime;
            /*Location812*/if (LazinatorObjectVersion >= 3)
            {
                typedClone.MyNewString = MyNewString;
            }
            
            /*Location813*/typedClone.MyNullableDecimal = MyNullableDecimal;
            /*Location814*/typedClone.MyNullableTimeSpan = MyNullableTimeSpan;
            /*Location815*/if (LazinatorObjectVersion < 3)
            {
                typedClone.MyOldString = MyOldString;
            }
            
            /*Location816*/typedClone.MyString = MyString;
            /*Location817*/typedClone.MyStringBrotli = MyStringBrotli;
            /*Location818*/typedClone.MyTestEnum = MyTestEnum;
            /*Location819*/typedClone.MyTestEnumByteNullable = MyTestEnumByteNullable;
            /*Location820*/typedClone.MyUint = MyUint;
            /*Location821*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
            {
            ...
            /*Location822*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild1 == null)
                {
            ...
            /*Location823*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyChild2 == null)
                {
            ...
            /*Location824*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren && LazinatorObjectVersion < 3)
            {
            ...
            /*Location825*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location826*/typedClone.MyNonLazinatorChild = NonLazinatorDirectConverter.CloneOrChange_NonLazinatorClass(MyNonLazinatorChild, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location827*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                typedClone.WrappedInt = (WInt) WrappedInt.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
            }
            
            /*Location828*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren && includeChildrenMode != IncludeChildrenMode.ExcludeOnlyExcludableChildren)
            {
        ...
        /*Location831*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location832*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _IncludableChild_Accessed) && IncludableChild == null)
            {
            ...
            /*Location833*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild1_Accessed) && MyChild1 == null)
            {
            ...
            /*Location834*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild2_Accessed) && MyChild2 == null)
            {
            ...
            /*Location835*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyChild2Previous_Accessed) && MyChild2Previous == null)
            {
            ...
            /*Location836*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyInterfaceImplementer_Accessed) && MyInterfaceImplementer == null)
            {
            ...
            /*Location837*/bool isMatch_WrappedInt = matchCriterion == null || matchCriterion(WrappedInt);
            ...
            /*Location838*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ExcludableChild_Accessed) && ExcludableChild == null)
            {
            ...
            /*Location839*/yield break;
        }
        /*Location840*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location841*/yield return ("MyNullableDouble", (object)MyNullableDouble);
            /*Location842*/yield return ("MyBool", (object)MyBool);
            /*Location843*/yield return ("MyChar", (object)MyChar);
            /*Location844*/yield return ("MyDateTime", (object)MyDateTime);
            /*Location845*/yield return ("MyNewString", (object)MyNewString);
            /*Location846*/yield return ("MyNullableDecimal", (object)MyNullableDecimal);
            /*Location847*/yield return ("MyNullableTimeSpan", (object)MyNullableTimeSpan);
            /*Location848*/yield return ("MyOldString", (object)MyOldString);
            /*Location849*/yield return ("MyString", (object)MyString);
            /*Location850*/yield return ("MyStringBrotli", (object)MyStringBrotli);
            /*Location851*/yield return ("MyTestEnum", (object)MyTestEnum);
            /*Location852*/yield return ("MyTestEnumByteNullable", (object)MyTestEnumByteNullable);
            /*Location853*/yield return ("MyUint", (object)MyUint);
            /*Location854*/yield return ("MyNonLazinatorChild", (object)MyNonLazinatorChild);
            /*Location855*/yield break;
        }
        /*Location856*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location857*/if ((!exploreOnlyDeserializedChildren && IncludableChild != null) || (_IncludableChild_Accessed && _IncludableChild != null))
            {
                _IncludableChild = (ExampleChild) _IncludableChild.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location858*/if ((!exploreOnlyDeserializedChildren && MyChild1 != null) || (_MyChild1_Accessed && _MyChild1 != null))
            {
                _MyChild1 = (ExampleChild) _MyChild1.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location859*/if ((!exploreOnlyDeserializedChildren && MyChild2 != null) || (_MyChild2_Accessed && _MyChild2 != null))
            {
                _MyChild2 = (ExampleChild) _MyChild2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location860*/if ((!exploreOnlyDeserializedChildren && MyChild2Previous != null) || (_MyChild2Previous_Accessed && _MyChild2Previous != null))
            {
                _MyChild2Previous = (ExampleChild) _MyChild2Previous.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location861*/if ((!exploreOnlyDeserializedChildren && MyInterfaceImplementer != null) || (_MyInterfaceImplementer_Accessed && _MyInterfaceImplementer != null))
            {
            ...
            /*Location862*/var deserialized_WrappedInt = WrappedInt;
            _WrappedInt = (WInt) _WrappedInt.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);/*Location863*/if ((!exploreOnlyDeserializedChildren && ExcludableChild != null) || (_ExcludableChild_Accessed && _ExcludableChild != null))
            {
                _ExcludableChild = (ExampleChild) _ExcludableChild.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location864*/if ((!exploreOnlyDeserializedChildren && MyNonLazinatorChild != null) || (_MyNonLazinatorChild_Accessed && _MyNonLazinatorChild != null))
            {
            ...
            /*Location865*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location868*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location869*/_MyNullableDouble = span.ToNullableDouble(ref bytesSoFar);
            /*Location870*/_MyBool = span.ToBoolean(ref bytesSoFar);
            /*Location871*/_MyChar = span.ToChar(ref bytesSoFar);
            /*Location872*/_MyDateTime = span.ToDecompressedDateTime(ref bytesSoFar);
            /*Location873*/if (serializedVersionNumber >= 3)
            {
                _MyNewString = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            }
            
            /*Location874*/_MyNullableDecimal = span.ToDecompressedNullableDecimal(ref bytesSoFar);
            /*Location875*/_MyNullableTimeSpan = span.ToDecompressedNullableTimeSpan(ref bytesSoFar);
            /*Location876*/if (serializedVersionNumber < 3)
            {
                _MyOldString = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            }
            
            /*Location877*/_MyString = span.ToString_VarIntLengthUtf8(ref bytesSoFar);
            /*Location878*/_MyStringBrotli = span.ToString_BrotliCompressedWithLength(ref bytesSoFar);
            /*Location879*/_MyTestEnum = (TestEnum)span.ToDecompressedInt(ref bytesSoFar);
            /*Location880*/_MyTestEnumByteNullable = (TestEnumByte?)span.ToDecompressedNullableByte(ref bytesSoFar);
            /*Location881*/_MyUint = span.ToDecompressedUint(ref bytesSoFar);
            /*Location882*/_IncludableChild_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location883*/_MyChild1_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location884*/_MyChild2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location885*/_MyChild2Previous_ByteIndex = bytesSoFar;
            ...
            /*Location886*/_MyInterfaceImplementer_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location887*/_MyNonLazinatorChild_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location888*/_WrappedInt_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToByte(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location889*/_ExcludableChild_ByteIndex = bytesSoFar;
            ...
            /*Location890*/_Example_EndByteIndex = bytesSoFar;
            /*Location891*/        }
            
            /*Location892*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location893*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location894*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location895*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location899*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location900*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location901*/}
                                /*Location902*/
                                _WrappedInt_Accessed = false;/*Location903*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location907*/if (_IncludableChild_Accessed && _IncludableChild != null)
                                {
                                ...
                                /*Location908*/if (_MyChild1_Accessed && _MyChild1 != null)
                                {
                                ...
                                /*Location909*/if (_MyChild2_Accessed && _MyChild2 != null)
                                {
                                ...
                                /*Location910*/if (_MyChild2Previous_Accessed && _MyChild2Previous != null)
                                {
                                ...
                                /*Location911*/if (_MyInterfaceImplementer_Accessed && _MyInterfaceImplementer != null)
                                {
                                ...
                                /*Location912*/WrappedInt.UpdateStoredBuffer(ref writer, startPosition + _WrappedInt_ByteIndex + sizeof(byte), _WrappedInt_ByteLength - sizeof(byte), IncludeChildrenMode.IncludeAllChildren, true);
                                /*Location913*/if (_ExcludableChild_Accessed && _ExcludableChild != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location916*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location917*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location918*/// write properties
                                    /*Location919*/WriteUncompressedPrimitives.WriteNullableDouble(ref writer, _MyNullableDouble);
                                    /*Location920*/WriteUncompressedPrimitives.WriteBool(ref writer, _MyBool);
                                    /*Location921*/EncodeCharAndString.WriteCharInTwoBytes(ref writer, _MyChar);
                                    /*Location922*/CompressedIntegralTypes.WriteCompressedDateTime(ref writer, _MyDateTime);
                                    /*Location923*/if (LazinatorObjectVersion >= 3)
                                    {
                                        EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _MyNewString);
                                    }
                                    
                                    /*Location924*/CompressedDecimal.WriteCompressedNullableDecimal(ref writer, _MyNullableDecimal);
                                    /*Location925*/CompressedIntegralTypes.WriteCompressedNullableTimeSpan(ref writer, _MyNullableTimeSpan);
                                    /*Location926*/if (LazinatorObjectVersion < 3)
                                    {
                                        EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _MyOldString);
                                    }
                                    
                                    /*Location927*/EncodeCharAndString.WriteStringUtf8WithVarIntPrefix(ref writer, _MyString);
                                    /*Location928*/EncodeCharAndString.WriteBrotliCompressedWithIntPrefix(ref writer, _MyStringBrotli);
                                    /*Location929*/CompressedIntegralTypes.WriteCompressedInt(ref writer, (int) _MyTestEnum);
                                    /*Location930*/CompressedIntegralTypes.WriteCompressedNullableByte(ref writer, (byte?) _MyTestEnumByteNullable);
                                    /*Location931*/CompressedIntegralTypes.WriteCompressedUint(ref writer, _MyUint);
                                    /*Location932*/startOfObjectPosition = writer.Position;
                                    /*Location933*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren)
                                    {
                                    ...
                                    /*Location934*/if (updateStoredBuffer)
                                    {
                                        _IncludableChild_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location935*/startOfObjectPosition = writer.Position;
                                    /*Location936*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location937*/if (updateStoredBuffer)
                                    {
                                        _MyChild1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location938*/startOfObjectPosition = writer.Position;
                                    /*Location939*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location940*/if (updateStoredBuffer)
                                    {
                                        _MyChild2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location941*/startOfObjectPosition = writer.Position;
                                    /*Location942*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren && LazinatorObjectVersion < 3)
                                    {
                                    ...
                                    /*Location943*/if (updateStoredBuffer)
                                    {
                                        _MyChild2Previous_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location944*/startOfObjectPosition = writer.Position;
                                    /*Location945*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location946*/if (updateStoredBuffer)
                                    {
                                        _MyInterfaceImplementer_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location947*/startOfObjectPosition = writer.Position;
                                    /*Location948*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyNonLazinatorChild_Accessed)
                                    {
                                        var deserialized = MyNonLazinatorChild;
                                    }
                                    /*Location949*/WriteNonLazinatorObject(
                                    ...
                                    /*Location950*/if (updateStoredBuffer)
                                    {
                                        _MyNonLazinatorChild_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location951*/startOfObjectPosition = writer.Position;
                                    /*Location952*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location953*/if (updateStoredBuffer)
                                    {
                                        _WrappedInt_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location954*/startOfObjectPosition = writer.Position;
                                    /*Location955*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren && includeChildrenMode != IncludeChildrenMode.ExcludeOnlyExcludableChildren)
                                    {
                                    ...
                                    /*Location956*/if (updateStoredBuffer)
                                    {
                                        _ExcludableChild_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location957*/if (updateStoredBuffer)
                                    {
                                        /*Location958*/_Example_EndByteIndex = writer.Position - startPosition;
                                        /*Location959*/}
                                        /*Location960*/}
                                        /*Location961*/
                                    }
