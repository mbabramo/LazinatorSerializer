//3192ea29-dbd4-eaec-ca44-c980fd3e4bd0
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class Example : ILazinator
    {
        ...
        public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            ...
            if (enumerateNulls && (MyAutoChangeParentChild == null))
            {
                yield return ("MyAutoChangeParentChild", default);
            }
            else if ((!exploreOnlyDeserializedChildren && MyAutoChangeParentChild != null) || (_MyAutoChangeParentChild_Accessed && _MyAutoChangeParentChild != null))
            {
                foreach (ILazinator toYield in MyAutoChangeParentChild.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren, enumerateNulls))
                {
