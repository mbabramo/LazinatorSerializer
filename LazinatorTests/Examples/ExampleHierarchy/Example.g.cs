//04e882c9-59a3-d2fd-34b3-3246a4eb7d59
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class Example : ILazinator
    {
        ...
        protected int _MyAutocloneChild_ByteIndex;
        protected int _MyAutocloneChildStruct_ByteIndex;
        ...
        protected virtual int _IncludableChild_ByteLength => _MyAutocloneChild_ByteIndex - _IncludableChild_ByteIndex;
        protected virtual int _MyAutocloneChild_ByteLength => _MyAutocloneChildStruct_ByteIndex - _MyAutocloneChild_ByteIndex;
        protected virtual int _MyAutocloneChildStruct_ByteLength => _MyChild1_ByteIndex - _MyAutocloneChildStruct_ByteIndex;
        ...
        public ExampleChild ExcludableChild
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property ExcludableChild cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
        ...
        public ExampleChild IncludableChild
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property IncludableChild cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        private ExampleChild _MyAutocloneChild;
        public ExampleChild MyAutocloneChild
        {
            [DebuggerStepThrough]
            get
            {
                if (!_MyAutocloneChild_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _MyAutocloneChild = default(ExampleChild);
                    }
                    else
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyAutocloneChild_ByteIndex, _MyAutocloneChild_ByteLength, false, false, null);
                        
                        _MyAutocloneChild = DeserializationFactory.Instance.CreateBaseOrDerivedType(213, () => new ExampleChild(), childData, this); 
                    }
                    _MyAutocloneChild_Accessed = true;
                }
                return _MyAutocloneChild;
            }
            [DebuggerStepThrough]
            set
            {
                ExampleChild selfOrClone = (value?.LazinatorParentClass == null) ? (ExampleChild) value : (ExampleChild) value/* DEBUG .CloneLazinatorTyped() */;
                if (selfOrClone != null)
                {
                    selfOrClone.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        protected bool _MyAutocloneChild_Accessed;
        private ExampleStruct _MyAutocloneChildStruct;
        public ExampleStruct MyAutocloneChildStruct
        {
            [DebuggerStepThrough]
            get
            {
                if (!_MyAutocloneChildStruct_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _MyAutocloneChildStruct = default(ExampleStruct);
                    }
                    else
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyAutocloneChildStruct_ByteIndex, _MyAutocloneChildStruct_ByteLength, false, false, null);
                        _MyAutocloneChildStruct = new ExampleStruct()
                        {
                ...
                return _MyAutocloneChildStruct;
            }
            [DebuggerStepThrough]
            set
            {
        ...
        protected bool _MyAutocloneChildStruct_Accessed;
        public ExampleStruct MyAutocloneChildStruct_Copy
        {
            [DebuggerStepThrough]
            get
            {
        ...
        public ExampleChild MyChild2Previous
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyChild2Previous cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        public IExampleNonexclusiveInterface MyInterfaceImplementer
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyInterfaceImplementer cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        {
            _ExcludableChild_Accessed = _IncludableChild_Accessed = _MyAutocloneChild_Accessed = _MyAutocloneChildStruct_Accessed = _MyChild1_Accessed = _MyChild2_Accessed = _MyChild2Previous_Accessed = _MyInterfaceImplementer_Accessed = _MyNonLazinatorChild_Accessed = _WrappedInt_Accessed = false;
        }
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _MyAutocloneChild_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            _MyAutocloneChildStruct_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            ...
            if (updateStoredBuffer)
            {
                ...
                _IsDirty = false;
                _DescendantIsDirty = includeChildrenMode != IncludeChildrenMode.IncludeAllChildren && ((_ExcludableChild_Accessed && ExcludableChild != null && (ExcludableChild.IsDirty || ExcludableChild.DescendantIsDirty)) || (_IncludableChild_Accessed && IncludableChild != null && (IncludableChild.IsDirty || IncludableChild.DescendantIsDirty)) || (_MyAutocloneChild_Accessed && MyAutocloneChild != null && (MyAutocloneChild.IsDirty || MyAutocloneChild.DescendantIsDirty)) || (_MyAutocloneChildStruct_Accessed && (MyAutocloneChildStruct.IsDirty || MyAutocloneChildStruct.DescendantIsDirty)) || (_MyChild1_Accessed && MyChild1 != null && (MyChild1.IsDirty || MyChild1.DescendantIsDirty)) || (_MyChild2_Accessed && MyChild2 != null && (MyChild2.IsDirty || MyChild2.DescendantIsDirty)) || (_MyChild2Previous_Accessed && MyChild2Previous != null && (MyChild2Previous.IsDirty || MyChild2Previous.DescendantIsDirty)) || (_MyInterfaceImplementer_Accessed && MyInterfaceImplementer != null && (MyInterfaceImplementer.IsDirty || MyInterfaceImplementer.DescendantIsDirty)) || (_WrappedInt_Accessed && (WrappedInt.IsDirty || WrappedInt.DescendantIsDirty)));
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChild(writer, _MyAutocloneChild, includeChildrenMode, _MyAutocloneChild_Accessed, () => GetChildSlice(LazinatorObjectBytes, _MyAutocloneChild_ByteIndex, _MyAutocloneChild_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
            if (updateStoredBuffer)
            {
                _MyAutocloneChild_ByteIndex = startOfObjectPosition - startPosition;
            }
            startOfObjectPosition = writer.Position;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChild(writer, _MyAutocloneChildStruct, includeChildrenMode, _MyAutocloneChildStruct_Accessed, () => GetChildSlice(LazinatorObjectBytes, _MyAutocloneChildStruct_ByteIndex, _MyAutocloneChildStruct_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
            if (updateStoredBuffer)
            {
                _MyAutocloneChildStruct_ByteIndex = startOfObjectPosition - startPosition;
            }
            startOfObjectPosition = writer.Position;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
