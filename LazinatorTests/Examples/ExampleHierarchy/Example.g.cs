//663772b5-1144-eb98-bb6e-0c0341f45474
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.101
//
    ...
    public partial class Example : ILazinator
    {
        ...
        public ExampleChild ExcludableChild
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property ExcludableChild cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
        ...
        public ExampleChild IncludableChild
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property IncludableChild cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        public ExampleChild MyAutoChangeParentChild
        {
            ...
            set
            {
                ...
                IsDirty = true;
                _MyAutoChangeParentChild = selfOrClone;
        ...
        public ExampleStruct MyAutoChangeParentChildStruct
        {
            ...
            set
            {
                ...
                IsDirty = true;
                _MyAutoChangeParentChildStruct = clone;
                _MyAutoChangeParentChildStruct_Accessed = true;
            }
        }
        ...
        public ExampleChild MyChild1
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyChild1 cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        public ExampleChild MyChild2
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyChild2 cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        public ExampleChild MyChild2Previous
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyChild2Previous cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
        ...
        public IExampleNonexclusiveInterface MyInterfaceImplementer
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property MyInterfaceImplementer cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
