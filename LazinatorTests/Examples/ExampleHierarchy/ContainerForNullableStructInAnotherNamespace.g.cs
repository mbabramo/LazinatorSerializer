...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial class ContainerForNullableStructInAnotherNamespace : ILazinator
    {
        ...
        public ContainerForNullableStructInAnotherNamespace(LazinatorMemory serializedBytes, ILazinator parent = null)
        {
        ...
        protected virtual void UpdateDeserializedChildren(BinaryBufferWriter writer, int startPosition)
        {
            ...
            {
                MyNullableStruct.Value.UpdateStoredBuffer(writer, startPosition + _MyNullableStruct_ByteIndex + sizeof(int), _MyNullableStruct_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
            }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                {
                    var copy = _MyNullableStruct.Value;
                    WriteChild(writer, ref copy, includeChildrenMode, _MyNullableStruct_Accessed, () => GetChildSlice(LazinatorMemoryStorage, _MyNullableStruct_ByteIndex, _MyNullableStruct_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
                    _MyNullableStruct = copy;
                }
