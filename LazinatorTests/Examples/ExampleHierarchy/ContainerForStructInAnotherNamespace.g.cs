//60434b17-d1a1-093c-1734-85fc58ff697b
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    [Autogenerated]
    public partial class ContainerForStructInAnotherNamespace : ILazinator
    {
        ...
        protected virtual int _MyNullableStruct_ByteLength => _MyStruct_ByteIndex - _MyNullableStruct_ByteIndex;
        private int _ContainerForStructInAnotherNamespace_EndByteIndex;
        protected virtual int _MyStruct_ByteLength => _ContainerForStructInAnotherNamespace_EndByteIndex - _MyStruct_ByteIndex;
        ...
        protected StructInAnotherNamespace _MyStruct;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public StructInAnotherNamespace MyStruct
        {
            get
            {
        ...
        private void Lazinate_MyStruct()
        {
            if (LazinatorObjectBytes.Length == 0)
            {
                _MyStruct = default(StructInAnotherNamespace);
            ...
            else
            {
                ...
                _MyStruct = new StructInAnotherNamespace()
                {
                    LazinatorParents = new LazinatorParentsCollection(this)
                };
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public StructInAnotherNamespace MyStruct_Copy
        {
            get
            {
                if (!_MyStruct_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        return default(StructInAnotherNamespace);
                    }
                    else
                    {
                        LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyStruct_ByteIndex, _MyStruct_ByteLength, false, false, null);
        ...
        public ContainerForStructInAnotherNamespace(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public ContainerForStructInAnotherNamespace(LazinatorMemory serializedBytes, ILazinator parent = null)
        {
        ...
        {
            ContainerForStructInAnotherNamespace clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new ContainerForStructInAnotherNamespace(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (ContainerForStructInAnotherNamespace)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, false, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, false, this);
                clone = new ContainerForStructInAnotherNamespace(bytes);
            }
            return clone;
        }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            ContainerForStructInAnotherNamespace typedClone = (ContainerForStructInAnotherNamespace) clone;
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                typedClone.MyStruct = (StructInAnotherNamespace) MyStruct.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            _MyStruct = (StructInAnotherNamespace) _MyStruct.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);if (changeThisLevel && changeFunc != null)
            {
        ...
        public virtual void FreeInMemoryObjects()
        {
            _MyNullableStruct = default;
            _MyStruct = default;
            _MyNullableStruct_Accessed = _MyStruct_Accessed = false;
            IsDirty = false;
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _ContainerForStructInAnotherNamespace_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _ContainerForStructInAnotherNamespace_EndByteIndex = writer.Position - startPosition;
            }
        }
