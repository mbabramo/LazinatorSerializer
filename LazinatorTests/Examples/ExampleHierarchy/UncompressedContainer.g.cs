//227f873e-8d47-837e-f840-b67a6f88966e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial record UncompressedContainer : ILazinator
    {
        ...
        public UncompressedContainer(LazinatorMemory serializedBytes, ILazinator parent = null)
        {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialSpan;
            _MyUncompressed = span.ToString_BrotliCompressedWithLength(ref bytesSoFar);
            _MyUncompressedDateTime = span.ToDecompressedDateTime(ref bytesSoFar);
            _MyUncompressedDecimal = span.ToDecompressedDecimal(ref bytesSoFar);
            _MyUncompressedInt = span.ToDecompressedInt(ref bytesSoFar);
            _MyUncompressedLong = span.ToDecompressedLong(ref bytesSoFar);
            _MyUncompressedNullableDateTime = span.ToDecompressedNullableDateTime(ref bytesSoFar);
            _MyUncompressedNullableDecimal = span.ToDecompressedNullableDecimal(ref bytesSoFar);
            _MyUncompressedNullableInt = span.ToDecompressedNullableInt(ref bytesSoFar);
            _MyUncompressedNullableLong = span.ToDecompressedNullableLong(ref bytesSoFar);
            _MyUncompressedNullableShort = span.ToDecompressedNullableShort(ref bytesSoFar);
            _MyUncompressedNullableTimeSpan = span.ToDecompressedNullableTimeSpan(ref bytesSoFar);
            _MyUncompressedNullableUInt = span.ToDecompressedNullableUint(ref bytesSoFar);
            _MyUncompressedNullableULong = span.ToDecompressedNullableUlong(ref bytesSoFar);
            _MyUncompressedNullableUShort = span.ToDecompressedNullableUshort(ref bytesSoFar);
            _MyUncompressedShort = span.ToDecompressedShort(ref bytesSoFar);
            _MyUncompressedTimeSpan = span.ToDecompressedTimeSpan(ref bytesSoFar);
            _MyUncompressedUInt = span.ToDecompressedUint(ref bytesSoFar);
            _MyUncompressedULong = span.ToDecompressedUlong(ref bytesSoFar);
            _MyUncompressedUShort = span.ToDecompressedUshort(ref bytesSoFar);
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            // write properties
            EncodeCharAndString.WriteBrotliCompressedWithIntPrefix(ref writer, _MyUncompressed);
            CompressedIntegralTypes.WriteCompressedDateTime(ref writer, _MyUncompressedDateTime);
            CompressedDecimal.WriteCompressedDecimal(ref writer, _MyUncompressedDecimal);
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _MyUncompressedInt);
            CompressedIntegralTypes.WriteCompressedLong(ref writer, _MyUncompressedLong);
            CompressedIntegralTypes.WriteCompressedNullableDateTime(ref writer, _MyUncompressedNullableDateTime);
            CompressedDecimal.WriteCompressedNullableDecimal(ref writer, _MyUncompressedNullableDecimal);
            CompressedIntegralTypes.WriteCompressedNullableInt(ref writer, _MyUncompressedNullableInt);
            CompressedIntegralTypes.WriteCompressedNullableLong(ref writer, _MyUncompressedNullableLong);
            CompressedIntegralTypes.WriteCompressedNullableShort(ref writer, _MyUncompressedNullableShort);
            CompressedIntegralTypes.WriteCompressedNullableTimeSpan(ref writer, _MyUncompressedNullableTimeSpan);
            CompressedIntegralTypes.WriteCompressedNullableUint(ref writer, _MyUncompressedNullableUInt);
            CompressedIntegralTypes.WriteCompressedNullableUlong(ref writer, _MyUncompressedNullableULong);
            CompressedIntegralTypes.WriteCompressedNullableUshort(ref writer, _MyUncompressedNullableUShort);
            CompressedIntegralTypes.WriteCompressedShort(ref writer, _MyUncompressedShort);
            CompressedIntegralTypes.WriteCompressedTimeSpan(ref writer, _MyUncompressedTimeSpan);
            CompressedIntegralTypes.WriteCompressedUint(ref writer, _MyUncompressedUInt);
            CompressedIntegralTypes.WriteCompressedUlong(ref writer, _MyUncompressedULong);
            CompressedIntegralTypes.WriteCompressedUshort(ref writer, _MyUncompressedUShort);
        }
