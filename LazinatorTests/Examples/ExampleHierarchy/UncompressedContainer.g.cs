...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial record UncompressedContainer : ILazinator
    {
        ...
        {
            _MyUncompressed = span.ToString_VarIntLengthUtf8(ref bytesSoFar);_MyUncompressedDateTime = span.ToDateTime(ref bytesSoFar);_MyUncompressedDecimal = span.ToDecimal(ref bytesSoFar);_MyUncompressedInt = span.ToInt32(ref bytesSoFar);_MyUncompressedLong = span.ToInt64(ref bytesSoFar);_MyUncompressedNullableDateTime = span.ToNullableDateTime(ref bytesSoFar);_MyUncompressedNullableDecimal = span.ToNullableDecimal(ref bytesSoFar);_MyUncompressedNullableInt = span.ToNullableInt32(ref bytesSoFar);_MyUncompressedNullableLong = span.ToNullableInt64(ref bytesSoFar);_MyUncompressedNullableShort = span.ToNullableInt16(ref bytesSoFar);_MyUncompressedNullableTimeSpan = span.ToNullableTimeSpan(ref bytesSoFar);_MyUncompressedNullableUInt = span.ToNullableUInt32(ref bytesSoFar);_MyUncompressedNullableULong = span.ToNullableUInt64(ref bytesSoFar);_MyUncompressedNullableUShort = span.ToNullableUInt16(ref bytesSoFar);_MyUncompressedShort = span.ToInt16(ref bytesSoFar);_MyUncompressedTimeSpan = span.ToTimeSpan(ref bytesSoFar);_MyUncompressedUInt = span.ToUInt32(ref bytesSoFar);_MyUncompressedULong = span.ToUInt64(ref bytesSoFar);_MyUncompressedUShort = span.ToUInt16(ref bytesSoFar);        }
