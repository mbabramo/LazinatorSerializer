//70a9e63d-cdfa-46cf-1f25-1efdb5e1ef8d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class ExampleGrandchild : ILazinator
    {
        ...
        {
            _AString = span.ToString_BrotliCompressedWithLength(ref bytesSoFar);_MyInt = span.ToDecompressedInt32(ref bytesSoFar);        }
            ...
            {
                TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.ExampleGrandchild ");
            ...
            {
                TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.ExampleGrandchild starting at {writer.Position}.");
                ...
                TabbedText.WriteLine($"Byte {writer.Position} (end of ExampleGrandchild) ");
            }
            ...
            {
                TabbedText.WriteLine($"Byte {writer.Position}, AString value {_AString}");
                TabbedText.Tabs++;
