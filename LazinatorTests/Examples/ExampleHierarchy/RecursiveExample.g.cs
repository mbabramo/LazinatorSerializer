/*Location3468*//*Location3454*///87136fa0-de4a-a0a3-e5a7-023c178a374f
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location3455*/
    using Lazinator.Attributes;/*Location3456*/
    using Lazinator.Buffers;/*Location3457*/
    using Lazinator.Core;/*Location3458*/
    using Lazinator.Exceptions;/*Location3459*/
    using Lazinator.Support;/*Location3460*/
    using System;/*Location3461*/
    using System.Buffers;/*Location3462*/
    using System.Collections.Generic;/*Location3463*/
    using System.Diagnostics;/*Location3464*/
    using System.IO;/*Location3465*/
    using System.Linq;/*Location3466*/
    using System.Runtime.InteropServices;/*Location3467*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class RecursiveExample : ILazinator
    {
        /*Location3469*/public bool IsStruct => false;
        
        /*Location3470*//* Property definitions */
        
        /*Location3471*/        protected int _RecursiveClass_ByteIndex;
        /*Location3472*/        protected int _RecursiveInterface_ByteIndex;
        /*Location3473*/protected virtual int _RecursiveClass_ByteLength => _RecursiveInterface_ByteIndex - _RecursiveClass_ByteIndex;
        /*Location3474*/private int _RecursiveExample_EndByteIndex;
        /*Location3475*/protected virtual int _RecursiveInterface_ByteLength => _RecursiveExample_EndByteIndex - _RecursiveInterface_ByteIndex;
        ...
        /*Location3482*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location3483*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _RecursiveClass_Accessed) && RecursiveClass == null)
            {
            ...
            /*Location3484*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _RecursiveInterface_Accessed) && RecursiveInterface == null)
            {
            ...
            /*Location3485*/yield break;
        }
        /*Location3486*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location3487*/yield break;
        }
        /*Location3488*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location3489*/if ((!exploreOnlyDeserializedChildren && RecursiveClass != null) || (_RecursiveClass_Accessed && _RecursiveClass != null))
            {
                _RecursiveClass = (RecursiveExample) _RecursiveClass.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location3490*/if ((!exploreOnlyDeserializedChildren && RecursiveInterface != null) || (_RecursiveInterface_Accessed && _RecursiveInterface != null))
            {
            ...
            /*Location3491*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location3494*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location3495*/_RecursiveClass_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location3496*/_RecursiveInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location3497*/_RecursiveExample_EndByteIndex = bytesSoFar;
            /*Location3498*/        }
            
            /*Location3499*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location3500*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location3501*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location3502*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location3506*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location3507*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location3508*/}
                                /*Location3509*//*Location3510*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location3514*/if (_RecursiveClass_Accessed && _RecursiveClass != null)
                                {
                                ...
                                /*Location3515*/if (_RecursiveInterface_Accessed && _RecursiveInterface != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location3518*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location3519*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location3520*/// write properties
                                    /*Location3521*/startOfObjectPosition = writer.Position;
                                    /*Location3522*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location3523*/if (updateStoredBuffer)
                                    {
                                        _RecursiveClass_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3524*/startOfObjectPosition = writer.Position;
                                    /*Location3525*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location3526*/if (updateStoredBuffer)
                                    {
                                        _RecursiveInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location3527*/if (updateStoredBuffer)
                                    {
                                        /*Location3528*/_RecursiveExample_EndByteIndex = writer.Position - startPosition;
                                        /*Location3529*/}
                                        /*Location3530*/}
                                        /*Location3531*/
                                    }
