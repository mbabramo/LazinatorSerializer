...
namespace LazinatorTests.Examples.Hierarchy
{
    ...
    public partial class RecursiveExample : ILazinator
    {
        ...
        protected virtual IEnumerable<ILazinator> EnumerateLazinatorNodes_Helper(bool exploreOnlyDeserializedChildren, Func<ILazinator, bool> exploreCriterion, Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch)
        {
            ...
            {
                foreach (ILazinator toYield in _RecursiveClass.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, matchCriterion, stopExploringBelowMatch))
                {
            ...
            {
                foreach (ILazinator toYield in _RecursiveInterface.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, matchCriterion, stopExploringBelowMatch))
                {
                    yield return toYield;
                }
            }
