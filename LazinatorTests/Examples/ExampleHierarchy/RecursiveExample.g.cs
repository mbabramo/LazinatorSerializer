/*Location2334*//*Location2320*///87136fa0-de4a-a0a3-e5a7-023c178a374f
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location2321*/
    using Lazinator.Attributes;/*Location2322*/
    using Lazinator.Buffers;/*Location2323*/
    using Lazinator.Core;/*Location2324*/
    using Lazinator.Exceptions;/*Location2325*/
    using Lazinator.Support;/*Location2326*/
    using System;/*Location2327*/
    using System.Buffers;/*Location2328*/
    using System.Collections.Generic;/*Location2329*/
    using System.Diagnostics;/*Location2330*/
    using System.IO;/*Location2331*/
    using System.Linq;/*Location2332*/
    using System.Runtime.InteropServices;/*Location2333*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class RecursiveExample : ILazinator
    {
        /*Location2335*/public bool IsStruct => false;
        
        /*Location2336*//* Property definitions */
        
        /*Location2337*/        protected int _RecursiveClass_ByteIndex;
        /*Location2338*/        protected int _RecursiveInterface_ByteIndex;
        /*Location2339*/protected virtual int _RecursiveClass_ByteLength => _RecursiveInterface_ByteIndex - _RecursiveClass_ByteIndex;
        /*Location2340*/private int _RecursiveExample_EndByteIndex;
        /*Location2341*/protected virtual int _RecursiveInterface_ByteLength => _RecursiveExample_EndByteIndex - _RecursiveInterface_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location2344*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location2345*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location2348*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location2349*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _RecursiveClass_Accessed) && RecursiveClass == null)
            {
            ...
            /*Location2350*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _RecursiveInterface_Accessed) && RecursiveInterface == null)
            {
            ...
            /*Location2351*/yield break;
        }
        /*Location2352*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location2353*/yield break;
        }
        /*Location2354*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location2355*/if ((!exploreOnlyDeserializedChildren && RecursiveClass != null) || (_RecursiveClass_Accessed && _RecursiveClass != null))
            {
                _RecursiveClass = (RecursiveExample) _RecursiveClass.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location2356*/if ((!exploreOnlyDeserializedChildren && RecursiveInterface != null) || (_RecursiveInterface_Accessed && _RecursiveInterface != null))
            {
            ...
            /*Location2357*/if (changeThisLevel && changeFunc != null)
            {
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location2361*/_RecursiveClass_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location2362*/_RecursiveInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location2363*/_RecursiveExample_EndByteIndex = bytesSoFar;
            /*Location2364*/        }
            
            /*Location2365*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location2366*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location2367*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location2368*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location2372*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location2373*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location2374*/}
                                /*Location2375*//*Location2376*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location2380*/if (_RecursiveClass_Accessed && _RecursiveClass != null)
                                {
                                ...
                                /*Location2381*/if (_RecursiveInterface_Accessed && _RecursiveInterface != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location2384*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location2385*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location2386*/// write properties
                                    /*Location2387*/startOfObjectPosition = writer.Position;
                                    /*Location2388*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location2389*/if (updateStoredBuffer)
                                    {
                                        _RecursiveClass_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location2390*/startOfObjectPosition = writer.Position;
                                    /*Location2391*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location2392*/if (updateStoredBuffer)
                                    {
                                        _RecursiveInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location2393*/if (updateStoredBuffer)
                                    {
                                        /*Location2394*/_RecursiveExample_EndByteIndex = writer.Position - startPosition;
                                        /*Location2395*/}
                                        /*Location2396*/}
                                        /*Location2397*/
                                    }
