...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial class TwoByteLengthsContainer : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.ExampleHierarchy.TwoByteLengthsContainer ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.ExampleHierarchy.TwoByteLengthsContainer starting at {writer.ActiveMemoryPosition}.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of TwoByteLengthsContainer) ");
