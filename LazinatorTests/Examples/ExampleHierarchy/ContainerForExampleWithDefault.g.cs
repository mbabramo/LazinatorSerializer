...
namespace LazinatorTests.Examples
{
    ...
    public partial class ContainerForExampleWithDefault : ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.ContainerForExampleWithDefault starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of ContainerForExampleWithDefault) ");
        }
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, ref Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _ContainerForExampleWithDefault_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
