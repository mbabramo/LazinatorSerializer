//16e3a9be-226c-d5e3-d407-2ce18cf43d58
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public WrapperContainer MyWrapperContainer
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property MyWrapperContainer cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
