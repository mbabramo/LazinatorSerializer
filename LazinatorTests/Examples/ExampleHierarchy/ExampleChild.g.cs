    ...
    public partial class ExampleChild : ILazinator
    {
        ...
        public ReadOnlySpan<Byte> ByteSpan
        {
            get
            {
                ...
                {
                    Memory<byte> initialMemory = LazinateByteSpan(); 
                    return initialMemory.Span;
                }
        ...
        private Memory<byte> LazinateByteSpan()
        {
            LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _ByteSpan_ByteIndex, _ByteSpan_ByteLength, true, false, null);
            var initialMemory = childData.InitialMemory;
            return initialMemory;
        }
        private async ValueTask<Memory<byte>> LazinateByteSpanAsync()
        {
        ...
        private async ValueTask EnsureByteSpanInMemoryAsync()
        {
            LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _ByteSpan_ByteIndex, _ByteSpan_ByteLength, true, false, null);
            await childData.LoadInitialMemoryAsync();
        }
