//ae287181-74e9-1dfe-e4b8-5cd374f9f94e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class ExampleChild : ILazinator
    {
        ...
        {
            if (_MyWrapperContainer_Accessed && _MyWrapperContainer != null && (_MyWrapperContainer.IsDirty || _MyWrapperContainer.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _MyWrapperContainer.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestMatch))
                {
