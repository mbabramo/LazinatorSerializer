...
namespace LazinatorTests.Examples
{
    ...
    public partial class ExampleChild : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_MyWrapperContainer_Accessed && _MyWrapperContainer != null))
            {
                foreach (ILazinator toYield in _MyWrapperContainer.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
