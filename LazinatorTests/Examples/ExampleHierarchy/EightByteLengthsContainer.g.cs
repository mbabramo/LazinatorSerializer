//1c61db4e-e343-3e10-da5a-6513bd142963
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial class EightByteLengthsContainer : ILazinator
    {
        ...
        protected virtual long ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.ExampleHierarchy.EightByteLengthsContainer from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        protected virtual long ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Contents: Length is at {bytesSoFar}; start location is {indexOfFirstChild + totalChildrenBytes}"); 
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.ExampleHierarchy.EightByteLengthsContainer at position {writer.ToLocationString()}");
        ...
        {
            long startPosition = writer.OverallMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.ExampleHierarchy.EightByteLengthsContainer.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of EightByteLengthsContainer) ");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, long startOfObjectPosition)
        {
            ...
            long lengthValue = 0;
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition}, Contents (accessed? {_Contents_Accessed}) (backing var null? {_Contents == null}) ");
            TabbedText.Tabs++;
