...
namespace LazinatorTests.Examples.ExampleHierarchy
{
    ...
    public partial class EightByteLengthsContainer : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.ExampleHierarchy.EightByteLengthsContainer ");
        ...
        {
            long startPosition = writer.OverallMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.ExampleHierarchy.EightByteLengthsContainer starting at {writer.ActiveMemoryPosition}.");
