//27f7460f-1c43-6061-8d09-472d8e63a620
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.432, on 2024/03/23 04:24:48.601 PM.
//
...
namespace LazinatorTests.Examples
{
    ...
    [Autogenerated]
    public partial class NullableContextEnabledWithParameterlessConstructor : ILazinator
    {
        ...
        private int _NullableContextEnabledWithParameterlessConstructor_EndByteIndex;
        protected virtual  int _MyList_ByteLength => _NullableContextEnabledWithParameterlessConstructor_EndByteIndex - _MyList_ByteIndex;
        protected virtual int _OverallEndByteIndex => _NullableContextEnabledWithParameterlessConstructor_EndByteIndex;
        ...
        public NullableContextEnabledWithParameterlessConstructor(List<Int32> myList, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
            _MyList = myList;
        ...
        public NullableContextEnabledWithParameterlessConstructor(LazinatorMemory serializedBytes, ILazinator? parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        {
            NullableContextEnabledWithParameterlessConstructor clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new NullableContextEnabledWithParameterlessConstructor(MyList, includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (NullableContextEnabledWithParameterlessConstructor)AssignCloneProperties(clone, includeChildrenMode)!;
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new NullableContextEnabledWithParameterlessConstructor(bytes);
            }
            return clone;
        }
        ...
        protected virtual ILazinator? AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            NullableContextEnabledWithParameterlessConstructor typedClone = (NullableContextEnabledWithParameterlessConstructor) clone;
        ...
        protected virtual int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _NullableContextEnabledWithParameterlessConstructor_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.UpdateStoredBuffer)
            {
                _NullableContextEnabledWithParameterlessConstructor_EndByteIndex = writer.ActiveMemoryPosition - startOfObjectPosition;
            }
