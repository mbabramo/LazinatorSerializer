//603e0de1-1f60-07e4-e2e3-712c8a3fe0c5
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.AnotherNamespace
{
    ...
    [Autogenerated]
    public partial struct StructInAnotherNamespace : ILazinator
    {
        ...
        public StructInAnotherNamespace(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : this()
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public StructInAnotherNamespace(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : this()
        {
        ...
        {
            StructInAnotherNamespace clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new StructInAnotherNamespace(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (StructInAnotherNamespace)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new StructInAnotherNamespace(bytes);
            }
            return clone;
        }
        ...
        ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            StructInAnotherNamespace typedClone = (StructInAnotherNamespace) clone;
        ...
        public int LazinatorUniqueID => 1088;
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.AnotherNamespace.StructInAnotherNamespace from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.AnotherNamespace.StructInAnotherNamespace at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for LazinatorTests.AnotherNamespace.StructInAnotherNamespace.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of StructInAnotherNamespace) ");
