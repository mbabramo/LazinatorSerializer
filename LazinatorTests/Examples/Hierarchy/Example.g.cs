//16b0cf83-f739-6320-f48d-2f3ac2a2cd7d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    public partial class Example : ILazinator
    {
        ...
        public virtual void LazinatorConvertToBytes()
        {
            ...
            _MyChild1_Accessed = false;
            _MyChild2_Accessed = false;
            _MyChild2Previous_Accessed = false;
            _MyInterfaceImplementer_Accessed = false;
            _MyNonLazinatorChild_Accessed = false;
        }
            ...
            get
            {
                if (!_MyNonLazinatorChild_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _MyNonLazinatorChild = ConvertFromBytes_LazinatorTests_Examples_NonLazinatorClass(childData, DeserializationFactory, () => { MyNonLazinatorChild_Dirty = true; });
                    }
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_LazinatorTests_Examples_NonLazinatorClass(w, MyNonLazinatorChild,
