//01adf74b-7559-4ca9-7e6c-a4db7730f6d6
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.Hierarchy
{
    ...
    public partial class ExampleInterfaceContainer : ILazinator
    {
            ...
            get
            {
                if (!_ExampleByInterface_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _ExampleByInterface = (IExample)DeserializationFactory.FactoryCreate(childData, this); 
                    }
        ...
        public List<IExample> ExampleListByInterface
        {
            ...
            get
            {
                if (!_ExampleListByInterface_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _ExampleListByInterface_ByteIndex, _ExampleListByInterface_ByteLength);
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _ExampleByInterface, includeChildrenMode, _ExampleByInterface_Accessed, () => GetChildSlice(LazinatorObjectBytes, _ExampleByInterface_ByteIndex, _ExampleByInterface_ByteLength), verifyCleanness, false, this);
            }
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _ExampleListByInterface_ByteIndex, _ExampleListByInterface_ByteLength),
        ...
        private static List<IExample> ConvertFromBytes_List_GIExample_g(ReadOnlyMemory<byte> storage, DeserializationFactory deserializationFactory, InformParentOfDirtinessDelegate informParentOfDirtinessDelegate)
        {
            ...
            for (int i = 0; i < collectionLength; i++)
            {
                ...
                else
                {
                    ...
                    var item = (IExample)deserializationFactory.FactoryCreate(childData, informParentOfDirtinessDelegate);
                    collection.Add(item);
                }
