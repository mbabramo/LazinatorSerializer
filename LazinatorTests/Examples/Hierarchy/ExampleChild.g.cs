//1366b26b-8bc4-0fcc-ae65-45797a3608f1
//------------------------------------------------------------------------------
// <auto-generated>
    ...
    public partial class ExampleChild : ILazinator
    {
        ...
        public ReadOnlySpan<byte> ByteSpan
        {
            ...
            get
            {
                ...
                {
                    ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _ByteSpan_ByteIndex, _ByteSpan_ByteLength, false, null);
                    _ByteSpan = childData;
        ...
        public WrapperContainer MyWrapperContainer
        {
            ...
            get
            {
                if (!_MyWrapperContainer_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _MyWrapperContainer_ByteIndex, _MyWrapperContainer_ByteLength, false, null);
                        
                        if (DeserializationFactory == null)
                        {
                            DeserializationFactory = DeserializationFactory.GetInstance();
                        }
                        _MyWrapperContainer = DeserializationFactory.CreateBaseOrDerivedType(248, () => new WrapperContainer(), childData, this); 
                    }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorObjectBytes, _ByteSpan_ByteIndex, _ByteSpan_ByteLength, false, null),
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _MyWrapperContainer, includeChildrenMode, _MyWrapperContainer_Accessed, () => GetChildSlice(LazinatorObjectBytes, _MyWrapperContainer_ByteIndex, _MyWrapperContainer_ByteLength, false, null), verifyCleanness, false, false, this);
            }
        }
