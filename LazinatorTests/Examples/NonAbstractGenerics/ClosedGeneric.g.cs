//8a9465b0-4fed-c419-cb6a-49da76edcb0b
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    public partial class ClosedGeneric : OpenGeneric<ExampleChild>, ILazinator
    {
        ...
        protected override int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.NonAbstractGenerics.ClosedGeneric at position: " + LazinatorMemoryStorage.ToLocationString());
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.NonAbstractGenerics.ClosedGeneric at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.NonAbstractGenerics.ClosedGeneric.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of ClosedGeneric) ");
        ...
        protected override void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()}, AnotherPropertyAdded value {_AnotherPropertyAdded}");
            TabbedText.Tabs++;
