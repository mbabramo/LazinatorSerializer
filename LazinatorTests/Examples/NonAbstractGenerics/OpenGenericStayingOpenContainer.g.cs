/*Location3958*//*Location3941*///5db2a6d2-c09b-6111-632f-58a4e4acc3e8
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location3942*/
    using Lazinator.Attributes;/*Location3943*/
    using Lazinator.Buffers;/*Location3944*/
    using Lazinator.Core;/*Location3945*/
    using Lazinator.Exceptions;/*Location3946*/
    using Lazinator.Support;/*Location3947*/
    using Lazinator.Wrappers;/*Location3948*/
    using LazinatorTests.Examples;/*Location3949*/
    using LazinatorTests.Examples.Abstract;/*Location3950*/
    using System;/*Location3951*/
    using System.Buffers;/*Location3952*/
    using System.Collections.Generic;/*Location3953*/
    using System.Diagnostics;/*Location3954*/
    using System.IO;/*Location3955*/
    using System.Linq;/*Location3956*/
    using System.Runtime.InteropServices;/*Location3957*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class OpenGenericStayingOpenContainer : ILazinator
    {
        /*Location3959*/public bool IsStruct => false;
        
        /*Location3960*//* Property definitions */
        
        /*Location3961*/        protected int _ClosedGenericBase_ByteIndex;
        /*Location3962*/        protected int _ClosedGenericFloat_ByteIndex;
        /*Location3963*/        protected int _ClosedGenericFromBaseWithBase_ByteIndex;
        /*Location3964*/        protected int _ClosedGenericInterface_ByteIndex;
        /*Location3965*/        protected int _ClosedGenericNonexclusiveInterface_ByteIndex;
        /*Location3966*/protected virtual int _ClosedGenericBase_ByteLength => _ClosedGenericFloat_ByteIndex - _ClosedGenericBase_ByteIndex;
        /*Location3967*/protected virtual int _ClosedGenericFloat_ByteLength => _ClosedGenericFromBaseWithBase_ByteIndex - _ClosedGenericFloat_ByteIndex;
        /*Location3968*/protected virtual int _ClosedGenericFromBaseWithBase_ByteLength => _ClosedGenericInterface_ByteIndex - _ClosedGenericFromBaseWithBase_ByteIndex;
        /*Location3969*/protected virtual int _ClosedGenericInterface_ByteLength => _ClosedGenericNonexclusiveInterface_ByteIndex - _ClosedGenericInterface_ByteIndex;
        /*Location3970*/private int _OpenGenericStayingOpenContainer_EndByteIndex;
        /*Location3971*/protected virtual int _ClosedGenericNonexclusiveInterface_ByteLength => _OpenGenericStayingOpenContainer_EndByteIndex - _ClosedGenericNonexclusiveInterface_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location3977*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location3978*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location3979*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location3980*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location3981*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location3984*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location3985*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericBase_Accessed) && ClosedGenericBase == null)
            {
            ...
            /*Location3986*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericFloat_Accessed) && ClosedGenericFloat == null)
            {
            ...
            /*Location3987*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericFromBaseWithBase_Accessed) && ClosedGenericFromBaseWithBase == null)
            {
            ...
            /*Location3988*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericInterface_Accessed) && ClosedGenericInterface == null)
            {
            ...
            /*Location3989*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericNonexclusiveInterface_Accessed) && ClosedGenericNonexclusiveInterface == null)
            {
        ...
        {
            /*Location3992*/yield break;
        }
        /*Location3993*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location3994*/if ((!exploreOnlyDeserializedChildren && ClosedGenericBase != null) || (_ClosedGenericBase_Accessed && _ClosedGenericBase != null))
            {
                _ClosedGenericBase = (OpenGeneric<Base>) _ClosedGenericBase.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location3995*/if ((!exploreOnlyDeserializedChildren && ClosedGenericFloat != null) || (_ClosedGenericFloat_Accessed && _ClosedGenericFloat != null))
            {
            ...
            /*Location3996*/if ((!exploreOnlyDeserializedChildren && ClosedGenericFromBaseWithBase != null) || (_ClosedGenericFromBaseWithBase_Accessed && _ClosedGenericFromBaseWithBase != null))
            {
            ...
            /*Location3997*/if ((!exploreOnlyDeserializedChildren && ClosedGenericInterface != null) || (_ClosedGenericInterface_Accessed && _ClosedGenericInterface != null))
            {
            ...
            /*Location3998*/if ((!exploreOnlyDeserializedChildren && ClosedGenericNonexclusiveInterface != null) || (_ClosedGenericNonexclusiveInterface_Accessed && _ClosedGenericNonexclusiveInterface != null))
            {
            ...
            /*Location3999*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4002*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4003*/_ClosedGenericBase_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4004*/_ClosedGenericFloat_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4005*/_ClosedGenericFromBaseWithBase_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4006*/_ClosedGenericInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4007*/_ClosedGenericNonexclusiveInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4008*/_OpenGenericStayingOpenContainer_EndByteIndex = bytesSoFar;
            /*Location4009*/        }
            
            /*Location4010*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4011*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4012*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4013*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4017*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4018*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location4019*/}
                                /*Location4020*//*Location4021*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location4025*/if (_ClosedGenericBase_Accessed && _ClosedGenericBase != null)
                                {
                                ...
                                /*Location4026*/if (_ClosedGenericFloat_Accessed && _ClosedGenericFloat != null)
                                {
                                ...
                                /*Location4027*/if (_ClosedGenericFromBaseWithBase_Accessed && _ClosedGenericFromBaseWithBase != null)
                                {
                                ...
                                /*Location4028*/if (_ClosedGenericInterface_Accessed && _ClosedGenericInterface != null)
                                {
                                ...
                                /*Location4029*/if (_ClosedGenericNonexclusiveInterface_Accessed && _ClosedGenericNonexclusiveInterface != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4032*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4033*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4034*/// write properties
                                    /*Location4035*/startOfObjectPosition = writer.Position;
                                    /*Location4036*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4037*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericBase_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4038*/startOfObjectPosition = writer.Position;
                                    /*Location4039*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4040*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericFloat_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4041*/startOfObjectPosition = writer.Position;
                                    /*Location4042*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4043*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericFromBaseWithBase_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4044*/startOfObjectPosition = writer.Position;
                                    /*Location4045*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4046*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4047*/startOfObjectPosition = writer.Position;
                                    /*Location4048*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4049*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericNonexclusiveInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4050*/if (updateStoredBuffer)
                                    {
                                        /*Location4051*/_OpenGenericStayingOpenContainer_EndByteIndex = writer.Position - startPosition;
                                        /*Location4052*/}
                                        /*Location4053*/}
                                        /*Location4054*/
                                    }
