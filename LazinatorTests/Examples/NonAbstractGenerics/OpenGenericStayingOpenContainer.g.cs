/*Location5108*//*Location5091*///5db2a6d2-c09b-6111-632f-58a4e4acc3e8
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location5092*/
    using Lazinator.Attributes;/*Location5093*/
    using Lazinator.Buffers;/*Location5094*/
    using Lazinator.Core;/*Location5095*/
    using Lazinator.Exceptions;/*Location5096*/
    using Lazinator.Support;/*Location5097*/
    using Lazinator.Wrappers;/*Location5098*/
    using LazinatorTests.Examples;/*Location5099*/
    using LazinatorTests.Examples.Abstract;/*Location5100*/
    using System;/*Location5101*/
    using System.Buffers;/*Location5102*/
    using System.Collections.Generic;/*Location5103*/
    using System.Diagnostics;/*Location5104*/
    using System.IO;/*Location5105*/
    using System.Linq;/*Location5106*/
    using System.Runtime.InteropServices;/*Location5107*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class OpenGenericStayingOpenContainer : ILazinator
    {
        /*Location5109*/public bool IsStruct => false;
        
        /*Location5110*//* Property definitions */
        
        /*Location5111*/        protected int _ClosedGenericBase_ByteIndex;
        /*Location5112*/        protected int _ClosedGenericFloat_ByteIndex;
        /*Location5113*/        protected int _ClosedGenericFromBaseWithBase_ByteIndex;
        /*Location5114*/        protected int _ClosedGenericInterface_ByteIndex;
        /*Location5115*/        protected int _ClosedGenericNonexclusiveInterface_ByteIndex;
        /*Location5116*/protected virtual int _ClosedGenericBase_ByteLength => _ClosedGenericFloat_ByteIndex - _ClosedGenericBase_ByteIndex;
        /*Location5117*/protected virtual int _ClosedGenericFloat_ByteLength => _ClosedGenericFromBaseWithBase_ByteIndex - _ClosedGenericFloat_ByteIndex;
        /*Location5118*/protected virtual int _ClosedGenericFromBaseWithBase_ByteLength => _ClosedGenericInterface_ByteIndex - _ClosedGenericFromBaseWithBase_ByteIndex;
        /*Location5119*/protected virtual int _ClosedGenericInterface_ByteLength => _ClosedGenericNonexclusiveInterface_ByteIndex - _ClosedGenericInterface_ByteIndex;
        /*Location5120*/private int _OpenGenericStayingOpenContainer_EndByteIndex;
        /*Location5121*/protected virtual int _ClosedGenericNonexclusiveInterface_ByteLength => _OpenGenericStayingOpenContainer_EndByteIndex - _ClosedGenericNonexclusiveInterface_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location5127*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location5128*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location5129*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location5130*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
            ...
            /*Location5131*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        /*Location5134*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location5135*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericBase_Accessed) && ClosedGenericBase == null)
            {
            ...
            /*Location5136*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericFloat_Accessed) && ClosedGenericFloat == null)
            {
            ...
            /*Location5137*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericFromBaseWithBase_Accessed) && ClosedGenericFromBaseWithBase == null)
            {
            ...
            /*Location5138*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericInterface_Accessed) && ClosedGenericInterface == null)
            {
            ...
            /*Location5139*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _ClosedGenericNonexclusiveInterface_Accessed) && ClosedGenericNonexclusiveInterface == null)
            {
            ...
            /*Location5140*/yield break;
        }
        /*Location5141*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location5142*/yield break;
        }
        /*Location5143*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location5144*/if ((!exploreOnlyDeserializedChildren && ClosedGenericBase != null) || (_ClosedGenericBase_Accessed && _ClosedGenericBase != null))
            {
                _ClosedGenericBase = (OpenGeneric<Base>) _ClosedGenericBase.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location5145*/if ((!exploreOnlyDeserializedChildren && ClosedGenericFloat != null) || (_ClosedGenericFloat_Accessed && _ClosedGenericFloat != null))
            {
            ...
            /*Location5146*/if ((!exploreOnlyDeserializedChildren && ClosedGenericFromBaseWithBase != null) || (_ClosedGenericFromBaseWithBase_Accessed && _ClosedGenericFromBaseWithBase != null))
            {
            ...
            /*Location5147*/if ((!exploreOnlyDeserializedChildren && ClosedGenericInterface != null) || (_ClosedGenericInterface_Accessed && _ClosedGenericInterface != null))
            {
            ...
            /*Location5148*/if ((!exploreOnlyDeserializedChildren && ClosedGenericNonexclusiveInterface != null) || (_ClosedGenericNonexclusiveInterface_Accessed && _ClosedGenericNonexclusiveInterface != null))
            {
            ...
            /*Location5149*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location5152*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location5153*/_ClosedGenericBase_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location5154*/_ClosedGenericFloat_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location5155*/_ClosedGenericFromBaseWithBase_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location5156*/_ClosedGenericInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location5157*/_ClosedGenericNonexclusiveInterface_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location5158*/_OpenGenericStayingOpenContainer_EndByteIndex = bytesSoFar;
            /*Location5159*/        }
            
            /*Location5160*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location5161*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location5162*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location5163*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location5167*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location5168*/
                            if (updateDeserializedChildren)
                            {
                                UpdateDeserializedChildren(ref writer, startPosition);
                                /*Location5169*/}
                                /*Location5170*//*Location5171*/
                            }
                            else
                            {
                            ...
                            {
                                /*Location5175*/if (_ClosedGenericBase_Accessed && _ClosedGenericBase != null)
                                {
                                ...
                                /*Location5176*/if (_ClosedGenericFloat_Accessed && _ClosedGenericFloat != null)
                                {
                                ...
                                /*Location5177*/if (_ClosedGenericFromBaseWithBase_Accessed && _ClosedGenericFromBaseWithBase != null)
                                {
                                ...
                                /*Location5178*/if (_ClosedGenericInterface_Accessed && _ClosedGenericInterface != null)
                                {
                                ...
                                /*Location5179*/if (_ClosedGenericNonexclusiveInterface_Accessed && _ClosedGenericNonexclusiveInterface != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location5182*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location5183*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location5184*/// write properties
                                    /*Location5185*/startOfObjectPosition = writer.Position;
                                    /*Location5186*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location5187*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericBase_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5188*/startOfObjectPosition = writer.Position;
                                    /*Location5189*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location5190*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericFloat_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5191*/startOfObjectPosition = writer.Position;
                                    /*Location5192*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location5193*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericFromBaseWithBase_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5194*/startOfObjectPosition = writer.Position;
                                    /*Location5195*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location5196*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5197*/startOfObjectPosition = writer.Position;
                                    /*Location5198*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location5199*/if (updateStoredBuffer)
                                    {
                                        _ClosedGenericNonexclusiveInterface_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location5200*/if (updateStoredBuffer)
                                    {
                                        /*Location5201*/_OpenGenericStayingOpenContainer_EndByteIndex = writer.Position - startPosition;
                                        /*Location5202*/}
                                        /*Location5203*/}
                                        /*Location5204*/
                                    }
