//db4eb791-9341-e03b-6230-382dbb3b11e8
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    public partial class OpenGenericStayingOpenContainer : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_ClosedGenericFloat_Accessed && _ClosedGenericFloat != null))
            {
                foreach (ILazinator toYield in _ClosedGenericFloat.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
                    yield return toYield;
                }
            }
            if (!exploreOnlyDeserializedChildren || (_ClosedGenericInterface_Accessed && _ClosedGenericInterface != null))
            {
                foreach (ILazinator toYield in _ClosedGenericInterface.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
                    yield return toYield;
                }
            }
            if (!exploreOnlyDeserializedChildren || (_ClosedGenericNonexclusiveInterface_Accessed && _ClosedGenericNonexclusiveInterface != null))
            {
                foreach (ILazinator toYield in _ClosedGenericNonexclusiveInterface.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
                    yield return toYield;
                }
            }
