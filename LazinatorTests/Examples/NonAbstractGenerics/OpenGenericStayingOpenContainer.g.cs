//b187d73d-c454-5552-05d5-b574cac53d0f
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public OpenGeneric<WFloat> ClosedGeneric
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property ClosedGeneric cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
