...
namespace LazinatorTests.Examples
{
    ...
    public partial class DerivedLazinatorList<T> : LazinatorCollections.LazinatorList<T>, ILazinator
    {
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.DerivedLazinatorList<T> starting at {writer.ActiveMemoryPosition}.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of DerivedLazinatorList<T>) ");
