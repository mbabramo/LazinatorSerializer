//aaeeb6d0-df5e-8932-d065-6e420b652cbf
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    public partial class ClosedGenericWithGeneric : OpenGeneric<OpenGeneric<ExampleChild>>, ILazinator
    {
        ...
        protected override int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.NonAbstractGenerics.ClosedGenericWithGeneric from bytes at: " + LazinatorMemoryStorage.ToLocationString());
        ...
        protected override void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading AnotherPropertyAddedHereToo at byte location {bytesSoFar}"); 
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of LazinatorTests.Examples.NonAbstractGenerics.ClosedGenericWithGeneric at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorTests.Examples.NonAbstractGenerics.ClosedGenericWithGeneric.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of ClosedGenericWithGeneric) ");
        ...
        protected override void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition}, AnotherPropertyAddedHereToo value {_AnotherPropertyAddedHereToo}");
            TabbedText.Tabs++;
