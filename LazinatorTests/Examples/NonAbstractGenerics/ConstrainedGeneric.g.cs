//fff3299c-96d2-86d3-af74-4f8235a511f9
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    public partial class ConstrainedGeneric<T, U> : ILazinator
    {
        ...
        public virtual T? MyNullableT
        {
            ...
            set
            {
                if (value.HasValue)
                {
                    ...
                    copy.LazinatorParents = new LazinatorParentsCollection(this);/*Location374*/
                    value = copy;
                }
        ...
        private void Lazinate_MyNullableT()
        {
            ...
            {
                _MyNullableT = default(T?);/*Location373*/
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MyNullableT_ByteIndex, _MyNullableT_ByteLength, false, false, null);
        ...
        public virtual T MyT
        {
            ...
            set
            {
                value.LazinatorParents = new LazinatorParentsCollection(this);/*Location376*/
        ...
        private void Lazinate_MyT()
        {
            ...
            {
                _MyT = default(T);
                _MyT.LazinatorParents = new LazinatorParentsCollection(this);/*Location375*/
            }
            else
            {
        ...
        public virtual U MyU
        {
            ...
            set
            {
                if (value != null && value.IsStruct)/*Location378*/
                {
                    value.LazinatorParents = new LazinatorParentsCollection(this);/*Location379*/
                }
                else
                {
                    if (_MyU != null)
                    {
                        _MyU.LazinatorParents = _MyU.LazinatorParents.WithRemoved(this);/*Location380*/
                    }
                    if (value != null)
                    {
                        value.LazinatorParents = value.LazinatorParents.WithAdded(this);/*Location381*/
                    }
                }
        ...
        private void Lazinate_MyU()
        {
            if (LazinatorObjectBytes.Length == 0)
            {
                ...
                if (_MyU != null)
                { // MyU is a struct
                    _MyU.LazinatorParents = new LazinatorParentsCollection(this);/*Location377*/
                }
            }
            else
            {
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            {
                typedClone.MyNullableT = (T?) MyNullableT.Value.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);/*Location382*/
            }
            
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                typedClone.MyT = (T) MyT.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);/*Location385*/
            }
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyU == null)
                {
                    typedClone.MyU = default(U);/*Location387*//*Location388*/
                }
                else
                {
                    typedClone.MyU = (U) MyU.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);/*Location386*/
                }
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _MyNullableT_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                WriteChild(ref writer, ref copy, includeChildrenMode, _MyNullableT_Accessed, () => GetChildSlice(LazinatorMemoryStorage, _MyNullableT_ByteIndex, _MyNullableT_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
            
            if (updateStoredBuffer)
            {
                _MyNullableT_ByteIndex = startOfObjectPosition - startPosition;
            }
            startOfObjectPosition = writer.Position;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
