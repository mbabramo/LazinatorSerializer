//d07067e3-4f09-81c9-c979-5b6c9d95a624
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.416, on 2024/02/06 01:31:21.938 PM.
//
    ...
    public partial class ConstrainedGeneric<T, U> : ILazinator
    {
        ...
        private void LazinateMyU()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_MyU != null)
                { // MyU is a struct
                    _MyU.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
