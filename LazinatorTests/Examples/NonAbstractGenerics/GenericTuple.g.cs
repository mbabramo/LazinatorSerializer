//02daf866-472d-5404-aae0-5b65b3c261f5
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    [Autogenerated]
    public partial class GenericTuple<T, U> : ILazinator
    {
        ...
        private int _GenericTuple_T_U_EndByteIndex = 0;
        protected virtual int _Item2_ByteLength => _GenericTuple_T_U_EndByteIndex - _Item2_ByteIndex;
        ...
        {
            var clone = new GenericTuple<T, U>()
            {
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            GenericTuple<T, U> typedClone = (GenericTuple<T, U>) clone;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<GenericTuple<T, U>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(105, new Type[] { typeof(T), typeof(U) }));
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _GenericTuple_T_U_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _GenericTuple_T_U_EndByteIndex = writer.Position - startPosition;
            }
        }
