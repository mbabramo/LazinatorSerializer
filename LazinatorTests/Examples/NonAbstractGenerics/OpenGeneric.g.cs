...
namespace LazinatorTests.Examples.NonAbstractGenerics
{
    ...
    public partial class OpenGeneric<T> : ILazinator
    {
        ...
        protected virtual int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting LazinatorTests.Examples.NonAbstractGenerics.OpenGeneric<T> from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"MyListT: Length is at {bytesSoFar}; start location is {indexOfFirstChild + totalChildrenBytes}"); 
