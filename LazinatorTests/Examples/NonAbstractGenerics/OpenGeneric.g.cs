/*Location4863*//*Location4849*///f8d4fe92-6559-6511-3ccc-3c2c092baf00
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location4850*/
    using Lazinator.Attributes;/*Location4851*/
    using Lazinator.Buffers;/*Location4852*/
    using Lazinator.Core;/*Location4853*/
    using Lazinator.Exceptions;/*Location4854*/
    using Lazinator.Support;/*Location4855*/
    using System;/*Location4856*/
    using System.Buffers;/*Location4857*/
    using System.Collections.Generic;/*Location4858*/
    using System.Diagnostics;/*Location4859*/
    using System.IO;/*Location4860*/
    using System.Linq;/*Location4861*/
    using System.Runtime.InteropServices;/*Location4862*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class OpenGeneric<T> : ILazinator
    {
        /*Location4864*/public bool IsStruct => false;
        
        /*Location4865*//* Property definitions */
        
        /*Location4866*/        protected int _MyListT_ByteIndex;
        /*Location4867*/        protected int _MyT_ByteIndex;
        /*Location4868*/protected virtual int _MyListT_ByteLength => _MyT_ByteIndex - _MyListT_ByteIndex;
        /*Location4869*/private int _OpenGeneric_T_EndByteIndex = 0;
        /*Location4870*/protected virtual int _MyT_ByteLength => _OpenGeneric_T_EndByteIndex - _MyT_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location4873*/typedClone.MyListT = CloneOrChange_List_GT_g(MyListT, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            /*Location4874*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (MyT == null)
                {
        ...
        /*Location4877*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location4878*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _MyT_Accessed) && MyT == null)
            {
            ...
            /*Location4879*/yield break;
        }
        /*Location4880*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location4881*/yield return ("MyListT", (object)MyListT);
            /*Location4882*/yield break;
        }
        /*Location4883*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location4884*/if ((!exploreOnlyDeserializedChildren && MyT != null) || (_MyT_Accessed && _MyT != null))
            {
                _MyT = (T) _MyT.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location4885*/if ((!exploreOnlyDeserializedChildren && MyListT != null) || (_MyListT_Accessed && _MyListT != null))
            {
            ...
            /*Location4886*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location4889*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location4890*/_MyListT_ByteIndex = bytesSoFar;
            bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            /*Location4891*/_MyT_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location4892*/_OpenGeneric_T_EndByteIndex = bytesSoFar;
            /*Location4893*/        }
            
            /*Location4894*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location4895*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location4896*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location4897*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location4901*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location4902*/
                            ...
                            {
                                /*Location4909*/if (_MyT_Accessed && _MyT != null)
                                {
                                ...
                                /*Location4910*/if (_MyListT_Accessed && _MyListT != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location4913*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location4914*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location4915*/// write properties
                                    /*Location4916*/startOfObjectPosition = writer.Position;
                                    /*Location4917*/if ((includeChildrenMode != IncludeChildrenMode.IncludeAllChildren || includeChildrenMode != OriginalIncludeChildrenMode) && !_MyListT_Accessed)
                                    {
                                        var deserialized = MyListT;
                                    }
                                    /*Location4918*/WriteNonLazinatorObject(
                                    ...
                                    /*Location4919*/if (updateStoredBuffer)
                                    {
                                        _MyListT_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4920*/startOfObjectPosition = writer.Position;
                                    /*Location4921*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location4922*/if (updateStoredBuffer)
                                    {
                                        _MyT_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location4923*/if (updateStoredBuffer)
                                    {
                                        /*Location4924*/_OpenGeneric_T_EndByteIndex = writer.Position - startPosition;
                                        /*Location4925*/}
                                        /*Location4926*/}
                                        /*Location4927*/
