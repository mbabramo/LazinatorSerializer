//719953bd-2668-fcc3-c545-e4f51b04066f
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorTests.Examples
{
    ...
    public partial class ClosedGenericWithoutBase : ILazinator
    {
            ...
            get
            {
                if (!_ItemU_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _ItemU = DeserializationFactory.Create(213, () => new ExampleChild(), childData, this); 
                    }
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _ItemU, includeChildrenMode, _ItemU_Accessed, () => GetChildSlice(LazinatorObjectBytes, _ItemU_ByteIndex, _ItemU_ByteLength), verifyCleanness, false, this);
            }
