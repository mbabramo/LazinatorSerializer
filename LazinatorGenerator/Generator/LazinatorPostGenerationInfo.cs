...
namespace LazinatorGenerator.Generator
{
    ...
    internal readonly record struct LazinatorPostGenerationInfo
    {
        ...
        public void GenerateSource(SourceProductionContext spc, IDateTimeNow dateTimeNowProvider, long pipelineRunTimeStamp, Compilation compilation)
        {
            if (pipelineRunTimeStamp == AlreadyGeneratedCode.PipelineStartTimeStamp)
            {
            ...
            var result = PreGenerationInfo.ExecuteSourceGeneration(dateTimeNowProvider, pipelineRunTimeStamp, compilation);
