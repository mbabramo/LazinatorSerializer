...
namespace LazinatorGenerator.Generator
{
    ...
    internal readonly record struct LazinatorPostGenerationInfo
    {
        ...
        public void GenerateSource(SourceProductionContext spc, IDateTimeNow dateTimeNowProvider, long pipelineRunTimeStamp)
        {
            ...
            var result = PreGenerationInfo.ExecuteSourceGeneration(dateTimeNowProvider, pipelineRunTimeStamp);
