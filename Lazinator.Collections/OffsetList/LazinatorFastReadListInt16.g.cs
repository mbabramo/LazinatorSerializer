...
namespace Lazinator.Collections.OffsetList
{
    ...
    public partial class LazinatorFastReadListInt16 : LazinatorFastReadList<Int16>, ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.OffsetList.LazinatorFastReadListInt16 ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.OffsetList.LazinatorFastReadListInt16 starting at {writer.ActiveMemoryPosition}.");
