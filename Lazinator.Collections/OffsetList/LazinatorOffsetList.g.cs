//77ad7713-707e-a7fc-31eb-90f8358e5d9e
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.410, on 2024/02/03 10:04:18.925 PM.
//
...
namespace Lazinator.Collections.OffsetList
{
    ...
    public sealed partial class LazinatorOffsetList : ILazinator
    {
        ...
        protected int _FourByteItems_ByteIndex;
        protected int _TwoByteItems_ByteIndex;
        protected int _FourByteItems_ByteLength => _TwoByteItems_ByteIndex - _FourByteItems_ByteIndex;
        protected int _TwoByteItems_ByteLength => (int) (LazinatorMemoryStorage.Length - _TwoByteItems_ByteIndex);
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorFastReadListInt32 _FourByteItems;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _FourByteItems_Accessed;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorFastReadListInt16 _TwoByteItems;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _TwoByteItems_Accessed;
        ...
        protected void DeserializeLazinator(LazinatorMemory serializedBytes)
        {
        ...
        protected LazinatorMemory EncodeToNewBuffer(in LazinatorSerializationOptions options) 
        {
        ...
        protected ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool ContainsOpenGenericParameters => false;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        protected int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        protected void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
        }
        
        protected int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
        ...
        protected void UpdateDeserializedChildren(ref BufferWriter writer, long startPosition)
        {
        ...
        protected void WritePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            int startPosition = writer.ActiveMemoryPosition;
            if (includeUniqueID)
            {
        ...
        protected void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
