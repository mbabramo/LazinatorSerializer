//4142d4b4-dec7-4701-8517-93420f1bcede
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.431, on 2024/03/19 03:51:31.155 PM.
//
    ...
    public partial class Remote<TKey, TValue> : ILazinator
    {
        ...
        private void LazinateKey()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_Key != null)
                { // Key is a struct
                    _Key.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
        ...
        private void LazinateLocal()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_Local != null)
                { // Local is a struct
                    _Local.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
