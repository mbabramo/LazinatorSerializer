...
namespace Lazinator.Collections.Tuples
{
    ...
    public partial class LazinatorTriple<T, U, V> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.Tuples.LazinatorTriple<T, U, V> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.Tuples.LazinatorTriple<T, U, V> starting at {writer.ActiveMemoryPosition}.");
