//e775da6a-a509-3994-b183-eb6c648a4b0d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Tuples
{
    ...
    public partial struct LazinatorKeyValue<TKey, TValue> : ILazinator
    {
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Collections.Tuples.LazinatorKeyValue<TKey, TValue> at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.Tuples.LazinatorKeyValue<TKey, TValue> at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.Tuples.LazinatorKeyValue<TKey, TValue>.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of LazinatorKeyValue<TKey, TValue>) ");
