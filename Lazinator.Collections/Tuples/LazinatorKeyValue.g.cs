//c26b904e-e6ba-8c7f-8bc7-c9aa2a30ab78
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.432, on 2024/03/23 04:24:52.195 PM.
//
    ...
    public partial struct LazinatorKeyValue<TKey, TValue> : ILazinator
    {
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                var serializedBytesCopy_Key = LazinatorMemoryStorage;
                var byteIndexCopy_Key = _Key_ByteIndex;
                var byteLengthCopy_Key = _Key_ByteLength;
                WriteChild(ref writer, ref _Key, options, _Key_Accessed, () => GetChildSlice(serializedBytesCopy_Key, byteIndexCopy_Key, byteLengthCopy_Key, null), null);
            ...
            if (options.IncludeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && options.IncludeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                WriteChild(ref writer, ref _Value, options, _Value_Accessed, () => GetChildSlice(serializedBytesCopy_Value, byteIndexCopy_Value, byteLengthCopy_Value, null), null);
                lengthValue = writer.ActiveMemoryPosition - startOfChildPosition;
                if (lengthValue > int.MaxValue)
                {
                    ThrowHelper.ThrowTooLargeException(int.MaxValue);
