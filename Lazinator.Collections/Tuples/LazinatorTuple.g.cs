...
namespace Lazinator.Collections.Tuples
{
    ...
    public partial class LazinatorTuple<T, U> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.Tuples.LazinatorTuple<T, U> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.Tuples.LazinatorTuple<T, U> starting at {writer.ActiveMemoryPosition}.");
