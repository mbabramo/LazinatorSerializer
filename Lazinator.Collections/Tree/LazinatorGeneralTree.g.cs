//2d61c143-1171-6eec-7972-94718a9f0200
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.416, on 2024/02/06 01:31:25.119 PM.
//
    ...
    public partial class LazinatorGeneralTree<T> : ILazinator
    {
        ...
        private void LazinateItem()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_Item != null)
                { // Item is a struct
                    _Item.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
