//f22ea719-3dac-2279-535c-23b54496249c
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Tree
{
    ...
    public partial class LazinatorBinaryTreeNode<T> : ILazinator, ILazinatorAsync
    {
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading length of Data at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
            _Data_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            }
            TabbedText.WriteLine($"Reading length of LeftNode at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
            _LeftNode_ByteIndex = indexOfFirstChild + totalChildrenBytes;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                totalChildrenBytes += span.ToInt32(ref bytesSoFar);
            }
            TabbedText.WriteLine($"Reading length of RightNode at byte location {bytesSoFar} to determine location: {indexOfFirstChild + totalChildrenBytes}"); 
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.Tree.LazinatorBinaryTreeNode<T> ");
        ...
        {
            long startPosition = writer.OverallMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.Tree.LazinatorBinaryTreeNode<T> starting at {writer.ActiveMemoryPosition}.");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, long startOfObjectPosition)
        {
            ...
            long lengthValue = 0;
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition}, Data value {_Data}");
            TabbedText.Tabs++;
