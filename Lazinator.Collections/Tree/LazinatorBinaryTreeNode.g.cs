//0c69ea2e-e1d2-329e-0ccd-0dba6fbea5cd
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.421, on 2024/02/06 09:19:58.847 PM.
//
    ...
    public partial class LazinatorBinaryTreeNode<T> : ILazinator, ILazinatorAsync
    {
        ...
        private void LazinateData()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_Data != null)
                { // Data is a struct
                    _Data.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
