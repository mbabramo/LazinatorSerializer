//ef754d4e-221b-029b-9744-df55a45eeead
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.419, on 2024/02/06 04:13:47.815 PM.
//
    ...
    public partial class LazinatorLinkedListNode<T> : ILazinator
    {
        ...
        private void LazinateValue()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                ...
                if (_Value != null)
                { // Value is a struct
                    _Value.LazinatorParents = new LazinatorParentsCollection(this, null);
                }
            }
            else
            {
