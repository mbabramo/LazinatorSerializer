...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorLinkedListNode<T> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.LazinatorLinkedListNode<T> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.LazinatorLinkedListNode<T> starting at {writer.ActiveMemoryPosition}.");
