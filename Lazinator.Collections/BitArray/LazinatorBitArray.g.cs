...
namespace Lazinator.Collections.BitArray
{
    ...
    public sealed partial class LazinatorBitArray : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.BitArray.LazinatorBitArray ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.BitArray.LazinatorBitArray starting at {writer.ActiveMemoryPosition}.");
