//f58aedd4-95ba-a6fb-1e80-f48246b09fb6
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorStack<T> : ILazinator
    {
        ...
        private int _LazinatorStack_T_EndByteIndex;
        protected virtual  int _UnderlyingList_ByteLength => _LazinatorStack_T_EndByteIndex - _UnderlyingList_ByteIndex;
        protected virtual int _OverallEndByteIndex => _LazinatorStack_T_EndByteIndex;
        ...
        public LazinatorStack(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        protected virtual int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Collections.LazinatorStack<T> at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        protected virtual int ConvertFromBytesForChildLengths(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _LazinatorStack_T_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.LazinatorStack<T> at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.LazinatorStack<T>.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of LazinatorStack<T>) ");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.UpdateStoredBuffer)
            {
                _LazinatorStack_T_EndByteIndex = writer.ActiveMemoryPosition - startOfObjectPosition;
            }
