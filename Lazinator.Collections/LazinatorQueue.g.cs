...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorQueue<T> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Collections.LazinatorQueue<T> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Collections.LazinatorQueue<T> starting at {writer.ActiveMemoryPosition}.");
