...
namespace LazinatorCollections.Dictionary
{
    ...
    public partial class LazinatorDictionary<TKey, TValue> : ILazinator
    {
        ...
        protected virtual void UpdateDeserializedChildren(BinaryBufferWriter writer, int startPosition)
        {
            ...
            {
                Buckets.UpdateStoredBuffer(writer, startPosition + _Buckets_ByteIndex + sizeof(int), _Buckets_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
            }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                WriteChild(writer, ref _Buckets, includeChildrenMode, _Buckets_Accessed, () => GetChildSlice(LazinatorMemoryStorage, _Buckets_ByteIndex, _Buckets_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
