...
namespace LazinatorCollections.ByteSpan
{
    ...
    public partial class LazinatorByteSpan : ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.ByteSpan.LazinatorByteSpan starting at {writer.Position}.");
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, ref Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _LazinatorByteSpan_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
