...
namespace LazinatorCollections
{
    ...
    public partial class LazinatorSortedLinkedList<T> : LazinatorLinkedList<T>, ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.LazinatorSortedLinkedList<T> starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of LazinatorSortedLinkedList<T>) ");
        }
