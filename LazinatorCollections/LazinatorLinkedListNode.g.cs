...
namespace LazinatorCollections
{
    ...
    public partial class LazinatorLinkedListNode<T> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorCollections.LazinatorLinkedListNode<T> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.LazinatorLinkedListNode<T> starting at {writer.ActiveMemoryPosition}.");
