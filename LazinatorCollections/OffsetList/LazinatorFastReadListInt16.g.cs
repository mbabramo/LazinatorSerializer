...
namespace LazinatorCollections.OffsetList
{
    ...
    public partial class LazinatorFastReadListInt16 : LazinatorFastReadList<Int16>, ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorCollections.OffsetList.LazinatorFastReadListInt16 ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.OffsetList.LazinatorFastReadListInt16 starting at {writer.ActiveMemoryPosition}.");
