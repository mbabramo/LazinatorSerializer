...
namespace LazinatorCollections.OffsetList
{
    ...
    public partial class LazinatorFastReadListInt32 : LazinatorFastReadList<Int32>, ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorCollections.OffsetList.LazinatorFastReadListInt32 ");
        ...
        {
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.OffsetList.LazinatorFastReadListInt32 starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of LazinatorFastReadListInt32) ");
        }
