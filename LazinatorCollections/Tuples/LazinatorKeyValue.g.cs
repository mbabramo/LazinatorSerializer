/*Location9937*//*Location9923*///061f7542-e51b-d8db-4ed2-55f1ac0e676f
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location9924*/
    using Lazinator.Attributes;/*Location9925*/
    using Lazinator.Buffers;/*Location9926*/
    using Lazinator.Core;/*Location9927*/
    using Lazinator.Exceptions;/*Location9928*/
    using Lazinator.Support;/*Location9929*/
    using System;/*Location9930*/
    using System.Buffers;/*Location9931*/
    using System.Collections.Generic;/*Location9932*/
    using System.Diagnostics;/*Location9933*/
    using System.IO;/*Location9934*/
    using System.Linq;/*Location9935*/
    using System.Runtime.InteropServices;/*Location9936*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct LazinatorKeyValue<TKey, TValue> : ILazinator
    {
        /*Location9938*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public bool IsStruct => true;
        
        /*Location9939*//* Property definitions */
        
        /*Location9940*/        int _Key_ByteIndex;
        /*Location9941*/        int _Value_ByteIndex;
        /*Location9942*/int _Key_ByteLength => _Value_ByteIndex - _Key_ByteIndex;
        /*Location9943*/private int _LazinatorKeyValue_TKey_TValue_EndByteIndex;
        /*Location9944*/int _Value_ByteLength => _LazinatorKeyValue_TKey_TValue_EndByteIndex - _Value_ByteIndex;
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location9947*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Key == null)
                {
            ...
            /*Location9948*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Value == null)
                {
        ...
        /*Location9951*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location9952*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Key_Accessed) && Key == null)
            {
            ...
            /*Location9953*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Value_Accessed) && Value == null)
            {
            ...
            /*Location9954*/yield break;
        }
        /*Location9955*/
        
        public IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location9956*/yield break;
        }
        /*Location9957*/
        public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location9958*/if ((!exploreOnlyDeserializedChildren && Key != null) || (_Key_Accessed && _Key != null))
            {
                _Key = (TKey) _Key.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location9959*/if ((!exploreOnlyDeserializedChildren && Value != null) || (_Value_Accessed && _Value != null))
            {
                _Value = (TValue) _Value.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location9960*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location9963*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location9964*/_Key_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location9965*/_Value_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location9966*/_LazinatorKeyValue_TKey_TValue_EndByteIndex = bytesSoFar;
            /*Location9967*/        }
            
            /*Location9968*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location9969*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location9970*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location9971*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location9975*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location9976*/
                            ...
                            {
                                /*Location9983*/if (_Key_Accessed && _Key != null)
                                {
                                ...
                                /*Location9984*/if (_Value_Accessed && _Value != null)
                                {
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location9987*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location9988*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location9989*/// write properties
                                    /*Location9990*/startOfObjectPosition = writer.Position;
                                    /*Location9991*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location9992*/if (updateStoredBuffer)
                                    {
                                        _Key_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location9993*/startOfObjectPosition = writer.Position;
                                    /*Location9994*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location9995*/if (updateStoredBuffer)
                                    {
                                        _Value_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location9996*/if (updateStoredBuffer)
                                    {
                                        /*Location9997*/_LazinatorKeyValue_TKey_TValue_EndByteIndex = writer.Position - startPosition;
                                        /*Location9998*/}
                                        /*Location9999*/}
                                        /*Location10000*/
                                    }
