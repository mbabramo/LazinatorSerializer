/*Location9181*//*Location9167*///1c9e518c-74dc-f8f1-8f97-d12aedc5a69e
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location9168*/
    using Lazinator.Attributes;/*Location9169*/
    using Lazinator.Buffers;/*Location9170*/
    using Lazinator.Core;/*Location9171*/
    using Lazinator.Exceptions;/*Location9172*/
    using Lazinator.Support;/*Location9173*/
    using System;/*Location9174*/
    using System.Buffers;/*Location9175*/
    using System.Collections.Generic;/*Location9176*/
    using System.Diagnostics;/*Location9177*/
    using System.IO;/*Location9178*/
    using System.Linq;/*Location9179*/
    using System.Runtime.InteropServices;/*Location9180*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial class LazinatorTriple<T, U, V> : ILazinator
    {
        /*Location9182*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public bool IsStruct => false;
        
        /*Location9183*//* Property definitions */
        
        /*Location9184*/        protected int _Item1_ByteIndex;
        /*Location9185*/        protected int _Item2_ByteIndex;
        /*Location9186*/        protected int _Item3_ByteIndex;
        /*Location9187*/protected virtual int _Item1_ByteLength => _Item2_ByteIndex - _Item1_ByteIndex;
        /*Location9188*/protected virtual int _Item2_ByteLength => _Item3_ByteIndex - _Item2_ByteIndex;
        /*Location9189*/private int _LazinatorTriple_T_U_V_EndByteIndex = 0;
        /*Location9190*/protected virtual int _Item3_ByteLength => _LazinatorTriple_T_U_V_EndByteIndex - _Item3_ByteIndex;
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location9194*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Item1 == null)
                {
            ...
            /*Location9195*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Item2 == null)
                {
            ...
            /*Location9196*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Item3 == null)
                {
        ...
        /*Location9199*/public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location9200*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Item1_Accessed) && Item1 == null)
            {
            ...
            /*Location9201*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Item2_Accessed) && Item2 == null)
            {
            ...
            /*Location9202*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Item3_Accessed) && Item3 == null)
            {
            ...
            /*Location9203*/yield break;
        }
        /*Location9204*/
        
        public virtual IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location9205*/yield break;
        }
        /*Location9206*/
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location9207*/if ((!exploreOnlyDeserializedChildren && Item1 != null) || (_Item1_Accessed && _Item1 != null))
            {
                _Item1 = (T) _Item1.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location9208*/if ((!exploreOnlyDeserializedChildren && Item2 != null) || (_Item2_Accessed && _Item2 != null))
            {
                _Item2 = (U) _Item2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location9209*/if ((!exploreOnlyDeserializedChildren && Item3 != null) || (_Item3_Accessed && _Item3 != null))
            {
                _Item3 = (V) _Item3.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location9210*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location9213*/public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location9214*/_Item1_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location9215*/_Item2_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location9216*/_Item3_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location9217*/_LazinatorTriple_T_U_V_EndByteIndex = bytesSoFar;
            /*Location9218*/        }
            
            /*Location9219*/public virtual void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location9220*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location9221*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location9222*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location9226*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location9227*/
                            ...
                            {
                                /*Location9234*/if (_Item1_Accessed && _Item1 != null)
                                {
                                ...
                                /*Location9235*/if (_Item2_Accessed && _Item2 != null)
                                {
                                ...
                                /*Location9236*/if (_Item3_Accessed && _Item3 != null)
                                {
                                ...
                                protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location9239*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location9240*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location9241*/// write properties
                                    /*Location9242*/startOfObjectPosition = writer.Position;
                                    /*Location9243*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location9244*/if (updateStoredBuffer)
                                    {
                                        _Item1_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location9245*/startOfObjectPosition = writer.Position;
                                    /*Location9246*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location9247*/if (updateStoredBuffer)
                                    {
                                        _Item2_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location9248*/startOfObjectPosition = writer.Position;
                                    /*Location9249*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location9250*/if (updateStoredBuffer)
                                    {
                                        _Item3_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location9251*/if (updateStoredBuffer)
                                    {
                                        /*Location9252*/_LazinatorTriple_T_U_V_EndByteIndex = writer.Position - startPosition;
                                        /*Location9253*/}
                                        /*Location9254*/}
                                        /*Location9255*/
                                    }
