/*Location8865*//*Location8851*///e9cd3769-0d6c-b822-3ca1-3b848ff49e4e
//------------------------------------------------------------------------------
// <auto-generated>
...
{/*Location8852*/
    using Lazinator.Attributes;/*Location8853*/
    using Lazinator.Buffers;/*Location8854*/
    using Lazinator.Core;/*Location8855*/
    using Lazinator.Exceptions;/*Location8856*/
    using Lazinator.Support;/*Location8857*/
    using System;/*Location8858*/
    using System.Buffers;/*Location8859*/
    using System.Collections.Generic;/*Location8860*/
    using System.Diagnostics;/*Location8861*/
    using System.IO;/*Location8862*/
    using System.Linq;/*Location8863*/
    using System.Runtime.InteropServices;/*Location8864*/
    using static Lazinator.Core.LazinatorUtilities;
    
    [Autogenerated]
    public partial struct LazinatorComparableKeyValue<TKey, TValue> : ILazinator
    {
        /*Location8866*/[DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public bool IsStruct => true;
        
        /*Location8867*//* Property definitions */
        
        /*Location8868*/        int _Key_ByteIndex;
        /*Location8869*/        int _Value_ByteIndex;
        /*Location8870*/int _Key_ByteLength => _Value_ByteIndex - _Key_ByteIndex;
        /*Location8871*/private int _LazinatorComparableKeyValue_TKey_TValue_EndByteIndex;
        /*Location8872*/int _Value_ByteLength => _LazinatorComparableKeyValue_TKey_TValue_EndByteIndex - _Value_ByteIndex;
        ...
        public ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            /*Location8875*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Key == null)
                {
            ...
            /*Location8876*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                if (Value == null)
                {
        ...
        /*Location8879*/public IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            /*Location8880*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Key_Accessed) && Key == null)
            {
            ...
            /*Location8881*/if (enumerateNulls && (!exploreOnlyDeserializedChildren || _Value_Accessed) && Value == null)
            {
            ...
            /*Location8882*/yield break;
        }
        /*Location8883*/
        
        public IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            /*Location8884*/yield break;
        }
        /*Location8885*/
        public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            /*Location8886*/if ((!exploreOnlyDeserializedChildren && Key != null) || (_Key_Accessed && _Key != null))
            {
                _Key = (TKey) _Key.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location8887*/if ((!exploreOnlyDeserializedChildren && Value != null) || (_Value_Accessed && _Value != null))
            {
                _Value = (TValue) _Value.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            /*Location8888*/if (changeThisLevel && changeFunc != null)
            {
        ...
        /*Location8891*/public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            /*Location8892*/_Key_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location8893*/_Value_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            
            /*Location8894*/_LazinatorComparableKeyValue_TKey_TValue_EndByteIndex = bytesSoFar;
            /*Location8895*/        }
            
            /*Location8896*/public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
            {
                /*Location8897*/if (includeChildrenMode != IncludeChildrenMode.IncludeAllChildren)
                {
                    updateStoredBuffer = false;
                }
                /*Location8898*/int startPosition = writer.Position;
                WritePropertiesIntoBuffer(ref writer, includeChildrenMode, verifyCleanness, updateStoredBuffer, true);
                /*Location8899*/if (updateStoredBuffer)
                {
                    ...
                    {
                        /*Location8903*/_IsDirty = false;
                        if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                        {
                            _DescendantIsDirty = false;/*Location8904*/
                            ...
                            {
                                /*Location8911*/if (_Key_Accessed && _Key != null)
                                {
                                ...
                                /*Location8912*/if (_Value_Accessed && _Value != null)
                                {
                                ...
                                void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
                                {
                                    ...
                                    // header information
                                    /*Location8915*/if (includeUniqueID)
                                    {
                                    ...
                                    /*Location8916*/CompressedIntegralTypes.WriteCompressedInt(ref writer, Lazinator.Support.LazinatorVersionInfo.LazinatorIntVersion);
                                    CompressedIntegralTypes.WriteCompressedInt(ref writer, LazinatorObjectVersion);
                                    writer.Write((byte)includeChildrenMode);
                                    /*Location8917*/// write properties
                                    /*Location8918*/startOfObjectPosition = writer.Position;
                                    /*Location8919*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location8920*/if (updateStoredBuffer)
                                    {
                                        _Key_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location8921*/startOfObjectPosition = writer.Position;
                                    /*Location8922*/if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
                                    {
                                    ...
                                    /*Location8923*/if (updateStoredBuffer)
                                    {
                                        _Value_ByteIndex = startOfObjectPosition - startPosition;
                                    }
                                    /*Location8924*/if (updateStoredBuffer)
                                    {
                                        /*Location8925*/_LazinatorComparableKeyValue_TKey_TValue_EndByteIndex = writer.Position - startPosition;
                                        /*Location8926*/}
                                        /*Location8927*/}
                                        /*Location8928*/
                                    }
