...
namespace LazinatorCollections.Tuples
{
    ...
    public partial struct LazinatorComparableKeyValue<TKey, TValue> : ILazinator
    {
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.Tuples.LazinatorComparableKeyValue<TKey, TValue> starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of LazinatorComparableKeyValue<TKey, TValue>) ");
        }
