...
namespace LazinatorCollections.Tuples
{
    ...
    public partial struct LazinatorComparableKeyValue<TKey, TValue> : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of LazinatorCollections.Tuples.LazinatorComparableKeyValue<TKey, TValue> ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.Tuples.LazinatorComparableKeyValue<TKey, TValue> starting at {writer.ActiveMemoryPosition}.");
