...
namespace LazinatorCollections
{
    ...
    public partial class LazinatorQueue<T> : ILazinator
    {
        ...
        protected virtual int Deserialize()
        {
            ...
            return _LazinatorQueue_T_EndByteIndex;
        }
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for LazinatorCollections.LazinatorQueue<T> starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of LazinatorQueue<T>) ");
        }
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _LazinatorQueue_T_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
