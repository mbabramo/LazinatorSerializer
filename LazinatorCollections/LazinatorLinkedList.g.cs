...
namespace LazinatorCollections
{
    ...
    public partial class LazinatorLinkedList<T> : ILazinator
    {
        ...
        protected virtual void UpdateDeserializedChildren(BinaryBufferWriter writer, int startPosition)
        {
            ...
            {
                FirstNode.UpdateStoredBuffer(writer, startPosition + _FirstNode_ByteIndex + sizeof(int), _FirstNode_ByteLength - sizeof(int), IncludeChildrenMode.IncludeAllChildren, true);
            }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            // write properties
            WriteUncompressedPrimitives.WriteBool(writer, _AllowDuplicates);
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren)
            {
                ...
                WriteChild(writer, ref _FirstNode, includeChildrenMode, _FirstNode_Accessed, () => GetChildSlice(LazinatorMemoryStorage, _FirstNode_ByteIndex, _FirstNode_ByteLength, false, false, null), verifyCleanness, updateStoredBuffer, false, false, this);
            }
