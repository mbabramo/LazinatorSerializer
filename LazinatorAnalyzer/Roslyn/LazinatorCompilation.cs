...
namespace LazinatorCodeGen.Roslyn
{
    public class LazinatorCompilation
    {
        ...
        static readonly string[] _methodNamesToLookFor = new string[] { "LazinatorObjectVersionUpgrade", "PreSerialization", "PostDeserialization", "OnDirty" };
        ...
        private static IEnumerable<TypeDeclarationSyntax> GetTypeDeclarationsForNamedType(INamedTypeSymbol namedType)
        {
