...
namespace Lazinator.CodeDescription
{
    public class ObjectDescription
    {
        ...
        Debug; // DEBUG: ref struct: Eliminate interfad3 declaRATIONS, add ToRefStruct, FromRefStruct. Most importantly, base properties without separate method on classes. ALSO, static conversion methods use superclass name.
        ...
        private void AppendDeclaration(CodeStringBuilder sb, string partialsuperclasses)
        {
            ...
            string theBeginning =
                    ...
                    {AccessibilityConverter.Convert(Accessibility)} { SealedKeyword }{IIF(GeneratingRefStruct, "ref ")}partial { (ObjectType == LazinatorObjectType.Class && !GeneratingRefStruct ? "class" : "struct") } { NameIncludingGenerics } : {IIF(IsDerivedFromNonAbstractLazinator, () => BaseObjectName + ", ")}ILazinator
                    {{";
