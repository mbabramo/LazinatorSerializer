    ...
    public class ObjectDescription
    {
        ...
        private void AppendDeclaration(CodeStringBuilder sb, string partialsuperclasses)
        {
            ...
            string theBeginning =
                    ...
                    {IIF(GeneratingRefStruct, $@"public ref partial struct { NameIncludingGenerics_RefStruct }")}{IIF(!GeneratingRefStruct, $@"{AccessibilityConverter.Convert(Accessibility)} { SealedKeyword }partial { (ObjectType == LazinatorObjectType.Class ? "class" : "struct") } { NameIncludingGenerics } : {IIF(IsDerivedFromNonAbstractLazinator, () => BaseObjectName + ", ")}{ILazinatorString}")}
                    {{";
