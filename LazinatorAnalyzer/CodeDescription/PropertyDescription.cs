...
namespace Lazinator.CodeDescription
{
    public class PropertyDescription
    {
        ...
        private void SetNonserializedTypeNameAndPropertyType(INamedTypeSymbol t)
        {
            ...
            string fullyQualifiedTypeName = t.GetFullNamespacePlusSimpleName();
        ...
        private bool HandleRecordLikeType(INamedTypeSymbol t)
        {
            ...
            if (!recordLikeTypes.ContainsKey(t) || (ContainingObjectDescription.Compilation.Config?.IgnoreRecordLikeTypes.Any(x => x.ToUpper() == (UseFullyQualifiedNames ? t.GetFullNamespacePlusSimpleName().ToUpper() : t.GetMinimallyQualifiedName())) ?? false))
            {
                return false;
            }
