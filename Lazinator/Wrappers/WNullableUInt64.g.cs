//fa0b52a9-8dd6-4ad3-d595-e8a35f7a2da1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    [Autogenerated]
    public partial struct WNullableUInt64 : ILazinator
    {
        ...
        public WNullableUInt64(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : this()
        {
        ...
        {
            WNullableUInt64 clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new WNullableUInt64(includeChildrenMode);
                clone = (WNullableUInt64)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new WNullableUInt64(bytes);
            }
            return clone;
        }
        ...
        ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            WNullableUInt64 typedClone = (WNullableUInt64) clone;
        ...
        {
            get => -1;
            set => ThrowHelper.ThrowVersioningDisabledException("WNullableUInt64");
        }
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WNullableUInt64 from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WrappedValue = span.ToDecompressedNullableUInt64(ref bytesSoFar);
        }
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WNullableUInt64 at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WNullableUInt64.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of WNullableUInt64) ");
