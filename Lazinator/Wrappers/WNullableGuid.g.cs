//6b5f6823-20de-c3dd-e539-149db21208ea
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WNullableGuid : ILazinator
    {
        ...
        public WNullableGuid(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : this()
        {
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WNullableGuid from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WrappedValue = span.ToNullableGuid(ref bytesSoFar);
        }
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WNullableGuid at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WNullableGuid.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of WNullableGuid) ");
        ...
        void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.Tabs++;
            WriteUncompressedPrimitives.WriteNullableGuid(ref writer, _WrappedValue);
            TabbedText.Tabs--;
        }
    }
}
