//1b5f0acb-85ed-8ec3-cf07-5898afca2ded
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.25, on 5/15/2018 11:17:51 AM
//
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperLongArray : ILazinator
    {
        ...
        public ILazinator CloneLazinator(IncludeChildrenMode includeChildrenMode)
        {
            ...
            var clone = new LazinatorWrapperLongArray()
            {
        ...
        private int _LazinatorWrapperLongArray_EndByteIndex;
        internal int _Value_ByteLength => _LazinatorWrapperLongArray_EndByteIndex - _Value_ByteIndex;
            ...
            get
            {
                if (!_Value_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Value = ConvertFromBytes_Array_long(childData, DeserializationFactory, null);
                    }
        ...
        {
            get => -1;
            set => throw new Exception("Lazinator versioning disabled for LazinatorWrapperLongArray.");
        }
        ...
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _LazinatorWrapperLongArray_EndByteIndex = bytesSoFar;
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_Array_long(w, copy_Value, includeChildrenMode, v));
        }
        
        /* Conversion of supported collections and tuples */
        
        private static long[] ConvertFromBytes_Array_long(ReadOnlyMemory<byte> storage, DeserializationFactory deserializationFactory, InformParentOfDirtinessDelegate informParentOfDirtinessDelegate)
        {
            if (storage.Length == 0)
            {
                return default(long[]);
        ...
        private static void ConvertToBytes_Array_long(BinaryBufferWriter writer, long[] itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
