//8785a85f-ac64-d771-126e-add817792394
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperLongArray : ILazinator
    {
        ...
        int _WrappedValue_ByteLength => _LazinatorWrapperLongArray_EndByteIndex - _WrappedValue_ByteIndex;
        ...
        {
            get => -1;
            set => throw new LazinatorSerializationException("Lazinator versioning disabled for LazinatorWrapperLongArray.");
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_long_B_b(w, copy_WrappedValue, includeChildrenMode, v));
        ...
        private static long[] ConvertFromBytes_long_B_b(ReadOnlyMemory<byte> storage, DeserializationFactory deserializationFactory, InformParentOfDirtinessDelegate informParentOfDirtinessDelegate)
        {
            if (storage.Length == 0)
            {
                return default(long[]);
        ...
        private static void ConvertToBytes_long_B_b(BinaryBufferWriter writer, long[] itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
