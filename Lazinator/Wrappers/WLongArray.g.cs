//aa113f60-8aa3-b7e4-0609-6255d96d7cf3
//------------------------------------------------------------------------------
// <auto-generated>
    ...
    public partial struct WLongArray : ILazinator
    {
        ...
        void AssignCloneProperties(ref WLongArray clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren)
            {
                ...
                {
                    _WrappedValue = (long[]) Clone_long_B_b(_WrappedValue, l => l.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren));
                }
            ...
            public void UpdateStoredBuffer(ref BinaryBufferWriter writer, int startPosition, int length, IncludeChildrenMode includeChildrenMode, bool updateDeserializedChildren)
            {
                ...
                if (includeChildrenMode == IncludeChildrenMode.IncludeAllChildren)
                {
                    ...
                    if (updateDeserializedChildren)
                    {
                        ...
                        {
                            _WrappedValue = (long[]) Clone_long_B_b(_WrappedValue, l => l.RemoveBufferOnHierarchy());
                        }
                    }
