//a892a47c-b928-52e5-3b27-cb6d96ce1f35
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    [Autogenerated]
    public partial struct WNullableUInt16 : ILazinator
    {
        ...
        public WNullableUInt16(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : this()
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public WNullableUInt16(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : this()
        {
        ...
        {
            WNullableUInt16 clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new WNullableUInt16(includeChildrenMode);
                clone = (WNullableUInt16)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new WNullableUInt16(bytes);
            }
            return clone;
        }
        ...
        ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            WNullableUInt16 typedClone = (WNullableUInt16) clone;
        ...
        {
            get => -1;
            set => ThrowHelper.ThrowVersioningDisabledException("WNullableUInt16");
        }
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WNullableUInt16 from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WrappedValue = span.ToDecompressedNullableUInt16(ref bytesSoFar);
        }
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WNullableUInt16 at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WNullableUInt16.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of WNullableUInt16) ");
        ...
        void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.Tabs++;
            CompressedIntegralTypes.WriteCompressedNullableUShort(ref writer, _WrappedValue);
            TabbedText.Tabs--;
        }
    }
}
