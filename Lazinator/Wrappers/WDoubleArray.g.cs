...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WDoubleArray : ILazinator
    {
        ...
        private void LazinateWrappedValue()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _WrappedValue_ByteIndex, _WrappedValue_ByteLength, SizeOfLength.SkipLength, null);_WrappedValue = ConvertFromBytes_double_B_b(childData);
            }
            _WrappedValue_Accessed = true;
        }
        ...
        private static void ConvertToBytes_double_B_b(ref BinaryBufferWriter writer, Double[] itemToConvert, LazinatorSerializationOptions options)
        {
