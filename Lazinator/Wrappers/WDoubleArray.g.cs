//26b48195-80fe-bb92-596c-d47eb94362cc
//------------------------------------------------------------------------------
// <auto-generated>
    ...
    public partial struct WDoubleArray : ILazinator
    {
        ...
        private void LazinateWrappedValue()
        {
            ...
            else
            {
                ...
                TabbedText.WriteLine($"ILazinator location: {childData.ToLocationString()}");_WrappedValue = ConvertFromBytes_double_B_b(childData);
            }
            _WrappedValue_Accessed = true;
        }
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WDoubleArray at position: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WDoubleArray at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WDoubleArray.");
            ...
            TabbedText.WriteLine($"Position {writer.ToLocationString()} (end of WDoubleArray) ");
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            ConvertToBytes_double_B_b(ref w, copy_WrappedValue, options));
            if (options.UpdateStoredBuffer)
            {
        ...
        private static void ConvertToBytes_double_B_b(ref BufferWriter writer, Double[] itemToConvert, LazinatorSerializationOptions options)
        {
