//237f8fa5-0f30-7a27-e222-a9751b1f9fdd
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WDoubleArray : ILazinator
    {
        ...
        public void AssignCloneProperties(ref WDoubleArray clone, IncludeChildrenMode includeChildrenMode)
        {
            clone.FreeInMemoryObjects();
            clone.WrappedValue = CloneOrChange_double_B_b(WrappedValue, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
            ...
            public ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren)
            {
                ...
                {
                    _WrappedValue = (double[]) CloneOrChange_double_B_b(_WrappedValue, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren), true);
                }
