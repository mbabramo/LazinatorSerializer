...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WDateTime : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WDateTime starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of WDateTime) ");
        }
