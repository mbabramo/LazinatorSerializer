...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WBool : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WBool starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of WBool) ");
        }
