...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WInt64Array : ILazinator
    {
        ...
        private void LazinateWrappedValue()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _WrappedValue_ByteIndex, _WrappedValue_ByteLength, SizeOfLength.SkipLength, null);_WrappedValue = ConvertFromBytes_long_B_b(childData);
            }
            _WrappedValue_Accessed = true;
        }
