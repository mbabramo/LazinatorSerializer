...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WInt64Array : ILazinator
    {
        ...
        public WInt64Array(LazinatorMemory serializedBytes, ILazinator parent = null) : this()
        {
        ...
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WInt64Array_EndByteIndex = bytesSoFar;
        }
        ...
        void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _WInt64Array_EndByteIndex = writer.Position - startPosition;
            }
        }
