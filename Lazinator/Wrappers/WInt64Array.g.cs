//7b89838a-7d40-adde-04c6-8c1be2a7e7e7
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WInt64Array : ILazinator
    {
        ...
        private int _WInt64Array_EndByteIndex;
        int _WrappedValue_ByteLength => _WInt64Array_EndByteIndex - _WrappedValue_ByteIndex;
        ...
        int Deserialize()
        {
            ...
            return _WInt64Array_EndByteIndex;
        }
        ...
        int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _WInt64Array_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WInt64Array starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of WInt64Array) ");
        }
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _WInt64Array_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
        ...
        private static void ConvertToBytes_long_B_b(ref BinaryBufferWriter writer, Int64[] itemToConvert, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
