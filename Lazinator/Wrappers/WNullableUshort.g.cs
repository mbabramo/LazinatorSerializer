//373c4a60-3bc6-6ee4-5042-7943eca1d958
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WNullableUshort : ILazinator
    {
        ...
        void AssignCloneProperties(ref WNullableUshort clone, IncludeChildrenMode includeChildrenMode)
        {
        ...
        public int LazinatorUniqueID => 73;
        ...
        {
            get => -1;
            set => throw new LazinatorSerializationException("Lazinator versioning disabled for WNullableUshort.");
        }
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _WrappedValue = span.ToDecompressedNullableUshort(ref bytesSoFar);
        }
        
        public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WNullableUshort ");
        ...
        {
            // header information
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WNullableUshort starting at {writer.Position}.");
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Byte {writer.Position} (end of WNullableUshort) ");
        }
