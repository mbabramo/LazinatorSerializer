//f35e859f-a194-f8d4-871f-2024a22f89b2
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperBool : ILazinator
    {
        ...
        {
            get => -1;
            set => throw new Exception("Lazinator versioning disabled for LazinatorWrapperBool.");
        }
        
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _Value = span.ToBoolean(ref bytesSoFar);
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            // write properties
            WriteUncompressedPrimitives.WriteBool(writer, _Value);
        }
