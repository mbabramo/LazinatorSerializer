...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WUInt16 : ILazinator
    {
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            {
                TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WUInt16 starting at {writer.Position}.");
                ...
                TabbedText.WriteLine($"Byte {writer.Position} (end of WUInt16) ");
            }
