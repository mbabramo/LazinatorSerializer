//870a9ac2-02a8-1868-e189-bee978aa7e6e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperNullableUint : ILazinator
    {
        ...
        {
            get => -1;
            set => throw new Exception("Lazinator versioning disabled for LazinatorWrapperNullableUint.");
        }
        
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _Value = span.ToDecompressedNullableUint(ref bytesSoFar);
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            // write properties
            CompressedIntegralTypes.WriteCompressedNullableUint(writer, _Value);
        }
