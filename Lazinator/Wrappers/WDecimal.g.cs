//2757203d-3912-0c23-462d-d58ab6675942
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WDecimal : ILazinator
    {
        ...
        public WDecimal(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : this()
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public WDecimal(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : this()
        {
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WDecimal from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WrappedValue = span.ToDecompressedDecimal(ref bytesSoFar);
        }
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WDecimal at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WDecimal.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of WDecimal) ");
        ...
        void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            TabbedText.Tabs++;
            CompressedDecimal.WriteCompressedDecimal(ref writer, _WrappedValue);
            TabbedText.Tabs--;
        }
    }
}
