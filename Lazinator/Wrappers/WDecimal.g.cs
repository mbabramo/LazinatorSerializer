...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WDecimal : ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WDecimal starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of WDecimal) ");
        }
