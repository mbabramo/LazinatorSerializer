//8c5d9125-a551-e2eb-9018-5d11c4d98ae6
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperIntArray : ILazinator
    {
        ...
        int _WrappedValue_ByteLength => _LazinatorWrapperIntArray_EndByteIndex - _WrappedValue_ByteIndex;
            ...
            get
            {
                if (!_WrappedValue_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _WrappedValue = ConvertFromBytes_int_B_b(childData, DeserializationFactory, null);
                    }
        ...
        {
            get => -1;
            set => throw new LazinatorSerializationException("Lazinator versioning disabled for LazinatorWrapperIntArray.");
        }
        ...
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _LazinatorWrapperIntArray_EndByteIndex = bytesSoFar;
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_int_B_b(w, copy_WrappedValue, includeChildrenMode, v));
