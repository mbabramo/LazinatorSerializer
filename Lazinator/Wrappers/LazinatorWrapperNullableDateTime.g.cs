//82b9e905-820a-cc72-4112-b8690c8d6388
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperNullableDateTime : ILazinator
    {
        ...
        public ILazinator CloneLazinator(IncludeChildrenMode includeChildrenMode)
        {
            ...
            var clone = new LazinatorWrapperNullableDateTime()
            {
        ...
        {
            get => -1;
            set => throw new Exception("Lazinator versioning disabled for LazinatorWrapperNullableDateTime.");
        }
        
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _Value = span.ToDecompressedNullableDateTime(ref bytesSoFar);
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            // write properties
            CompressedIntegralTypes.WriteCompressedNullableDateTime(writer, _Value);
        }
