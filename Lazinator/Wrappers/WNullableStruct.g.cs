//70a37279-2c44-18b8-4fbb-9a94e5c89375
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WNullableStruct<T> : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_NonNullValue_Accessed && !System.Collections.Generic.EqualityComparer<T>.Default.Equals(_NonNullValue, default(T))))
            {
                foreach (ILazinator toYield in NonNullValue.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
