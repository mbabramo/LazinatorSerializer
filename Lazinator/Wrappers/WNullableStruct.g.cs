//d884ad63-b52e-f962-b043-300809d6e13c
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public T NonNullValue
        {
            ...
            set
            {
                if (!System.Collections.Generic.EqualityComparer<T>.Default.Equals(value, default(T)))
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property NonNullValue cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
