//cbe0d582-af3b-ae08-e05f-3f19ca687921
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperDoubleArray : ILazinator
    {
            ...
            get
            {
                if (!_Value_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Value = ConvertFromBytes_double_B_b(childData, DeserializationFactory, null);
                    }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_double_B_b(w, copy_Value, includeChildrenMode, v));
        }
