//0f5282cd-b9de-17e9-0f5d-04a6c360dc1b
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WNullableChar : ILazinator
    {
        ...
        int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Wrappers.WNullableChar from bytes at: " + LazinatorMemoryStorage.ToLocationString());
            ReadOnlySpan<byte> span = LazinatorMemoryStorage.InitialReadOnlyMemory.Span;
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WNullableChar at position {writer.ToLocationString()}");
        ...
        {
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WNullableChar.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of WNullableChar) ");
