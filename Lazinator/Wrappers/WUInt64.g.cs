...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WUInt64 : ILazinator
    {
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            {
                TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WUInt64 starting at {writer.Position}.");
                ...
                TabbedText.WriteLine($"Byte {writer.Position} (end of WUInt64) ");
            }
