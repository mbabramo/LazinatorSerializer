//a1f6c23d-2864-78b9-fccd-0f09b39927fa
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct LazinatorWrapperNullableBool : ILazinator
    {
        ...
        {
            get => -1;
            set => throw new Exception("Lazinator versioning disabled for LazinatorWrapperNullableBool.");
        }
        
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _Value = span.ToDecompressedNullableBool(ref bytesSoFar);
        }
        ...
        public void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            // write properties
            CompressedIntegralTypes.WriteCompressedNullableBool(writer, _Value);
        }
