//af1ffc18-cc1e-6c35-deb7-5eb651056791
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WShort : ILazinator
    {
        ...
        void AssignCloneProperties(ref WShort clone, IncludeChildrenMode includeChildrenMode)
        {
        ...
        {
            get => -1;
            set => throw new LazinatorSerializationException("Lazinator versioning disabled for WShort.");
        }
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _WrappedValue = span.ToDecompressedShort(ref bytesSoFar);
        }
        
        public void SerializeExistingBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer)
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Wrappers.WShort ");
        ...
        {
            // header information
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WShort starting at {writer.Position}.");
            ...
            TabbedText.Tabs--;
            TabbedText.WriteLine($"Byte {writer.Position} (end of WShort) ");
        }
