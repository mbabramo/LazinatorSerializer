...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WInt32Array : ILazinator
    {
        ...
        private int _WInt32Array_EndByteIndex;
        int _WrappedValue_ByteLength => _WInt32Array_EndByteIndex - _WrappedValue_ByteIndex;
        ...
        int Deserialize()
        {
            ...
            return _WInt32Array_EndByteIndex;
        }
        ...
        int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _WInt32Array_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        {
            int startPosition = writer.Position;
            TabbedText.WriteLine($"Writing properties for Lazinator.Wrappers.WInt32Array starting at {writer.Position}.");
            ...
            TabbedText.WriteLine($"Byte {writer.Position} (end of WInt32Array) ");
        }
        ...
        void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID, int startOfObjectPosition, Span<byte> lengthsSpan)
        {
            ...
            if (updateStoredBuffer)
            {
                _WInt32Array_EndByteIndex = writer.Position - startOfObjectPosition;
            }
        }
