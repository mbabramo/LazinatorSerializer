...
namespace Lazinator.Wrappers
{
    ...
    public partial struct WInt32Array : ILazinator
    {
        ...
        public WInt32Array(LazinatorMemory serializedBytes, ILazinator parent = null) : this()
        {
        ...
        public void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _WInt32Array_EndByteIndex = bytesSoFar;
        }
        ...
        void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _WInt32Array_EndByteIndex = writer.Position - startPosition;
            }
        }
