...
namespace Lazinator.Buffers
{
    ...
    public readonly struct LazinatorMemory
    {
        ...
        public string ToLocationString()
        {
            ...
            var result = $"RInd: {MemoryRangeIndex} Off {FurtherOffsetIntoMemoryBlock} L {Length} (MBID: {range.MemoryBlock.MemoryBlockID} Off {range.SliceInfo.OffsetIntoMemoryBlock + FurtherOffsetIntoMemoryBlock} L {range.SliceInfo.Length})";
            return result;
        }
