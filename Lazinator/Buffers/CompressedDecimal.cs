...
namespace Lazinator.Buffers
{
    ...
    public static class CompressedDecimal
    {
        ...
        public static byte WriteCompressedDecimal(ref BufferWriter writer, decimal d) => WriteCompressedNullableDecimal(ref writer, d);

        public static byte WriteCompressedNullableDecimal(ref BufferWriter writer, decimal? d)
        {
            if (d == null)
            {
