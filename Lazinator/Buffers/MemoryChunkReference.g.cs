//cc98140f-84c4-9bfa-e3d0-aab9ce2c6d40
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial struct MemoryChunkReference : ILazinator
    {
        ...
        public int LengthAsLoaded
        {
            ...
            get
            {
                return _LengthForLoading;
            }
            [DebuggerStepThrough]
            set
            {
                IsDirty = true;
                _LengthForLoading = value;
            }
        }
        ...
        void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _LengthForLoading = span.ToDecompressedInt32(ref bytesSoFar);
        ...
        void WritePrimitivePropertiesIntoBuffer(ref BinaryBufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _LengthForLoading);
