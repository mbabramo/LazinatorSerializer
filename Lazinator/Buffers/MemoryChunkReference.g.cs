//5b38df12-e3c6-c032-bf02-e663d89398ce
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    [Autogenerated]
    public partial struct MemoryChunkReference : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        int _MemoryChunkID;
        public int MemoryChunkID
        {
            [DebuggerStepThrough]
            get
            {
                return _MemoryChunkID;
            }
            [DebuggerStepThrough]
            set
            {
                IsDirty = true;
                _MemoryChunkID = value;
            }
        }
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        int _OffsetForLoading;
        public int OffsetForLoading
        {
            [DebuggerStepThrough]
            get
            {
                return _OffsetForLoading;
            }
            [DebuggerStepThrough]
            set
            {
                IsDirty = true;
                _OffsetForLoading = value;
            }
        }
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        int _PreTruncationLength;
        public int PreTruncationLength
        {
            [DebuggerStepThrough]
            get
            {
        ...
        public MemoryChunkReference(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : this()
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public MemoryChunkReference(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : this()
        {
        ...
        {
            MemoryChunkReference clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new MemoryChunkReference(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (MemoryChunkReference)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new MemoryChunkReference(bytes);
            }
            return clone;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public int LazinatorUniqueID => 42;
        ...
        {
            _AdditionalOffset = span.ToDecompressedInt32(ref bytesSoFar);
            _FinalLength = span.ToDecompressedInt32(ref bytesSoFar);
            _MemoryChunkID = span.ToDecompressedInt32(ref bytesSoFar);
            _OffsetForLoading = span.ToDecompressedInt32(ref bytesSoFar);
        ...
        {
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _AdditionalOffset);
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _FinalLength);
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _MemoryChunkID);
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _OffsetForLoading);
