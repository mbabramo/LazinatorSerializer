//e60be739-382f-71c7-3ee6-1892556af272
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial struct MemoryChunkReference : ILazinator
    {
        ...
        {
            _IndexWithinMemoryChunk = span.ToInt32(ref bytesSoFar);
            _Length = span.ToInt32(ref bytesSoFar);
            _MemoryChunkID = span.ToInt32(ref bytesSoFar);
        }
        ...
        {
            WriteUncompressedPrimitives.WriteInt(ref writer, _IndexWithinMemoryChunk);
            WriteUncompressedPrimitives.WriteInt(ref writer, _Length);
            WriteUncompressedPrimitives.WriteInt(ref writer, _MemoryChunkID);
        }
    }
}
