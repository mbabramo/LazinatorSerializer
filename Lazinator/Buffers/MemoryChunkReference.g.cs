//c39379f3-de31-7387-e22a-d90c354df8e8
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial struct MemoryChunkReference : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        int _IndexWithinMemoryChunk;
        public int IndexWithinMemoryChunk
        {
            [DebuggerStepThrough]
            get
            {
                return _IndexWithinMemoryChunk;
            }
            [DebuggerStepThrough]
            set
            {
                IsDirty = true;
                _IndexWithinMemoryChunk = value;
            }
        }
        ...
        ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.IndexWithinMemoryChunk = IndexWithinMemoryChunk;
            typedClone.Length = Length;
        ...
        {
            yield return ("IndexWithinMemoryChunk", (object)IndexWithinMemoryChunk);
            yield return ("Length", (object)Length);
        ...
        {
            _IndexWithinMemoryChunk = span.ToDecompressedInt32(ref bytesSoFar);
            _Length = span.ToDecompressedInt32(ref bytesSoFar);
        ...
        {
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _IndexWithinMemoryChunk);
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _Length);
