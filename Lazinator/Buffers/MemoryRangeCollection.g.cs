...
namespace Lazinator.Buffers
{
    ...
    public partial class MemoryRangeCollection : MemoryBlockCollection, ILazinator
    {
        ...
        {
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Buffers.MemoryRangeCollection ");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Buffers.MemoryRangeCollection starting at {writer.ActiveMemoryPosition}.");
