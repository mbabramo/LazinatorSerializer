//4736feed-fad7-ed76-47fb-6b5cae25db6e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemoryChunkCollection : ILazinator
    {
        ...
        protected int _MemoryBlockLoadingInfo_ByteIndex;
        private int _MemoryChunkCollection_EndByteIndex;
        protected virtual  int _MemoryBlockLoadingInfo_ByteLength => _MemoryChunkCollection_EndByteIndex - _MemoryBlockLoadingInfo_ByteIndex;
        ...
        public List<MemoryBlockLoadingInfo> MemoryBlockLoadingInfo
        {
            ...
            get
            {
                if (!_MemoryBlockLoadingInfo_Accessed)
                {
                    LazinateMemoryBlockLoadingInfo();
                }
                IsDirty = true; 
                return _MemoryBlockLoadingInfo;
            }
            [DebuggerStepThrough]
            set
            {
                ...
                _MemoryBlockLoadingInfo = value;
                _MemoryBlockLoadingInfo_Accessed = true;
            }
        }
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _MemoryBlockLoadingInfo_Accessed;
        private void LazinateMemoryBlockLoadingInfo()
        {
            if (LazinatorMemoryStorage.Length == 0)
            {
                _MemoryBlockLoadingInfo = default(List<MemoryBlockLoadingInfo>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _MemoryBlockLoadingInfo_ByteIndex, _MemoryBlockLoadingInfo_ByteLength, null);_MemoryBlockLoadingInfo = ConvertFromBytes_List_GMemoryBlockLoadingInfo_g(childData);
            }
            _MemoryBlockLoadingInfo_Accessed = true;
        }
        ...
        {
            _MemoryBlockLoadingInfo = default;
            _MemoryBlockLoadingInfo_Accessed = false;
            IsDirty = false;
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _MemoryBlockLoadingInfo_ByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        {
            if (_MemoryBlockLoadingInfo_Accessed && _MemoryBlockLoadingInfo != null)
            {
                _MemoryBlockLoadingInfo = (List<MemoryBlockLoadingInfo>) CloneOrChange_List_GMemoryBlockLoadingInfo_g(_MemoryBlockLoadingInfo, l => l.RemoveBufferInHierarchy(), true);
            }
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            isAccessed: _MemoryBlockLoadingInfo_Accessed, writer: ref writer,
            getChildSliceForFieldFn: () => GetChildSlice(LazinatorMemoryStorage, _MemoryBlockLoadingInfo_ByteIndex, _MemoryBlockLoadingInfo_ByteLength, null),
            verifyCleanness: false,
            binaryWriterAction: (ref BufferWriter w, bool v) =>
            ConvertToBytes_List_GMemoryBlockLoadingInfo_g(ref w, _MemoryBlockLoadingInfo,
            options));
            if (options.UpdateStoredBuffer)
            {
                _MemoryBlockLoadingInfo_ByteIndex = startOfChildPosition - startOfObjectPosition;
