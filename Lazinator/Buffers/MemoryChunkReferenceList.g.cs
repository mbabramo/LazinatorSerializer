//3c338cce-8f72-ef6f-5a34-7fc7038e973d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    [Autogenerated]
    public partial class MemoryChunkReferenceList : ILazinator
    {
        ...
        private int _MemoryChunkReferenceList_EndByteIndex;
        protected virtual  int _MemoryChunkReferences_ByteLength => _MemoryChunkReferenceList_EndByteIndex - _MemoryChunkReferences_ByteIndex;
        protected virtual int _OverallEndByteIndex => _MemoryChunkReferenceList_EndByteIndex;
        ...
        public MemoryChunkReferenceList(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public MemoryChunkReferenceList(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        {
            MemoryChunkReferenceList clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new MemoryChunkReferenceList(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (MemoryChunkReferenceList)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new MemoryChunkReferenceList(bytes);
            }
            return clone;
        }
        ...
        protected virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            MemoryChunkReferenceList typedClone = (MemoryChunkReferenceList) clone;
        ...
        public virtual void FreeInMemoryObjects()
        {
            ...
            _MemoryChunkReferences_Accessed = false;
            IsDirty = false;
        ...
        protected virtual int ConvertFromBytesForChildProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, int indexOfFirstChild, ref int bytesSoFar)
        {
            ...
            _MemoryChunkReferenceList_EndByteIndex = indexOfFirstChild + totalChildrenBytes;
        ...
        protected virtual void WriteChildrenPropertiesIntoBuffer(ref BinaryBufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            if (options.UpdateStoredBuffer)
            {
                _MemoryChunkReferenceList_EndByteIndex = writer.ActiveMemoryPosition - startOfObjectPosition;
            }
