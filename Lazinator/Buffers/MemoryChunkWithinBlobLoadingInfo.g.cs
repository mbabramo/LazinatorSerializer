//1f0bb622-65dd-60eb-8a2f-b50238f44802
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    [Autogenerated]
    public partial class MemoryChunkWithinBlobLoadingInfo : MemoryChunkLoadingInfo, ILazinator
    {
        ...
        public long OffsetWhenLoading
        {
            ...
            get
            {
                return _OffsetWhenLoading;
            }
            [DebuggerStepThrough]
            set
            {
                IsDirty = true;
                _OffsetWhenLoading = value;
            }
        }
        /* Clone overrides */
        
        public MemoryChunkWithinBlobLoadingInfo(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : base(originalIncludeChildrenMode)
        {
        }
        
        public MemoryChunkWithinBlobLoadingInfo(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : base(serializedBytes, parent, originalIncludeChildrenMode, lazinatorObjectVersion)
        {
        }
        
        public override ILazinator CloneLazinator(IncludeChildrenMode includeChildrenMode = IncludeChildrenMode.IncludeAllChildren, CloneBufferOptions cloneBufferOptions = CloneBufferOptions.IndependentBuffers)
        {
            MemoryChunkWithinBlobLoadingInfo clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new MemoryChunkWithinBlobLoadingInfo(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (MemoryChunkWithinBlobLoadingInfo)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new MemoryChunkWithinBlobLoadingInfo(bytes);
            }
            return clone;
        }
        ...
        protected override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            MemoryChunkWithinBlobLoadingInfo typedClone = (MemoryChunkWithinBlobLoadingInfo) clone;
        ...
        protected override void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _OffsetWhenLoading = span.ToDecompressedInt64(ref bytesSoFar);
        }
        ...
        protected override void WritePrimitivePropertiesIntoBuffer(ref BufferWriter writer, in LazinatorSerializationOptions options, bool includeUniqueID)
        {
            ...
            CompressedIntegralTypes.WriteCompressedLong(ref writer, _OffsetWhenLoading);
        }
