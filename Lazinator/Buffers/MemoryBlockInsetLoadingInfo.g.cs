//7849196d-006f-66f0-60c0-681e78789372
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemoryBlockInsetLoadingInfo : MemoryBlockLoadingInfo, ILazinator
    {
        ...
        protected override int ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Converting Lazinator.Buffers.MemoryBlockInsetLoadingInfo from bytes at: " + LazinatorMemoryStorage.ToLocationString());
        ...
        protected override void ConvertFromBytesForPrimitiveProperties(ReadOnlySpan<byte> span, IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            TabbedText.WriteLine($"Reading LoadingOffset at byte location {bytesSoFar}"); 
        ...
        {
            TabbedText.WriteLine("");
            TabbedText.WriteLine($"Initiating serialization of Lazinator.Buffers.MemoryBlockInsetLoadingInfo at position {writer.ToLocationString()}");
        ...
        {
            int startPosition = writer.ActiveMemoryPosition;
            TabbedText.WriteLine($"Writing properties for Lazinator.Buffers.MemoryBlockInsetLoadingInfo.");
            ...
            TabbedText.WriteLine($"Byte {writer.ActiveMemoryPosition} (end of MemoryBlockInsetLoadingInfo) ");
