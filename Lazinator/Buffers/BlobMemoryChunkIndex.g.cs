...
namespace Lazinator.Buffers
{
    ...
    [Autogenerated]
    public partial class BlobMemoryChunkIndex : ILazinator
    {
        ...
        public BlobMemoryChunkIndex(IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren)
        {
            OriginalIncludeChildrenMode = originalIncludeChildrenMode;
        }
        
        public BlobMemoryChunkIndex(LazinatorMemory serializedBytes, ILazinator parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null)
        {
        ...
        {
            BlobMemoryChunkIndex clone;
            if (cloneBufferOptions == CloneBufferOptions.NoBuffer)
            {
                clone = new BlobMemoryChunkIndex(includeChildrenMode);
                clone.LazinatorObjectVersion = LazinatorObjectVersion;
                clone = (BlobMemoryChunkIndex)AssignCloneProperties(clone, includeChildrenMode);
            }
            else
            {
                LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
                clone = new BlobMemoryChunkIndex(bytes);
            }
            return clone;
        }
        ...
        protected virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            BlobMemoryChunkIndex typedClone = (BlobMemoryChunkIndex) clone;
