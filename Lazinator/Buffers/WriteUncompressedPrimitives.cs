...
namespace Lazinator.Buffers
{
    ...
    public static class WriteUncompressedPrimitives
    {
        ...
        public static byte WriteDecimal(BinaryBufferWriter writer, decimal value)
        {
            writer.Write(value);
            return (byte)sizeof(decimal);
        }
        public static byte WriteDateTime(BinaryBufferWriter writer, DateTime value)
        {
            writer.Write(value.Ticks);
            return (byte)sizeof(long);
        }
        public static byte WriteTimeSpan(BinaryBufferWriter writer, TimeSpan value)
        {
            writer.Write(value.Ticks);
            return (byte)sizeof(long);
        }
        ...
        public static byte WriteNullableDecimal(BinaryBufferWriter writer, decimal? value)
        {
            if (value == null)
            {
                writer.Write((byte)0);
        ...
        public static byte WriteNullableDateTime(BinaryBufferWriter writer, DateTime? value)
        {
            if (value == null)
            {
                writer.Write((byte)0);
        ...
        public static byte WriteNullableTimeSpan(BinaryBufferWriter writer, TimeSpan? value)
        {
            if (value == null)
            {
                writer.Write((byte)0);
