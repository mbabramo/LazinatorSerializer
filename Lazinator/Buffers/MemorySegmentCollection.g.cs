//21013895-5bf0-2a04-ce86-2cd29b3e4b6b
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemorySegmentCollection : MemoryChunkCollection, ILazinator
    {
        ...
        private void LazinateSegments()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Segments_ByteIndex, _Segments_ByteLength, null);_Segments = ConvertFromBytes_List_GMemoryBlockIDAndSlice_g(childData);
            }
            _Segments_Accessed = true;
        }
        ...
        protected override void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            ConvertToBytes_List_GMemoryBlockIDAndSlice_g(ref w, _Segments,
            options));
            if (options.UpdateStoredBuffer)
            {
        ...
        private static List<MemoryBlockIDAndSlice> ConvertFromBytes_List_GMemoryBlockIDAndSlice_g(LazinatorMemory storage)
        {
            ...
            for (int itemIndex = 0; itemIndex < collectionLength; itemIndex++)
            {
                ...
                var item = ConvertFromBytes_MemoryBlockIDAndSlice(childData);
                collection.Add(item);
        ...
        private static void ConvertToBytes_List_GMemoryBlockIDAndSlice_g(ref BufferWriter writer, List<MemoryBlockIDAndSlice> itemToConvert, LazinatorSerializationOptions options)
        {
            ...
            {
                void action(ref BufferWriter w) => ConvertToBytes_MemoryBlockIDAndSlice(ref w, itemToConvert[itemIndex], options);
