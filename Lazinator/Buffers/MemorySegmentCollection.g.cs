//f6d8c0e4-2e45-4781-e632-a33cca0727b1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemorySegmentCollection : MemoryChunkCollection, ILazinator
    {
        ...
        protected List<(Int32 memoryBlockID, Int32 offset, Int32 length)> _Segments;
        public List<(Int32 memoryBlockID, Int32 offset, Int32 length)> Segments
        {
            [DebuggerStepThrough]
            get
            {
        ...
        private void LazinateSegments()
        {
            ...
            {
                _Segments = default(List<(Int32 memoryBlockID, Int32 offset, Int32 length)>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Segments_ByteIndex, _Segments_ByteLength, null);_Segments = ConvertFromBytes_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(childData);
            }
            _Segments_Accessed = true;
        }
        ...
        protected override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.Segments = CloneOrChange_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(Segments, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            {
                _Segments = (List<(Int32 memoryBlockID, Int32 offset, Int32 length)>) CloneOrChange_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(_Segments, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
        ...
        protected override void UpdateDeserializedChildren(ref BufferWriter writer, long startPosition)
        {
            ...
            {
                _Segments = (List<(Int32 memoryBlockID, Int32 offset, Int32 length)>) CloneOrChange_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(_Segments, l => l.RemoveBufferInHierarchy(), true);
            }
        ...
        protected override void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            ConvertToBytes_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(ref w, _Segments,
            options));
            if (options.UpdateStoredBuffer)
            {
        ...
        private static List<(Int32 memoryBlockID, Int32 offset, Int32 length)> ConvertFromBytes_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default(List<(Int32 memoryBlockID, Int32 offset, Int32 length)>);
            }
            ReadOnlySpan<byte> span = storage.InitialReadOnlyMemory.Span;
            int bytesSoFar = 0;
            int collectionLength = span.ToDecompressedInt32(ref bytesSoFar);
            
            List<(Int32 memoryBlockID, Int32 offset, Int32 length)> collection = new List<(Int32 memoryBlockID, Int32 offset, Int32 length)>(collectionLength);
            for (int itemIndex = 0; itemIndex < collectionLength; itemIndex++)
            {
                int lengthCollectionMember = span.ToInt32(ref bytesSoFar);
                LazinatorMemory childData = storage.Slice(bytesSoFar, lengthCollectionMember);
                var item = ConvertFromBytes__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p(childData);
                collection.Add(item);
        ...
        private static void ConvertToBytes_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(ref BufferWriter writer, List<(Int32 memoryBlockID, Int32 offset, Int32 length)> itemToConvert, LazinatorSerializationOptions options)
        {
            if (itemToConvert == default(List<(Int32 memoryBlockID, Int32 offset, Int32 length)>))
            {
                return;
            }
            ...
            {
                void action(ref BufferWriter w) => ConvertToBytes__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p(ref w, itemToConvert[itemIndex], options);
                WriteToBinaryWithInt32LengthPrefix(ref writer, action);
            }
        }
        
        private static List<(Int32 memoryBlockID, Int32 offset, Int32 length)> CloneOrChange_List_G_Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p_g(List<(Int32 memoryBlockID, Int32 offset, Int32 length)> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
            ...
            {
                var itemCopied = ((Int32 memoryBlockID, Int32 offset, Int32 length)) CloneOrChange__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p(itemToClone[itemIndex], cloneOrChangeFunc, avoidCloningIfPossible);
                collection.Add(itemCopied);
            }
            return collection;
        }
        
        private static (Int32 memoryBlockID, Int32 offset, Int32 length) ConvertFromBytes__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default;
        ...
        private static void ConvertToBytes__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p(ref BufferWriter writer, (Int32 memoryBlockID, Int32 offset, Int32 length) itemToConvert, LazinatorSerializationOptions options)
        {
            ...
            CompressedIntegralTypes.WriteCompressedInt(ref writer, itemToConvert.Item3);
        }
        
        private static (Int32 memoryBlockID, Int32 offset, Int32 length) CloneOrChange__Pint_C32memoryBlockID_c_C32int_C32offset_c_C32int_C32length_p((Int32 memoryBlockID, Int32 offset, Int32 length) itemToConvert, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            return ((int) (itemToConvert.Item1), (int) (itemToConvert.Item2), (int) (itemToConvert.Item3));
        }
