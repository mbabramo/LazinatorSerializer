//615c9c12-20dd-e9bb-b683-c31eb2484511
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemorySegmentCollection : MemoryChunkCollection, ILazinator
    {
        ...
        private void LazinateSegments()
        {
            ...
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Segments_ByteIndex, _Segments_ByteLength, null);_Segments = ConvertFromBytes_List_GMemorySegmentIDAndSlice_g(childData);
            }
            _Segments_Accessed = true;
        }
        ...
        protected override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.Segments = CloneOrChange_List_GMemorySegmentIDAndSlice_g(Segments, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            {
                _Segments = (List<MemorySegmentIDAndSlice>) CloneOrChange_List_GMemorySegmentIDAndSlice_g(_Segments, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
        ...
        protected override void UpdateDeserializedChildren(ref BufferWriter writer, long startPosition)
        {
            ...
            {
                _Segments = (List<MemorySegmentIDAndSlice>) CloneOrChange_List_GMemorySegmentIDAndSlice_g(_Segments, l => l.RemoveBufferInHierarchy(), true);
            }
        ...
        protected override void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            ConvertToBytes_List_GMemorySegmentIDAndSlice_g(ref w, _Segments,
            options));
            if (options.UpdateStoredBuffer)
            {
