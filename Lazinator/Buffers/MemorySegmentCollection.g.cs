//56d05b55-fec5-6ccf-65bf-a341c7ca2efa
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Buffers
{
    ...
    public partial class MemorySegmentCollection : MemoryChunkCollection, ILazinator
    {
        ...
        protected List<MemorySegmentIDAndSlice> _SegmentInfos;
        public List<MemorySegmentIDAndSlice> SegmentInfos
        {
            [DebuggerStepThrough]
            get
            {
        ...
        private void LazinateSegmentInfos()
        {
            ...
            {
                _SegmentInfos = default(List<MemorySegmentIDAndSlice>);
            }
            else
            {
                LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _SegmentInfos_ByteIndex, _SegmentInfos_ByteLength, null);_SegmentInfos = ConvertFromBytes_List_GMemorySegmentIDAndSlice_g(childData);
            }
            _SegmentInfos_Accessed = true;
        }
        ...
        protected override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            typedClone.SegmentInfos = CloneOrChange_List_GMemorySegmentIDAndSlice_g(SegmentInfos, l => l?.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer), false);
        ...
        public override ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            {
                _SegmentInfos = (List<MemorySegmentIDAndSlice>) CloneOrChange_List_GMemorySegmentIDAndSlice_g(_SegmentInfos, l => l?.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true), true);
            }
        ...
        protected override void UpdateDeserializedChildren(ref BufferWriter writer, long startPosition)
        {
            ...
            {
                _SegmentInfos = (List<MemorySegmentIDAndSlice>) CloneOrChange_List_GMemorySegmentIDAndSlice_g(_SegmentInfos, l => l.RemoveBufferInHierarchy(), true);
            }
        ...
        protected override void WriteChildrenPropertiesIntoBuffer(ref BufferWriter writer, LazinatorSerializationOptions options, bool includeUniqueID, int startOfObjectPosition)
        {
            ...
            ConvertToBytes_List_GMemorySegmentIDAndSlice_g(ref w, _SegmentInfos,
            options));
            if (options.UpdateStoredBuffer)
            {
        ...
        private static List<MemorySegmentIDAndSlice> ConvertFromBytes_List_GMemorySegmentIDAndSlice_g(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
            ...
            for (int itemIndex = 0; itemIndex < collectionLength; itemIndex++)
            {
                ...
                var item = ConvertFromBytes_MemorySegmentIDAndSlice(childData);
                collection.Add(item);
        ...
        private static void ConvertToBytes_List_GMemorySegmentIDAndSlice_g(ref BufferWriter writer, List<MemorySegmentIDAndSlice> itemToConvert, LazinatorSerializationOptions options)
        {
            ...
            {
                void action(ref BufferWriter w) => ConvertToBytes_MemorySegmentIDAndSlice(ref w, itemToConvert[itemIndex], options);
                WriteToBinaryWithInt32LengthPrefix(ref writer, action);
            }
        }
        
        private static List<MemorySegmentIDAndSlice> CloneOrChange_List_GMemorySegmentIDAndSlice_g(List<MemorySegmentIDAndSlice> itemToClone, Func<ILazinator, ILazinator> cloneOrChangeFunc, bool avoidCloningIfPossible)
        {
            if (itemToClone == null)
            {
                return default;
            ...
            {
                var itemCopied = (MemorySegmentIDAndSlice) CloneOrChange_MemorySegmentIDAndSlice(itemToClone[itemIndex], cloneOrChangeFunc, avoidCloningIfPossible);
                collection.Add(itemCopied);
            }
            return collection;
        }
        
        private static MemorySegmentIDAndSlice ConvertFromBytes_MemorySegmentIDAndSlice(LazinatorMemory storage)
        {
            if (storage.Length == 0)
            {
                return default;
