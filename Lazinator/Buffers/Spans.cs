...
namespace Lazinator.Buffers
{
    ...
    public static class Spans
    {
        public static ReadOnlySpan<Int16> CastSpanToInt16(ReadOnlySpan<byte> s)
        {
            ...
            if (BufferWriter.LittleEndianStorage == BitConverter.IsLittleEndian)
                return cast;
        ...
        public static void Write_WithVarLongLengthPrefix(this ReadOnlySpan<byte> b, ref BufferWriter writer)
        {
            CompressedIntegralTypes.WriteCompressedLong(ref writer, (long)b.Length);
            writer.Write(b);
        }

        public static void Write_WithIntLengthPrefix(this ReadOnlySpan<byte> b, ref BufferWriter writer)
        {
            writer.Write(b.Length);
            writer.Write(b);
        }

        public static void Write_WithByteLengthPrefix(this ReadOnlySpan<byte> b, ref BufferWriter writer)
        {
        ...
        public static void Write(this ReadOnlyMemory<byte> m, ref BufferWriter writer)
        {
