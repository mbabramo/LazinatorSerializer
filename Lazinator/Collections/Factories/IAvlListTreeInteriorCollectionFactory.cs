...
namespace Lazinator.Collections.Factories
{
    ...
    public interface IAvlListTreeInteriorCollectionFactory<T> : ILazinator where T : ILazinator
    {
        ...
        IMultivalueContainer<T> CreateMultivalueContainer(bool allowDuplicates);
    }
}
