...
namespace Lazinator.Collections.Factories
{
    ...
    public partial class AvlSortedIndexableTreeFactory<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlSortedIndexableTreeFactory<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(175, new Type[] { typeof(T) }));
