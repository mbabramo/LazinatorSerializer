...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorLinkedListNode<T> : ILazinator
    {
            ...
            get
            {
                if (!_NextNode_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _NextNode = DeserializationFactory.Instance.CreateBaseOrDerivedType(129, () => new LazinatorLinkedListNode<T>(), childData, this); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<LazinatorLinkedListNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(129, new Type[] { typeof(T) }));
