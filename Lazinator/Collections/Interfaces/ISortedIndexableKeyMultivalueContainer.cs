...
namespace Lazinator.Collections.Interfaces
{
    ...
    {
        (long index, bool exists) Find(TKey key, MultivalueLocationOptions whichOne);
        (long index, bool exists) Find(TKey key, TValue value, MultivalueLocationOptions whichOne);
