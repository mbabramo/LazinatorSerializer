//d2e1664e-de14-7346-38d6-27013c98bad1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorQueue<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorList<T> _UnderlyingList;
        public virtual LazinatorList<T> UnderlyingList
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingList_Accessed)
                {
                    ...
                    {
                        _UnderlyingList = default(LazinatorList<T>);
                    }
                    else
                    {
                        ...
                        _UnderlyingList = DeserializationFactory.Instance.CreateBaseOrDerivedType(51, () => new LazinatorList<T>(), childData, this); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<LazinatorQueue<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(98, new Type[] { typeof(T) }));
