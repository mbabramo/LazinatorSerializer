//afdfe8fd-179a-cf13-5138-2060d50554a8
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorQueue<T> : ILazinator
    {
        ...
        protected virtual void AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            {
                typedClone.UnderlyingList = (UnderlyingList == null) ? default(AvlList<T>) : (AvlList<T>) UnderlyingList.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
            }
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlList<T> _UnderlyingList;
        public virtual AvlList<T> UnderlyingList
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingList_Accessed)
                {
                    ...
                    {
                        _UnderlyingList = default(AvlList<T>);
                    }
                    else
                    {
                        ...
                        _UnderlyingList = DeserializationFactory.Instance.CreateBaseOrDerivedType(110, () => new AvlList<T>(), childData, this); 
                    }
        ...
        public virtual IEnumerable<(string propertyName, ILazinator descendant)> EnumerateLazinatorDescendants(Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch, Func<ILazinator, bool> exploreCriterion, bool exploreOnlyDeserializedChildren, bool enumerateNulls)
        {
            ...
            else if ((!exploreOnlyDeserializedChildren && UnderlyingList != null) || (_UnderlyingList_Accessed && _UnderlyingList != null))
            {
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren)
        {
            ...
            {
                _UnderlyingList = (AvlList<T>) _UnderlyingList.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren);
            }
