...
namespace Lazinator.Collections.Dictionary
{
    ...
    internal partial class DictionaryBucket<TKey, TValue> : ILazinator
    {
        ...
        public virtual System.Collections.Generic.List<int> LazinatorGenericID => DeserializationFactory.GetUniqueIDListForGenericType(98, new Type[] { typeof(TKey), typeof(TValue) });
