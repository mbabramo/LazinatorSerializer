//a4397fdd-3de8-907f-c46f-b0ea2766a72f
//------------------------------------------------------------------------------
// <auto-generated>
    ...
    public partial class LazinatorDictionary<TKey, TValue> : ILazinator
    {
            ...
            get
            {
                if (!_Buckets_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Buckets = DeserializationFactory.GetInstance().CreateBaseOrDerivedType(51, () => new LazinatorList<DictionaryBucket<TKey, TValue>>(), childData, this); 
                    }
        ...
        public virtual System.Collections.Generic.List<int> LazinatorGenericID
        {
            get
            {
                ...
                {
                    _LazinatorGenericID = DeserializationFactory.GetInstance().GetUniqueIDListForGenericType(99, new Type[] { typeof(TKey), typeof(TValue) });
                }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _Buckets, includeChildrenMode, _Buckets_Accessed, () => GetChildSlice(LazinatorObjectBytes, _Buckets_ByteIndex, _Buckets_ByteLength, false, false, null), verifyCleanness, false, false, this);
            }
        }
