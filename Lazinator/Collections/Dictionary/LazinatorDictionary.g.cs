//357af59c-5938-83da-cbad-6b5953b9eeb8
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        internal virtual LazinatorList<DictionaryBucket<TKey, TValue>> Buckets
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property Buckets cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
