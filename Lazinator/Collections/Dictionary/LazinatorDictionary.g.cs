//02684ebb-2574-3be9-4903-0b5910411ad3
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Dictionary
{
    ...
    public partial class LazinatorDictionary<TKey, TValue> : ILazinator
    {
        ...
        {
            if (_Buckets_Accessed && _Buckets != null && (_Buckets.IsDirty || _Buckets.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _Buckets.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestDirty))
                {
