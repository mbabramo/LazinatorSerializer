//b841bfe3-6e57-55de-2825-bae2ce8a7631
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Dictionary
{
    ...
    public partial class LazinatorDictionary<TKey, TValue> : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_Buckets_Accessed && _Buckets != null))
            {
                foreach (ILazinator toYield in _Buckets.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
