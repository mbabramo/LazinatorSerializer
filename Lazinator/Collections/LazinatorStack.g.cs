...
namespace Lazinator.Collections
{
    ...
    public partial class LazinatorStack<T> : LazinatorList<T>, ILazinator
    {
        ...
        public override int LazinatorUniqueID => 97;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<LazinatorStack<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(97, new Type[] { typeof(T) }));
