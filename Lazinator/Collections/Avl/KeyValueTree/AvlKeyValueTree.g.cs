//5a9e7d69-2fa2-ace5-5c7f-6254eaf57f64
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl.KeyValueTree
{
    ...
    public partial class AvlKeyValueTree<TKey, TValue> : ILazinator
    {
        ...
        protected virtual int _UnderlyingTree_ByteLength => _AvlKeyValueTree_TKey_TValue_EndByteIndex - _UnderlyingTree_ByteIndex;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlTree<LazinatorKeyValue<TKey, TValue>> _UnderlyingTree;
        public virtual AvlTree<LazinatorKeyValue<TKey, TValue>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(AvlTree<LazinatorKeyValue<TKey, TValue>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(149, () => new AvlTree<LazinatorKeyValue<TKey, TValue>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(AvlTree<LazinatorKeyValue<TKey, TValue>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (AvlTree<LazinatorKeyValue<TKey, TValue>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (AvlTree<LazinatorKeyValue<TKey, TValue>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
