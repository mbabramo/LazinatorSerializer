...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlNode<T> : Lazinator.Collections.Tree.BinaryNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(166, new Type[] { typeof(T) }));
