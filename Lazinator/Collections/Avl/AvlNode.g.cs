//0388a49d-8966-e03f-3f8e-721b5ab07d00
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    [Autogenerated]
    public partial class AvlNode<T> : Lazinator.Collections.Tree.BinaryNode<T>, ILazinator
    {
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            AvlNode<T> typedClone = (AvlNode<T>) clone;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(164, new Type[] { typeof(T) }));
