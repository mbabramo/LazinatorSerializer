...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlKeyValueTree<TKey, TValue> : ILazinator
    {
            ...
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(167, () => new AvlTree<LazinatorKeyValue<TKey, TValue>>(), childData, this); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlKeyValueTree<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(180, new Type[] { typeof(TKey), typeof(TValue) }));
