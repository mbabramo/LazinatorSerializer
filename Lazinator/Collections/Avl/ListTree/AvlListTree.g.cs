//88ccd50c-1750-6a7b-68eb-a5c59540dff3
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl.ListTree
{
    ...
    public partial class AvlListTree<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IMultivalueContainer<IMultivalueContainer<T>> _UnderlyingTree;
        public virtual IMultivalueContainer<IMultivalueContainer<T>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _UnderlyingTree = default(IMultivalueContainer<IMultivalueContainer<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBasedOnType<IMultivalueContainer<IMultivalueContainer<T>>>(childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(IMultivalueContainer<IMultivalueContainer<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (IMultivalueContainer<IMultivalueContainer<T>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (IMultivalueContainer<IMultivalueContainer<T>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
