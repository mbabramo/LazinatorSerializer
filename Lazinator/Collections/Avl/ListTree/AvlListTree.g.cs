//a2909d66-23fb-9762-a27e-e8e2b3182895
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl.ListTree
{
    ...
    public partial class AvlListTree<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlTree<IMultivalueContainer<T>> _UnderlyingTree;
        public virtual AvlTree<IMultivalueContainer<T>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _UnderlyingTree = default(AvlTree<IMultivalueContainer<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(149, () => new AvlTree<IMultivalueContainer<T>>(), childData, this); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected IAvlTree<IMultivalueContainer<T>> _UnderlyingTree2;
        public virtual IAvlTree<IMultivalueContainer<T>> UnderlyingTree2
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree2_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _UnderlyingTree2 = default(IAvlTree<IMultivalueContainer<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree2 = DeserializationFactory.Instance.CreateBasedOnType<IAvlTree<IMultivalueContainer<T>>>(childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(AvlTree<IMultivalueContainer<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (AvlTree<IMultivalueContainer<T>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree2 = default(IAvlTree<IMultivalueContainer<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree2 = (IAvlTree<IMultivalueContainer<T>>) UnderlyingTree2.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (AvlTree<IMultivalueContainer<T>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree2 != null) || (_UnderlyingTree2_Accessed && _UnderlyingTree2 != null))
            {
                _UnderlyingTree2 = (IAvlTree<IMultivalueContainer<T>>) _UnderlyingTree2.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        public virtual void FreeInMemoryObjects()
        {
            ...
            _InnerContainerFactory_Accessed = _UnderlyingTree_Accessed = _UnderlyingTree2_Accessed = false;
            IsDirty = false;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlListTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(173, new Type[] { typeof(T) }));
