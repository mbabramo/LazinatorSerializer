//58c59622-436b-cef7-ba26-17754cfb9eb7
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl.ListTree
{
    ...
    [Autogenerated]
    public partial class AvlListNode<T> : Lazinator.Collections.Avl.ValueTree.AvlCountedNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlListNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(172, new Type[] { typeof(T) }));
