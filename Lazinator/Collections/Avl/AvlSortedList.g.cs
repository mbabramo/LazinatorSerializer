//08803a50-1a0a-6306-a5aa-c05182497518
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlSortedList<T> : ILazinator
    {
        ...
        protected virtual int _UnderlyingTree_ByteLength => _AvlSortedList_T_EndByteIndex - _UnderlyingTree_ByteIndex;
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected ILazinatorOrderedKeyable<T, Placeholder> _UnderlyingTree;
        public virtual ILazinatorOrderedKeyable<T, Placeholder> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(ILazinatorOrderedKeyable<T, Placeholder>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBasedOnType<ILazinatorOrderedKeyable<T, Placeholder>>(childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(ILazinatorOrderedKeyable<T, Placeholder>);
                }
                else
                {
                    typedClone.UnderlyingTree = (ILazinatorOrderedKeyable<T, Placeholder>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (ILazinatorOrderedKeyable<T, Placeholder>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
