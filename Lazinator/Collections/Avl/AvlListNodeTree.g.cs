...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlListNodeTree<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlListNodeTree<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(122, new Type[] { typeof(TKey), typeof(TValue) }));
