...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlIndexableTree<T> : AvlTree<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlIndexableTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(170, new Type[] { typeof(T) }));
