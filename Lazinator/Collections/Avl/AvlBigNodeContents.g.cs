//f4d7e5d7-b4c7-5c65-1c29-062c6256403a
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlBigNodeContents<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected SortedLazinatorList<LazinatorTuple<TKey, TValue>> _Items;
        public virtual SortedLazinatorList<LazinatorTuple<TKey, TValue>> Items
        {
            [DebuggerStepThrough]
            get
            {
                if (!_Items_Accessed)
                {
                    ...
                    {
                        _Items = default(SortedLazinatorList<LazinatorTuple<TKey, TValue>>);
                    }
                    else
                    {
                        LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Items_ByteIndex, _Items_ByteLength, false, false, null);
                        
                        _Items = DeserializationFactory.Instance.CreateBaseOrDerivedType(126, () => new SortedLazinatorList<LazinatorTuple<TKey, TValue>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (Items == null)
                {
                    typedClone.Items = default(SortedLazinatorList<LazinatorTuple<TKey, TValue>>);
                }
                else
                {
                    typedClone.Items = (SortedLazinatorList<LazinatorTuple<TKey, TValue>>) Items.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && Items != null) || (_Items_Accessed && _Items != null))
            {
                _Items = (SortedLazinatorList<LazinatorTuple<TKey, TValue>>) _Items.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
