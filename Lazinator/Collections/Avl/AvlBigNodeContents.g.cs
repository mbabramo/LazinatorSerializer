//9a15518e-6950-521f-f1f8-2985be53ac3d
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlBigNodeContents<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorList<LazinatorTuple<TKey, TValue>> _Items;
        public virtual LazinatorList<LazinatorTuple<TKey, TValue>> Items
        {
            [DebuggerStepThrough]
            get
            {
                if (!_Items_Accessed)
                {
                    ...
                    {
                        _Items = default(LazinatorList<LazinatorTuple<TKey, TValue>>);
                    }
                    else
                    {
                        LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Items_ByteIndex, _Items_ByteLength, false, false, null);
                        
                        _Items = DeserializationFactory.Instance.CreateBaseOrDerivedType(51, () => new LazinatorList<LazinatorTuple<TKey, TValue>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (Items == null)
                {
                    typedClone.Items = default(LazinatorList<LazinatorTuple<TKey, TValue>>);
                }
                else
                {
                    typedClone.Items = (LazinatorList<LazinatorTuple<TKey, TValue>>) Items.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && Items != null) || (_Items_Accessed && _Items != null))
            {
                _Items = (LazinatorList<LazinatorTuple<TKey, TValue>>) _Items.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
