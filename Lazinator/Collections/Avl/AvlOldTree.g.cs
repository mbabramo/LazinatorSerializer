//fbba9a32-0301-b006-8c78-61043e4977df
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    [Autogenerated]
    public partial class AvlOldTree<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlOldNode<TKey, TValue> _Root;
        public virtual AvlOldNode<TKey, TValue> Root
        {
            [DebuggerStepThrough]
            get
            {
                if (!_Root_Accessed)
                {
                    ...
                    {
                        _Root = default(AvlOldNode<TKey, TValue>);
                    }
                    else
                    {
                        LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Root_ByteIndex, _Root_ByteLength, false, false, null);
                        
                        _Root = DeserializationFactory.Instance.CreateBaseOrDerivedType(94, () => new AvlOldNode<TKey, TValue>(), childData, this); 
                    }
                    _Root_Accessed = true;
                } 
                return _Root;
        ...
        {
            var clone = new AvlOldTree<TKey, TValue>()
            {
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            AvlOldTree<TKey, TValue> typedClone = (AvlOldTree<TKey, TValue>) clone;
            typedClone.AllowDuplicates = AllowDuplicates;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (Root == null)
                {
                    typedClone.Root = default(AvlOldNode<TKey, TValue>);
                }
                else
                {
                    typedClone.Root = (AvlOldNode<TKey, TValue>) Root.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && Root != null) || (_Root_Accessed && _Root != null))
            {
                _Root = (AvlOldNode<TKey, TValue>) _Root.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlOldTree<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(95, new Type[] { typeof(TKey), typeof(TValue) }));
