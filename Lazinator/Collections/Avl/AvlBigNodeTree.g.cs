//6dad7384-0615-0ab7-3a1c-a7c53a0c0f8f
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlBigNodeTree<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>> _UnderlyingTree;
        public virtual AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(95, () => new AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (AvlTree<LazinatorTuple<TKey, TValue>, AvlBigNodeContents<TKey, TValue>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
