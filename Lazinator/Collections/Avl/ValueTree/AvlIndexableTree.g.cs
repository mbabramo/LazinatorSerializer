//b55f2100-f524-6273-80c5-1a80ebb3ab7c
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl.ValueTree
{
    ...
    [Autogenerated]
    public partial class AvlIndexableTree<T> : AvlTree<T>, ILazinator
    {
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            AvlIndexableTree<T> typedClone = (AvlIndexableTree<T>) clone;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlIndexableTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(166, new Type[] { typeof(T) }));
