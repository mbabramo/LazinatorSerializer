...
namespace Lazinator.Collections.Avl.ValueTree
{
    ...
    public partial class AvlAggregatedNode<T> : AvlCountedNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override int LazinatorUniqueID => 181;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlAggregatedNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(181, new Type[] { typeof(T) }));
