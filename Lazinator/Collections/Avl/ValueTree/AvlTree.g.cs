...
namespace Lazinator.Collections.Avl.ValueTree
{
    ...
    public partial class AvlTree<T> : Lazinator.Collections.Tree.BinaryTree<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(163, new Type[] { typeof(T) }));
