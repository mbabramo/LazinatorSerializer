...
namespace Lazinator.Collections.Avl.ValueTree
{
    ...
    public partial class AvlNode<T> : Lazinator.Collections.Tree.BinaryNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override int LazinatorUniqueID => 162;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(162, new Type[] { typeof(T) }));
