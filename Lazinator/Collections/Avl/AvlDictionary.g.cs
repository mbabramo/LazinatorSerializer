//891237d3-9612-8486-7494-6c1b2b109ac1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlDictionary<TKey, TValue> : ILazinator
    {
        ...
        private int _AvlDictionary_TKey_TValue_EndByteIndex;
        protected virtual int _UnderlyingTree_ByteLength => _AvlDictionary_TKey_TValue_EndByteIndex - _UnderlyingTree_ByteIndex;
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _AllowDuplicateKeys;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>> _UnderlyingTree;
        public virtual ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBasedOnType<ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>>>(childData, this); 
                    }
        ...
        {
            var clone = new AvlDictionary<TKey, TValue>()
            {
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            AvlDictionary<TKey, TValue> typedClone = (AvlDictionary<TKey, TValue>) clone;
            typedClone.AllowDuplicateKeys = AllowDuplicateKeys;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (UnderlyingTree == null)
                {
                    typedClone.UnderlyingTree = default(ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        {
            yield return ("AllowDuplicateKeys", (object)AllowDuplicateKeys);
            yield break;
        }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (ILazinatorOrderedKeyable<WUint, LazinatorTuple<TKey, TValue>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 132;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlDictionary<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(132, new Type[] { typeof(TKey), typeof(TValue) }));
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _AllowDuplicateKeys = span.ToBoolean(ref bytesSoFar);
            _UnderlyingTree_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            _AvlDictionary_TKey_TValue_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            // write properties
            WriteUncompressedPrimitives.WriteBool(ref writer, _AllowDuplicateKeys);
            ...
            if (updateStoredBuffer)
            {
                _AvlDictionary_TKey_TValue_EndByteIndex = writer.Position - startPosition;
            }
        }
