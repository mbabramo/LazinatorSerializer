//67e73a0c-504c-5e34-96cf-ba01b3381991
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.AvlTree
{
    ...
    public partial class AvlMultiset<T> : ILazinator
    {
        ...
        {
            if (!exploreOnlyDeserializedChildren || (_UnderlyingSet_Accessed && _UnderlyingSet != null))
            {
                foreach (ILazinator toYield in _UnderlyingSet.EnumerateLazinatorNodes(matchCriterion, stopExploringBelowMatch, exploreCriterion, exploreOnlyDeserializedChildren))
                {
