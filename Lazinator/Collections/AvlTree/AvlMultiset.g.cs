//113e0e8d-0e76-40f3-a1de-633f0b062999
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public virtual AvlSet<LazinatorTuple<T, WInt>> UnderlyingSet
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property UnderlyingSet cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
