//3a4b8632-687f-a582-f064-9161c48b5959
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.AvlTree
{
    ...
    public partial class AvlMultiset<T> : ILazinator
    {
        ...
        public virtual AvlSet<LazinatorTuple<T, WInt>> UnderlyingSet
        {
            ...
            get
            {
                if (!_UnderlyingSet_Accessed)
                {
                    ...
                    {
                        ReadOnlyMemory<byte> childData = GetChildSlice(LazinatorObjectBytes, _UnderlyingSet_ByteIndex, _UnderlyingSet_ByteLength, false, null);
                        
                        if (DeserializationFactory == null)
                        {
                            DeserializationFactory = DeserializationFactory.GetInstance();
                        }
                        _UnderlyingSet = DeserializationFactory.CreateBaseOrDerivedType(97, () => new AvlSet<LazinatorTuple<T, WInt>>(), childData, this); 
                    }
        ...
        protected virtual void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _UnderlyingSet, includeChildrenMode, _UnderlyingSet_Accessed, () => GetChildSlice(LazinatorObjectBytes, _UnderlyingSet_ByteIndex, _UnderlyingSet_ByteLength, false, null), verifyCleanness, false, false, this);
            }
        }
