//9fc8cbdc-33c2-4dcd-8e3e-f50f5638f2b8
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public virtual AvlSet<LazinatorTuple<T, WInt>> UnderlyingSet
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property UnderlyingSet cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
