...
namespace Lazinator.Collections.Avl
{
    ...
    public partial class AvlTree<TKey, TValue> : ILazinator
    {
        ...
        {
            if (_Root_Accessed && _Root != null && (_Root.IsDirty || _Root.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _Root.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestDirty))
                {
