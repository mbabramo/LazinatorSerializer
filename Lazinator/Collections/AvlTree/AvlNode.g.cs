//b8b8f8bd-5d78-7459-fce3-c279206620d1
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public TKey Key
        {
            ...
            set
            {
                if (!System.Collections.Generic.EqualityComparer<TKey>.Default.Equals(value, default(TKey)))
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property Key cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
        ...
        public TValue Value
        {
            ...
            set
            {
                if (!System.Collections.Generic.EqualityComparer<TValue>.Default.Equals(value, default(TValue)))
                {
                    if (value.LazinatorParentClass != null)
                    {
                        throw new MovedLazinatorException($"The property Value cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
                    value.LazinatorParentClass = this;
                }
                IsDirty = true;
