...
namespace Lazinator.Collections.AvlTree
{
    ...
    public partial class AvlSet<TKey> : ILazinator
    {
        ...
        protected virtual IEnumerable<ILazinator> EnumerateLazinatorNodes_Helper(bool exploreOnlyDeserializedChildren, Func<ILazinator, bool> exploreCriterion, Func<ILazinator, bool> matchCriterion, bool stopExploringBelowMatch)
        {
            ...
            {
                foreach (ILazinator toYield in _UnderlyingTree.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, matchCriterion, stopExploringBelowMatch))
                {
