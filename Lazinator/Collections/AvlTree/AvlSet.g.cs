...
namespace Lazinator.Collections.AvlTree
{
    ...
    public partial class AvlSet<TKey> : ILazinator
    {
        ...
        {
            if (_UnderlyingTree_Accessed && _UnderlyingTree != null && (_UnderlyingTree.IsDirty || _UnderlyingTree.DescendantIsDirty))
            {
                foreach (ILazinator toYield in _UnderlyingTree.EnumerateLazinatorNodes(exploreOnlyDeserializedChildren, exploreCriterion, yieldCriterion, onlyHighestDirty))
                {
