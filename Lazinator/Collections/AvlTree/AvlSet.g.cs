//60595b90-0499-be0a-25c4-e960875b204f
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public virtual AvlTree<TKey, WByte> UnderlyingTree
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property UnderlyingTree cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutocloneAttribute or the AllowMovedAttribute.");
                    }
