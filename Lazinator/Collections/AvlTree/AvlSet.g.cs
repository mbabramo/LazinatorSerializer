//378a5e20-7daf-255a-ea6b-1731d393cc9a
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        public virtual AvlTree<TKey, WByte> UnderlyingTree
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property UnderlyingTree cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
