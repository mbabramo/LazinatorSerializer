//96202d88-221f-7314-cd2a-8f1face0979e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.BigList
{
    ...
    [Autogenerated]
    public partial class BigListLeafNode<T> : ILazinator
    {
        /* Property definitions */
        
        protected int _Items_ByteIndex;
        private int _BigListLeafNode_T_EndByteIndex;
        protected virtual int _Items_ByteLength => _BigListLeafNode_T_EndByteIndex - _Items_ByteIndex;
        ...
        {
            var clone = new BigListLeafNode<T>()
            {
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            BigListLeafNode<T> typedClone = (BigListLeafNode<T>) clone;
        ...
        public override LazinatorGenericIDType LazinatorGenericID
        {
            get
            {
                ...
                {
                    _LazinatorGenericID = DeserializationFactory.Instance.GetUniqueIDListForGenericType(119, new Type[] { typeof(T) });
                }
        ...
        public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _BigListLeafNode_T_EndByteIndex = bytesSoFar;
        }
        ...
        protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _BigListLeafNode_T_EndByteIndex = writer.Position - startPosition;
            }
        }
