//bfbbab10-8b3c-60f3-5288-59e2a3059b3b
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.BigList
{
    ...
    [Autogenerated]
    public partial class BigListInteriorNode<T> : ILazinator
    {
        /* Property definitions */
        
        protected int _Counts_ByteIndex;
        private int _BigListInteriorNode_T_EndByteIndex;
        protected virtual int _Counts_ByteLength => _BigListInteriorNode_T_EndByteIndex - _Counts_ByteIndex;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected int _MaxLeafCount;
        public override int MaxLeafCount
        {
            [DebuggerStepThrough]
            get
            {
                return _MaxLeafCount;
            }
            [DebuggerStepThrough]
            set
            {
        ...
        public BigListInteriorNode() : base()
        {
        }
        ...
        {
            var clone = new BigListInteriorNode<T>()
            {
        ...
        public override ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            BigListInteriorNode<T> typedClone = (BigListInteriorNode<T>) clone;
            typedClone.Count = Count;
            typedClone.MaxLeafCount = MaxLeafCount;
        ...
        public override IEnumerable<(string propertyName, object descendant)> EnumerateNonLazinatorProperties()
        {
            ...
            yield return ("MaxLeafCount", (object)MaxLeafCount);
            yield break;
        }
        ...
        public override void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _MaxLeafCount = span.ToDecompressedInt(ref bytesSoFar);
            _Counts_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            _BigListInteriorNode_T_EndByteIndex = bytesSoFar;
        }
        ...
        protected override void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            CompressedIntegralTypes.WriteCompressedInt(ref writer, _MaxLeafCount);
            ...
            if (updateStoredBuffer)
            {
                _BigListInteriorNode_T_EndByteIndex = writer.Position - startPosition;
            }
        }
