//b7a45f1a-f295-5fe0-545e-53904aec3c94
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.BigList
{
    ...
    [Autogenerated]
    public partial class BigList<T> : ILazinator
    {
        ...
        private int _BigList_T_EndByteIndex;
        protected virtual int _UnderlyingTree_ByteLength => _BigList_T_EndByteIndex - _UnderlyingTree_ByteIndex;
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _IsAppendOnly;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected BigListTree<T> _UnderlyingTree;
        public virtual BigListTree<T> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(BigListTree<T>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(123, () => new BigListTree<T>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            BigList<T> typedClone = (BigList<T>) clone;
            typedClone.IsAppendOnly = IsAppendOnly;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (UnderlyingTree == null)
                {
                    typedClone.UnderlyingTree = default(BigListTree<T>);
                }
                else
                {
                    typedClone.UnderlyingTree = (BigListTree<T>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        {
            yield return ("IsAppendOnly", (object)IsAppendOnly);
            yield break;
        }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (BigListTree<T>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<BigList<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(122, new Type[] { typeof(T) }));
        ...
        {
            ReadOnlySpan<byte> span = LazinatorObjectBytes.Span;
            _IsAppendOnly = span.ToBoolean(ref bytesSoFar);
            _UnderlyingTree_ByteIndex = bytesSoFar;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                bytesSoFar = span.ToInt32(ref bytesSoFar) + bytesSoFar;
            }
            _BigList_T_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            // write properties
            WriteUncompressedPrimitives.WriteBool(ref writer, _IsAppendOnly);
            ...
            if (updateStoredBuffer)
            {
                _BigList_T_EndByteIndex = writer.Position - startPosition;
            }
        }
