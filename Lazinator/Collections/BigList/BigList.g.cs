//a9e8ac68-0e53-b2f5-3b57-a84ebf67f563
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.BigList
{
    ...
    public partial class BigList<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorGeneralTree<BigListNode<T>> _UnderlyingTree;
        public virtual LazinatorGeneralTree<BigListNode<T>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(LazinatorGeneralTree<BigListNode<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(114, () => new LazinatorGeneralTree<BigListNode<T>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(LazinatorGeneralTree<BigListNode<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (LazinatorGeneralTree<BigListNode<T>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (LazinatorGeneralTree<BigListNode<T>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
