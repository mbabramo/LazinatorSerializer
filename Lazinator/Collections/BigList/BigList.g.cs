//5d67dbc0-fc53-34fe-e39b-19be55a303e9
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections.BigList
{
    ...
    public partial class BigList<T> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorGeneralTree<BigListContainer<T>> _UnderlyingTree;
        public virtual LazinatorGeneralTree<BigListContainer<T>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(LazinatorGeneralTree<BigListContainer<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(114, () => new LazinatorGeneralTree<BigListContainer<T>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(LazinatorGeneralTree<BigListContainer<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (LazinatorGeneralTree<BigListContainer<T>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (LazinatorGeneralTree<BigListContainer<T>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        public virtual LazinatorGenericIDType LazinatorGenericID
        {
            get
            {
                ...
                {
                    _LazinatorGenericID = DeserializationFactory.Instance.GetUniqueIDListForGenericType(121, new Type[] { typeof(T) });
                }
