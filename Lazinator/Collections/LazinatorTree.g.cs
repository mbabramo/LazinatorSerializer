//a16dbafc-e6d7-3808-c7a7-f39f51fc6083
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections
{
    ...
    [Autogenerated]
    public partial class LazinatorTree<T> : ILazinator
    {
        ...
        private int _LazinatorTree_T_EndByteIndex = 0;
        protected virtual int _Item_ByteLength => _LazinatorTree_T_EndByteIndex - _Item_ByteIndex;
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected LazinatorList<LazinatorTree<T>> _Children;
        protected virtual LazinatorList<LazinatorTree<T>> Children
        {
            [DebuggerStepThrough]
            get
            {
                if (!_Children_Accessed)
                {
                    ...
                    {
                        _Children = default(LazinatorList<LazinatorTree<T>>);
                    }
                    else
                    {
                        LazinatorMemory childData = GetChildSlice(LazinatorMemoryStorage, _Children_ByteIndex, _Children_ByteLength, false, false, null);
                        
                        _Children = DeserializationFactory.Instance.CreateBaseOrDerivedType(51, () => new LazinatorList<LazinatorTree<T>>(), childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            LazinatorTree<T> typedClone = (LazinatorTree<T>) clone;
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                if (Children == null)
                {
                    typedClone.Children = default(LazinatorList<LazinatorTree<T>>);
                }
                else
                {
                    typedClone.Children = (LazinatorList<LazinatorTree<T>>) Children.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && Children != null) || (_Children_Accessed && _Children != null))
            {
                _Children = (LazinatorList<LazinatorTree<T>>) _Children.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if ((!exploreOnlyDeserializedChildren && Item != null) || (_Item_Accessed && _Item != null))
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 114;
        ...
        public virtual LazinatorGenericIDType LazinatorGenericID
        {
            get
            {
                ...
                {
                    _LazinatorGenericID = DeserializationFactory.Instance.GetUniqueIDListForGenericType(114, new Type[] { typeof(T) });
                }
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _LazinatorTree_T_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _LazinatorTree_T_EndByteIndex = writer.Position - startPosition;
            }
        }
