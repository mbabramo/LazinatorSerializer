//b9e57c2c-7e89-d983-5ac0-b70fe8fba7a7
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Collections
{
    ...
    [Autogenerated]
    public partial struct LazinatorKeyValue<T, U> : ILazinator
    {
        ...
        private int _LazinatorKeyValue_T_U_EndByteIndex;
        int _Value_ByteLength => _LazinatorKeyValue_T_U_EndByteIndex - _Value_ByteIndex;
            ...
            get
            {
                if (!_Key_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Key = DeserializationFactory.Instance.CreateBasedOnType<T>(childData); 
                    }
                    _Key_Accessed = true;
                } 
                return _Key;
            ...
            get
            {
                if (!_Value_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _Value = DeserializationFactory.Instance.CreateBasedOnType<U>(childData); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<LazinatorKeyValue<T, U>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(125, new Type[] { typeof(T), typeof(U) }));
