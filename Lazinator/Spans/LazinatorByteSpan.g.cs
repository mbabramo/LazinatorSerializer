//1bc04541-87e1-4e8e-2f02-cbd585f40709
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.25, on 5/15/2018 11:17:49 AM
//
...
namespace Lazinator.Spans
{
    ...
    public partial class LazinatorByteSpan : ILazinator
    {
            ...
            get
            {
                if (!_ReadOrWrite_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _ReadOrWrite = ConvertFromBytes_Memory_byte(childData, DeserializationFactory, null);
                    }
        ...
        public virtual void SerializeExistingBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness)
        {
            ...
            ConvertToBytes_ReadOnlySpan_byte(w, ReadOnly,
            ...
            verifyCleanness: false,
            binaryWriterAction: (w, v) =>
            ConvertToBytes_Memory_byte(w, ReadOrWrite,
            includeChildrenMode, v));
        }
