//c2f9b967-778b-a468-204e-8fe2fe795f09
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lazinator.Spans
{
    ...
    public sealed partial class LazinatorBitArray : ILazinator
    {
        ...
        void WritePropertiesIntoBuffer(BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool includeUniqueID)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                WriteChildWithLength(writer, _ByteSpan, includeChildrenMode, _ByteSpan_Accessed, () => GetChildSlice(LazinatorObjectBytes, _ByteSpan_ByteIndex, _ByteSpan_ByteLength, false, null), verifyCleanness, false, false, this);
            }
        }
