//1a196eea-c26d-d83f-ad05-f830f85124da
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        private LazinatorByteSpan ByteSpan
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        throw new MovedLazinatorException($"The property ByteSpan cannot be set to a Lazinator object with a defined LazinatorParentClass. Set the LazinatorParentClass to null, clone the object, or use the AutoChangeParentAttribute or the AllowMovedAttribute.");
                    }
