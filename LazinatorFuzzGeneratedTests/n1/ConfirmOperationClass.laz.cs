//6b880b6b-efbc-a77d-d7b2-8126999a3ba1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace FuzzTests.n1
{
    ...
    [Autogenerated]
    public partial class ConfirmOperationClass : ILazinator
    {
        ...
        protected int _DistinguishStart_ByteIndex;
        protected int _WeekBar_ByteIndex;
        protected virtual int _DistinguishStart_ByteLength => _WeekBar_ByteIndex - _DistinguishStart_ByteIndex;
        protected virtual int _WeekBar_ByteLength { get; }
        
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _DistinguishStart_Accessed = false;
        public abstract RefugeeSmartStruct? DistinguishStart
        {
            get;
            set;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected bool _WeekBar_Accessed = false;
        public abstract CommanderPersuadeStruct? WeekBar
        {
            get;
            set;
        }
