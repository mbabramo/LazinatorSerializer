//09741f3c-2ba6-fac9-7ab6-f2f6bbeb1720
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by the Lazinator tool, version 0.1.0.399, on 2024/01/22 10:06:57.102 AM.
//
...
#pragma warning restore 8019
    ...
    [Autogenerated]
    public partial class BinaryTree<T> : BinaryTreeWithNodeType<T, BinaryNode<T>>, ILazinator
    {
        ...
        public BinaryTree(BinaryNode<T> root, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren) : base({ parametersForBaseClassString}), originalIncludeChildrenMode
        {
            
        }

    public BinaryTree(LazinatorMemory serializedBytes, ILazinator? parent = null, IncludeChildrenMode originalIncludeChildrenMode = IncludeChildrenMode.IncludeAllChildren, int? lazinatorObjectVersion = null) : base(serializedBytes, parent, originalIncludeChildrenMode, lazinatorObjectVersion)
    {
        LazinatorMemory childData;

        childData = GetChildSlice(LazinatorMemoryStorage, _Root_ByteIndex, _Root_ByteLength, null);
        _Root = DeserializationFactory.Instance.CreateBaseOrDerivedType(524, (c, p) => new BinaryNode<T>(c, p), childData, this);
    }
    ...
    public override ILazinator? CloneLazinator(IncludeChildrenMode includeChildrenMode = IncludeChildrenMode.IncludeAllChildren, CloneBufferOptions cloneBufferOptions = CloneBufferOptions.IndependentBuffers)
    {
        ...
        {
            clone = new BinaryTree<T>(Root, includeChildrenMode);
            clone.LazinatorObjectVersion = LazinatorObjectVersion;
            clone = (BinaryTree<T>)AssignCloneProperties(clone, includeChildrenMode)!;
        }
        else
        {
            LazinatorMemory bytes = EncodeOrRecycleToNewBuffer(includeChildrenMode, OriginalIncludeChildrenMode, IsDirty, DescendantIsDirty, false, LazinatorMemoryStorage, this);
            clone = new BinaryTree<T>(bytes);
        }
        return clone;
    }
    ...
    public override int LazinatorUniqueID => 526;

    protected override bool ContainsOpenGenericParameters => true;
    public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<BinaryTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(526, new Type[] { typeof(T) }));
