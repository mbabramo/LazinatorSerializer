...
namespace LazinatorAvlCollections.Avl
{
    public partial class AvlSortedList<T> : IAvlSortedList<T>, IList<T>, ILazinatorSorted<T> where T : ILazinator, IComparable<T>
    {
        ...
        {
            UnderlyingTree = new AvlSortedIndexableTree<T>(allowDuplicates, false, true);
            AllowDuplicates = allowDuplicates;
        }

        public AvlSortedList(bool allowDuplicates, ContainerFactory innerContainerFactory)
        {
            UnderlyingTree = (ISortedIndexableMultivalueContainer<T>) innerContainerFactory.CreateSortedValueContainer<T>();
            AllowDuplicates = allowDuplicates;
        }
