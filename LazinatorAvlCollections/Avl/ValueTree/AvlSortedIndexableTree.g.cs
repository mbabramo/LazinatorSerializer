//91e71717-55af-d422-3937-9536a8d9cc0f
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ValueTree
{
    ...
    public partial class AvlSortedIndexableTree<T> : AvlIndexableTree<T>, ILazinator
    {
        ...
        public override int LazinatorUniqueID => 509;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlSortedIndexableTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(509, new Type[] { typeof(T) }));
