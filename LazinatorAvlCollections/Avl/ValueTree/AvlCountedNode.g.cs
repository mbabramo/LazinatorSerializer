//02f273b6-dec7-30df-f958-d75b0e858ed5
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ValueTree
{
    ...
    public partial class AvlCountedNode<T> : AvlNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override int LazinatorUniqueID => 507;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlCountedNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(507, new Type[] { typeof(T) }));
