//ba4de40f-e1c8-0462-f6ef-9b85e6a4f6fe
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ValueTree
{
    ...
    public partial class AvlTree<T> : LazinatorCollections.Tree.BinaryTree<T>, ILazinator
    {
        ...
        public override int LazinatorUniqueID => 505;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(505, new Type[] { typeof(T) }));
