//7abc5afe-a2d1-6fb6-7a12-9b206c834039
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ValueTree
{
    ...
    public partial class AvlAggregatedNode<T> : AvlCountedNode<T>, ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override int LazinatorUniqueID => 517;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected override bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlAggregatedNode<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(517, new Type[] { typeof(T) }));
