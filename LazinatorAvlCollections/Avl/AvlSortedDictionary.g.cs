//daa22a82-b734-da61-3b45-49f29383a30e
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl
{
    ...
    public partial class AvlSortedDictionary<TKey, TValue> : ILazinator
    {
        ...
        protected virtual int _UnderlyingTree_ByteLength => _AvlSortedDictionary_TKey_TValue_EndByteIndex - _UnderlyingTree_ByteIndex;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected ISortedKeyMultivalueContainer<TKey, TValue> _UnderlyingTree;
        public virtual ISortedKeyMultivalueContainer<TKey, TValue> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(ISortedKeyMultivalueContainer<TKey, TValue>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBasedOnType<ISortedKeyMultivalueContainer<TKey, TValue>>(childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(ISortedKeyMultivalueContainer<TKey, TValue>);
                }
                else
                {
                    typedClone.UnderlyingTree = (ISortedKeyMultivalueContainer<TKey, TValue>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (ISortedKeyMultivalueContainer<TKey, TValue>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 502;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlSortedDictionary<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(502, new Type[] { typeof(TKey), typeof(TValue) }));
