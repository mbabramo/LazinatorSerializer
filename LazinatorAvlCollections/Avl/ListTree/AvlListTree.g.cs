//9339494f-dd75-fa2d-c0e1-a8940d8870dd
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ListTree
{
    ...
    public partial class AvlListTree<T> : ILazinator
    {
            ...
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(505, () => new AvlTree<IMultivalueContainer<T>>(), childData, this); 
                    }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 515;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlListTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(515, new Type[] { typeof(T) }));
