//fe871bce-6b98-e710-570b-a6f906dddbe1
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl.ListTree
{
    ...
    [Autogenerated]
    public partial class AvlIndexableListTree<T> : ILazinator
    {
        ...
        private int _AvlIndexableListTree_T_EndByteIndex;
        protected virtual int _UnderlyingTree_ByteLength => _AvlIndexableListTree_T_EndByteIndex - _UnderlyingTree_ByteIndex;
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected AvlAggregatedTree<IIndexableMultivalueContainer<T>> _UnderlyingTree;
        public virtual AvlAggregatedTree<IIndexableMultivalueContainer<T>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    if (LazinatorObjectBytes.Length == 0)
                    {
                        _UnderlyingTree = default(AvlAggregatedTree<IIndexableMultivalueContainer<T>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBaseOrDerivedType(518, () => new AvlAggregatedTree<IIndexableMultivalueContainer<T>>(), childData, this); 
                    }
        ...
        public AvlIndexableListTree() : base()
        {
        }
        ...
        {
            var clone = new AvlIndexableListTree<T>()
            {
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            AvlIndexableListTree<T> typedClone = (AvlIndexableListTree<T>) clone;
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(AvlAggregatedTree<IIndexableMultivalueContainer<T>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (AvlAggregatedTree<IIndexableMultivalueContainer<T>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            ...
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (AvlAggregatedTree<IIndexableMultivalueContainer<T>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 519;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlIndexableListTree<T>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(519, new Type[] { typeof(T) }));
        ...
        public virtual void ConvertFromBytesAfterHeader(IncludeChildrenMode includeChildrenMode, int serializedVersionNumber, ref int bytesSoFar)
        {
            ...
            _AvlIndexableListTree_T_EndByteIndex = bytesSoFar;
        }
        ...
        protected virtual void WritePropertiesIntoBuffer(ref BinaryBufferWriter writer, IncludeChildrenMode includeChildrenMode, bool verifyCleanness, bool updateStoredBuffer, bool includeUniqueID)
        {
            ...
            if (updateStoredBuffer)
            {
                _AvlIndexableListTree_T_EndByteIndex = writer.Position - startPosition;
            }
        }
