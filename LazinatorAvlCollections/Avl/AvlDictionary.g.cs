//2bfd4bef-f009-c4c5-e8c4-588f6b64f6f2
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LazinatorAvlCollections.Avl
{
    ...
    public partial class AvlDictionary<TKey, TValue> : ILazinator
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>> _UnderlyingTree;
        public virtual ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>> UnderlyingTree
        {
            [DebuggerStepThrough]
            get
            {
                if (!_UnderlyingTree_Accessed)
                {
                    ...
                    {
                        _UnderlyingTree = default(ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>>);
                    }
                    else
                    {
                        ...
                        _UnderlyingTree = DeserializationFactory.Instance.CreateBasedOnType<ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>>>(childData, this); 
                    }
        ...
        public virtual ILazinator AssignCloneProperties(ILazinator clone, IncludeChildrenMode includeChildrenMode)
        {
            ...
            if (includeChildrenMode != IncludeChildrenMode.ExcludeAllChildren && includeChildrenMode != IncludeChildrenMode.IncludeOnlyIncludableChildren) 
            {
                ...
                {
                    typedClone.UnderlyingTree = default(ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>>);
                }
                else
                {
                    typedClone.UnderlyingTree = (ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>>) UnderlyingTree.CloneLazinator(includeChildrenMode, CloneBufferOptions.NoBuffer);
                }
            }
        ...
        public virtual ILazinator ForEachLazinator(Func<ILazinator, ILazinator> changeFunc, bool exploreOnlyDeserializedChildren, bool changeThisLevel)
        {
            if ((!exploreOnlyDeserializedChildren && UnderlyingTree != null) || (_UnderlyingTree_Accessed && _UnderlyingTree != null))
            {
                _UnderlyingTree = (ISortedKeyMultivalueContainer<WUint, LazinatorKeyValue<TKey, TValue>>) _UnderlyingTree.ForEachLazinator(changeFunc, exploreOnlyDeserializedChildren, true);
            }
            if (changeThisLevel)
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual int LazinatorUniqueID => 503;
        
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected virtual bool ContainsOpenGenericParameters => true;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public virtual LazinatorGenericIDType LazinatorGenericID => LazinatorGenericIDType.GetCachedForType<AvlDictionary<TKey, TValue>>(() => DeserializationFactory.Instance.GetUniqueIDListForGenericType(503, new Type[] { typeof(TKey), typeof(TValue) }));
